...
var MusicEvent = resource.define('MusicEvent'); 

MusicEvent.schema.description = "Event type: Music event."; 
MusicEvent.persist('fs'); 


MusicEvent.property('additionalType', {
  "name" : "additionalType", 
...
MusicEvent.property('description', {
  "name" : "description", 
...
MusicEvent.property('performers', {
  "name" : "performers", 
...
MusicEvent.property('superEvent', {
  "name" : "superEvent", 
