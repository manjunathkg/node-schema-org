...
var MarryAction = resource.define('MarryAction'); 

MarryAction.schema.description = "The act of marrying a person."; 
MarryAction.persist('fs'); 


MarryAction.property('additionalType', {
  "name" : "additionalType", 
...
MarryAction.property('description', {
  "name" : "description", 
...
MarryAction.property('instrument', {
  "name" : "instrument", 
...
MarryAction.property('participant', {
  "name" : "participant", 
...
MarryAction.property('startTime', {
  "name" : "startTime", 
