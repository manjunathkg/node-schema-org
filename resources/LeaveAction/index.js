...
var LeaveAction = resource.define('LeaveAction'); 

LeaveAction.schema.description = "An agent leaves an event / group with participants/friends at a location.Related actions:JoinAction: The antagonym of LeaveAction.UnRegisterAction: Unlike UnRegisterAction, LeaveAction implies leaving a group/team of people rather than a service."; 
LeaveAction.persist('fs'); 


LeaveAction.property('additionalType', {
  "name" : "additionalType", 
...
LeaveAction.property('description', {
  "name" : "description", 
...
LeaveAction.property('instrument', {
  "name" : "instrument", 
...
LeaveAction.property('participant', {
  "name" : "participant", 
...
LeaveAction.property('startTime', {
  "name" : "startTime", 
