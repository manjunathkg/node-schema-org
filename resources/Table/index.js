...
var Table = resource.define('Table'); 

Table.schema.description = "A table on the page."; 
Table.persist('fs'); 


Table.property('additionalType', {
  "name" : "additionalType", 
...
Table.property('accountablePerson', {
...
Table.property('aggregateRating', {
...
Table.property('alternativeHeadline', {
...
Table.property('associatedMedia', {
...
Table.property('contentLocation', {
...
Table.property('copyrightHolder', {
...
Table.property('educationalAlignment', {
...
Table.property('interactionCount', {
...
Table.property('interactivityType', {
...
Table.property('isFamilyFriendly', {
...
Table.property('learningResourceType', {
...
Table.property('publishingPrinciples', {
...
Table.property('sourceOrganization', {
...
Table.property('typicalAgeRange', {
