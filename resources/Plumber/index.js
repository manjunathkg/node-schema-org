...
var Plumber = resource.define('Plumber'); 

Plumber.schema.description = "A plumbing service."; 
Plumber.persist('fs'); 


Plumber.property('additionalType', {
  "name" : "additionalType", 
...
Plumber.property('aggregateRating', {
...
Plumber.property('globalLocationNumber', {
...
Plumber.property('interactionCount', {
...
Plumber.property('openingHoursSpecification', {
...
Plumber.property('contactPoints', {
  "name" : "contactPoints", 
...
Plumber.property('currenciesAccepted', {
...
Plumber.property('paymentAccepted', {
