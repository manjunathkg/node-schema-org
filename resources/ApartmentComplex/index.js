...
var ApartmentComplex = resource.define('ApartmentComplex'); 

ApartmentComplex.schema.description = "Residence type: Apartment complex."; 
ApartmentComplex.persist('fs'); 


ApartmentComplex.property('additionalType', {
  "name" : "additionalType", 
...
ApartmentComplex.property('description', {
  "name" : "description", 
...
ApartmentComplex.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
ApartmentComplex.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
ApartmentComplex.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ApartmentComplex.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
ApartmentComplex.property('aggregateRating', {
...
ApartmentComplex.property('containedIn', {
  "name" : "containedIn", 
...
ApartmentComplex.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
ApartmentComplex.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
ApartmentComplex.property('faxNumber', {
  "name" : "faxNumber", 
...
ApartmentComplex.property('globalLocationNumber', {
...
ApartmentComplex.property('interactionCount', {
...
ApartmentComplex.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
ApartmentComplex.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
ApartmentComplex.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
ApartmentComplex.property('openingHoursSpecification', {
...
ApartmentComplex.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
ApartmentComplex.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
ApartmentComplex.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
ApartmentComplex.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
ApartmentComplex.property('telephone', {
  "name" : "telephone", 
