...
var Reservoir = resource.define('Reservoir'); 

Reservoir.schema.description = "A reservoir, like the Lake Kariba reservoir."; 
Reservoir.persist('fs'); 


Reservoir.property('additionalType', {
  "name" : "additionalType", 
...
Reservoir.property('aggregateRating', {
...
Reservoir.property('containedIn', {
  "name" : "containedIn", 
...
Reservoir.property('globalLocationNumber', {
...
Reservoir.property('interactionCount', {
...
Reservoir.property('openingHoursSpecification', {
