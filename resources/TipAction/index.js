...
var TipAction = resource.define('TipAction'); 

TipAction.schema.description = "The act of giving money voluntarily to a beneficiary in recognition of services rendered."; 
TipAction.persist('fs'); 


TipAction.property('additionalType', {
  "name" : "additionalType", 
...
TipAction.property('description', {
  "name" : "description", 
...
TipAction.property('participant', {
  "name" : "participant", 
