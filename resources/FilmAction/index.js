...
var FilmAction = resource.define('FilmAction'); 

FilmAction.schema.description = "The act of capturing sound and moving images on film, video, or digitally."; 
FilmAction.persist('fs'); 


FilmAction.property('additionalType', {
  "name" : "additionalType", 
...
FilmAction.property('description', {
  "name" : "description", 
...
FilmAction.property('instrument', {
  "name" : "instrument", 
...
FilmAction.property('participant', {
  "name" : "participant", 
