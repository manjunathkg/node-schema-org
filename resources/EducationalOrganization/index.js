...
var EducationalOrganization = resource.define('EducationalOrganization'); 

EducationalOrganization.schema.description = "An educational organization."; 
EducationalOrganization.persist('fs'); 


EducationalOrganization.property('additionalType', {
  "name" : "additionalType", 
...
EducationalOrganization.property('description', {
  "name" : "description", 
...
EducationalOrganization.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
EducationalOrganization.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
EducationalOrganization.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
EducationalOrganization.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
EducationalOrganization.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
EducationalOrganization.property('aggregateRating', {
...
EducationalOrganization.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
EducationalOrganization.property('contactPoint', {
  "name" : "contactPoint", 
...
EducationalOrganization.property('contactPoints', {
  "name" : "contactPoints", 
...
EducationalOrganization.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
EducationalOrganization.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
EducationalOrganization.property('employee', {
  "name" : "employee", 
...
EducationalOrganization.property('employees', {
  "name" : "employees", 
...
EducationalOrganization.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
EducationalOrganization.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
EducationalOrganization.property('faxNumber', {
  "name" : "faxNumber", 
...
EducationalOrganization.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
EducationalOrganization.property('founders', {
  "name" : "founders", 
...
EducationalOrganization.property('foundingDate', {
  "name" : "foundingDate", 
...
EducationalOrganization.property('globalLocationNumber', {
...
EducationalOrganization.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
EducationalOrganization.property('interactionCount', {
...
EducationalOrganization.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
EducationalOrganization.property('legalName', {
  "name" : "legalName", 
...
EducationalOrganization.property('location', {
  "name" : "location", 
...
EducationalOrganization.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
EducationalOrganization.property('makesOffer', {
  "name" : "makesOffer", 
...
EducationalOrganization.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
EducationalOrganization.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
EducationalOrganization.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
EducationalOrganization.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
EducationalOrganization.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
EducationalOrganization.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
EducationalOrganization.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
EducationalOrganization.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
EducationalOrganization.property('telephone', {
  "name" : "telephone", 
...
EducationalOrganization.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
EducationalOrganization.property('alumni', {
  "name" : "alumni", 
  "displayName" : "Alumni", 
