...
var MusicStore = resource.define('MusicStore'); 

MusicStore.schema.description = "A music store."; 
MusicStore.persist('fs'); 


MusicStore.property('additionalType', {
  "name" : "additionalType", 
...
MusicStore.property('description', {
  "name" : "description", 
...
MusicStore.property('aggregateRating', {
...
MusicStore.property('containedIn', {
  "name" : "containedIn", 
...
MusicStore.property('globalLocationNumber', {
...
MusicStore.property('interactionCount', {
...
MusicStore.property('openingHoursSpecification', {
...
MusicStore.property('contactPoint', {
  "name" : "contactPoint", 
...
MusicStore.property('contactPoints', {
  "name" : "contactPoints", 
...
MusicStore.property('foundingDate', {
  "name" : "foundingDate", 
...
MusicStore.property('makesOffer', {
  "name" : "makesOffer", 
...
MusicStore.property('currenciesAccepted', {
...
MusicStore.property('openingHours', {
  "name" : "openingHours", 
...
MusicStore.property('paymentAccepted', {
...
MusicStore.property('priceRange', {
  "name" : "priceRange", 
