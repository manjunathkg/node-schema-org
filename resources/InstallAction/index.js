...
var InstallAction = resource.define('InstallAction'); 

InstallAction.schema.description = "The act of installing an application."; 
InstallAction.persist('fs'); 


InstallAction.property('additionalType', {
  "name" : "additionalType", 
...
InstallAction.property('description', {
  "name" : "description", 
...
InstallAction.property('endTime', {
  "name" : "endTime", 
...
InstallAction.property('instrument', {
  "name" : "instrument", 
...
InstallAction.property('location', {
  "name" : "location", 
...
InstallAction.property('participant', {
  "name" : "participant", 
...
InstallAction.property('startTime', {
  "name" : "startTime", 
