...
var HinduTemple = resource.define('HinduTemple'); 

HinduTemple.schema.description = "A Hindu temple."; 
HinduTemple.persist('fs'); 


HinduTemple.property('additionalType', {
  "name" : "additionalType", 
...
HinduTemple.property('description', {
  "name" : "description", 
...
HinduTemple.property('aggregateRating', {
...
HinduTemple.property('containedIn', {
  "name" : "containedIn", 
...
HinduTemple.property('faxNumber', {
  "name" : "faxNumber", 
...
HinduTemple.property('globalLocationNumber', {
...
HinduTemple.property('interactionCount', {
...
HinduTemple.property('openingHoursSpecification', {
...
HinduTemple.property('telephone', {
  "name" : "telephone", 
...
HinduTemple.property('openingHours', {
  "name" : "openingHours", 
