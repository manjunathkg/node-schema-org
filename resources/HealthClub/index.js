...
var HealthClub = resource.define('HealthClub'); 

HealthClub.schema.description = "A health club."; 
HealthClub.persist('fs'); 


HealthClub.property('additionalType', {
  "name" : "additionalType", 
...
HealthClub.property('description', {
  "name" : "description", 
...
HealthClub.property('aggregateRating', {
...
HealthClub.property('containedIn', {
  "name" : "containedIn", 
...
HealthClub.property('globalLocationNumber', {
...
HealthClub.property('interactionCount', {
...
HealthClub.property('openingHoursSpecification', {
...
HealthClub.property('contactPoint', {
  "name" : "contactPoint", 
...
HealthClub.property('contactPoints', {
  "name" : "contactPoints", 
...
HealthClub.property('foundingDate', {
  "name" : "foundingDate", 
...
HealthClub.property('makesOffer', {
  "name" : "makesOffer", 
...
HealthClub.property('currenciesAccepted', {
...
HealthClub.property('openingHours', {
  "name" : "openingHours", 
...
HealthClub.property('paymentAccepted', {
...
HealthClub.property('priceRange', {
  "name" : "priceRange", 
