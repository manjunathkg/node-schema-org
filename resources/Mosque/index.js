...
var Mosque = resource.define('Mosque'); 

Mosque.schema.description = "A mosque."; 
Mosque.persist('fs'); 


Mosque.property('additionalType', {
  "name" : "additionalType", 
...
Mosque.property('aggregateRating', {
...
Mosque.property('globalLocationNumber', {
...
Mosque.property('interactionCount', {
...
Mosque.property('openingHoursSpecification', {
