...
var GeneralContractor = resource.define('GeneralContractor'); 

GeneralContractor.schema.description = "A general contractor."; 
GeneralContractor.persist('fs'); 


GeneralContractor.property('additionalType', {
  "name" : "additionalType", 
...
GeneralContractor.property('description', {
  "name" : "description", 
...
GeneralContractor.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
GeneralContractor.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
GeneralContractor.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
GeneralContractor.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
GeneralContractor.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
GeneralContractor.property('aggregateRating', {
...
GeneralContractor.property('containedIn', {
  "name" : "containedIn", 
...
GeneralContractor.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
GeneralContractor.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
GeneralContractor.property('faxNumber', {
  "name" : "faxNumber", 
...
GeneralContractor.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
GeneralContractor.property('globalLocationNumber', {
...
GeneralContractor.property('interactionCount', {
...
GeneralContractor.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
GeneralContractor.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
GeneralContractor.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
GeneralContractor.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
GeneralContractor.property('openingHoursSpecification', {
...
GeneralContractor.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
GeneralContractor.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
GeneralContractor.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
GeneralContractor.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
GeneralContractor.property('telephone', {
  "name" : "telephone", 
...
GeneralContractor.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
GeneralContractor.property('contactPoint', {
  "name" : "contactPoint", 
...
GeneralContractor.property('contactPoints', {
  "name" : "contactPoints", 
...
GeneralContractor.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
GeneralContractor.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
GeneralContractor.property('employee', {
  "name" : "employee", 
...
GeneralContractor.property('employees', {
  "name" : "employees", 
...
GeneralContractor.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
GeneralContractor.property('founders', {
  "name" : "founders", 
...
GeneralContractor.property('foundingDate', {
  "name" : "foundingDate", 
...
GeneralContractor.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
GeneralContractor.property('legalName', {
  "name" : "legalName", 
...
GeneralContractor.property('location', {
  "name" : "location", 
...
GeneralContractor.property('makesOffer', {
  "name" : "makesOffer", 
...
GeneralContractor.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
GeneralContractor.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
GeneralContractor.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
GeneralContractor.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
GeneralContractor.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
GeneralContractor.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
GeneralContractor.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
GeneralContractor.property('branchOf', {
  "name" : "branchOf", 
...
GeneralContractor.property('currenciesAccepted', {
...
GeneralContractor.property('openingHours', {
  "name" : "openingHours", 
...
GeneralContractor.property('paymentAccepted', {
...
GeneralContractor.property('priceRange', {
  "name" : "priceRange", 
