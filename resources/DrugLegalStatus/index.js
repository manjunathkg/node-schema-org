...
var DrugLegalStatus = resource.define('DrugLegalStatus'); 

DrugLegalStatus.schema.description = "The legal availability status of a medical drug."; 
DrugLegalStatus.persist('fs'); 


DrugLegalStatus.property('additionalType', {
  "name" : "additionalType", 
...
DrugLegalStatus.property('description', {
  "name" : "description", 
...
DrugLegalStatus.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
DrugLegalStatus.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
DrugLegalStatus.property('alternateName', {
  "name" : "alternateName", 
...
DrugLegalStatus.property('guideline', {
  "name" : "guideline", 
...
DrugLegalStatus.property('medicineSystem', {
  "name" : "medicineSystem", 
...
DrugLegalStatus.property('recognizingAuthority', {
...
DrugLegalStatus.property('relevantSpecialty', {
...
DrugLegalStatus.property('study', {
  "name" : "study", 
  "displayName" : "Study", 
...
DrugLegalStatus.property('applicableLocation', {
