...
var MusicGroup = resource.define('MusicGroup'); 

MusicGroup.schema.description = "A musical group, such as a band, an orchestra, or a choir. Can also be a solo musician."; 
MusicGroup.persist('fs'); 


MusicGroup.property('additionalType', {
  "name" : "additionalType", 
...
MusicGroup.property('description', {
  "name" : "description", 
...
MusicGroup.property('aggregateRating', {
...
MusicGroup.property('contactPoint', {
  "name" : "contactPoint", 
...
MusicGroup.property('contactPoints', {
  "name" : "contactPoints", 
...
MusicGroup.property('foundingDate', {
  "name" : "foundingDate", 
...
MusicGroup.property('globalLocationNumber', {
...
MusicGroup.property('interactionCount', {
...
MusicGroup.property('makesOffer', {
  "name" : "makesOffer", 
