...
var CancelAction = resource.define('CancelAction'); 

CancelAction.schema.description = "The act of asserting that a future event/action is no longer going to happen.Related actions:ConfirmAction: The antagonym of CancelAction."; 
CancelAction.persist('fs'); 


CancelAction.property('additionalType', {
  "name" : "additionalType", 
...
CancelAction.property('description', {
  "name" : "description", 
...
CancelAction.property('instrument', {
  "name" : "instrument", 
...
CancelAction.property('location', {
  "name" : "location", 
...
CancelAction.property('participant', {
  "name" : "participant", 
...
CancelAction.property('startTime', {
  "name" : "startTime", 
...
CancelAction.property('scheduledTime', {
  "name" : "scheduledTime", 
