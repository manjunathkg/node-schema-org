...
var Hotel = resource.define('Hotel'); 

Hotel.schema.description = "A hotel."; 
Hotel.persist('fs'); 


Hotel.property('additionalType', {
  "name" : "additionalType", 
...
Hotel.property('aggregateRating', {
...
Hotel.property('globalLocationNumber', {
...
Hotel.property('interactionCount', {
...
Hotel.property('openingHoursSpecification', {
...
Hotel.property('currenciesAccepted', {
...
Hotel.property('paymentAccepted', {
