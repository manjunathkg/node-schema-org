...
var AppendAction = resource.define('AppendAction'); 

AppendAction.schema.description = "The act of inserting at the end if an ordered collection."; 
AppendAction.persist('fs'); 


AppendAction.property('additionalType', {
  "name" : "additionalType", 
...
AppendAction.property('description', {
  "name" : "description", 
...
AppendAction.property('instrument', {
  "name" : "instrument", 
...
AppendAction.property('location', {
  "name" : "location", 
...
AppendAction.property('participant', {
  "name" : "participant", 
...
AppendAction.property('startTime', {
  "name" : "startTime", 
...
AppendAction.property('collection', {
  "name" : "collection", 
...
AppendAction.property('toLocation', {
  "name" : "toLocation", 
