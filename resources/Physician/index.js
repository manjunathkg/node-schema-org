...
var Physician = resource.define('Physician'); 

Physician.schema.description = "A doctor&#x27;s office."; 
Physician.persist('fs'); 


Physician.property('additionalType', {
  "name" : "additionalType", 
...
Physician.property('description', {
  "name" : "description", 
...
Physician.property('aggregateRating', {
...
Physician.property('containedIn', {
  "name" : "containedIn", 
...
Physician.property('globalLocationNumber', {
...
Physician.property('interactionCount', {
...
Physician.property('openingHoursSpecification', {
...
Physician.property('contactPoint', {
  "name" : "contactPoint", 
...
Physician.property('contactPoints', {
  "name" : "contactPoints", 
...
Physician.property('foundingDate', {
  "name" : "foundingDate", 
...
Physician.property('currenciesAccepted', {
...
Physician.property('openingHours', {
  "name" : "openingHours", 
...
Physician.property('paymentAccepted', {
...
Physician.property('availableService', {
...
Physician.property('hospitalAffiliation', {
  "name" : "hospitalAffiliation", 
  "displayName" : "Hospital Affiliation", 
  "description" : "A hospital with which the physician or office is affiliated.", 
"type":"object","properties" : {"Hospital" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


Physician.property('medicalSpecialty', {
