...
var RentAction = resource.define('RentAction'); 

RentAction.schema.description = "The act of giving money in return for temporary use, but not ownership, of an object such as a vehicle or property. For example, an agent rents a property from a landlord in exchange for a periodic payment."; 
RentAction.persist('fs'); 


RentAction.property('additionalType', {
  "name" : "additionalType", 
...
RentAction.property('description', {
  "name" : "description", 
...
RentAction.property('instrument', {
  "name" : "instrument", 
...
RentAction.property('participant', {
  "name" : "participant", 
...
RentAction.property('realEstateAgent', {
  "name" : "realEstateAgent", 
  "displayName" : "Real Estateagent", 
  "description" : "A sub property of participant. The real estate agent involved in the action.", 
"type":"object","properties" : {"RealEstateAgent" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 
