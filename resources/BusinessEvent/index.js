...
var BusinessEvent = resource.define('BusinessEvent'); 

BusinessEvent.schema.description = "Event type: Business event."; 
BusinessEvent.persist('fs'); 


BusinessEvent.property('additionalType', {
  "name" : "additionalType", 
...
BusinessEvent.property('description', {
  "name" : "description", 
...
BusinessEvent.property('attendee', {
  "name" : "attendee", 
...
BusinessEvent.property('attendees', {
  "name" : "attendees", 
...
BusinessEvent.property('duration', {
  "name" : "duration", 
...
BusinessEvent.property('endDate', {
  "name" : "endDate", 
...
BusinessEvent.property('location', {
  "name" : "location", 
...
BusinessEvent.property('performer', {
  "name" : "performer", 
...
BusinessEvent.property('performers', {
  "name" : "performers", 
...
BusinessEvent.property('startDate', {
  "name" : "startDate", 
...
BusinessEvent.property('subEvent', {
  "name" : "subEvent", 
...
BusinessEvent.property('subEvents', {
  "name" : "subEvents", 
...
BusinessEvent.property('superEvent', {
  "name" : "superEvent", 
