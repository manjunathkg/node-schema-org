...
var DanceGroup = resource.define('DanceGroup'); 

DanceGroup.schema.description = "A dance group—for example, the Alvin Ailey Dance Theater or Riverdance."; 
DanceGroup.persist('fs'); 


DanceGroup.property('additionalType', {
  "name" : "additionalType", 
...
DanceGroup.property('description', {
  "name" : "description", 
...
DanceGroup.property('aggregateRating', {
...
DanceGroup.property('contactPoint', {
  "name" : "contactPoint", 
...
DanceGroup.property('contactPoints', {
  "name" : "contactPoints", 
...
DanceGroup.property('foundingDate', {
  "name" : "foundingDate", 
...
DanceGroup.property('globalLocationNumber', {
...
DanceGroup.property('interactionCount', {
...
DanceGroup.property('makesOffer', {
  "name" : "makesOffer", 
