...
var Code = resource.define('Code'); 

Code.schema.description = "Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates."; 
Code.persist('fs'); 


Code.property('additionalType', {
  "name" : "additionalType", 
...
Code.property('accountablePerson', {
...
Code.property('alternativeHeadline', {
...
Code.property('educationalAlignment', {
...
Code.property('interactionCount', {
...
Code.property('interactivityType', {
...
Code.property('isFamilyFriendly', {
...
Code.property('learningResourceType', {
...
Code.property('publishingPrinciples', {
...
Code.property('sourceOrganization', {
...
Code.property('programmingLanguage', {
...
"type":"object","properties" : {"SoftwareApplication" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 
