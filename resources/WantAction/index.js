...
var WantAction = resource.define('WantAction'); 

WantAction.schema.description = "The act of expressing a desire about the object. An agent wants an object."; 
WantAction.persist('fs'); 


WantAction.property('additionalType', {
  "name" : "additionalType", 
...
WantAction.property('description', {
  "name" : "description", 
...
WantAction.property('instrument', {
  "name" : "instrument", 
...
WantAction.property('participant', {
  "name" : "participant", 
