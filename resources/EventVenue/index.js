...
var EventVenue = resource.define('EventVenue'); 

EventVenue.schema.description = "An event venue."; 
EventVenue.persist('fs'); 


EventVenue.property('additionalType', {
  "name" : "additionalType", 
...
EventVenue.property('description', {
  "name" : "description", 
...
EventVenue.property('aggregateRating', {
...
EventVenue.property('containedIn', {
  "name" : "containedIn", 
...
EventVenue.property('globalLocationNumber', {
...
EventVenue.property('interactionCount', {
...
EventVenue.property('openingHoursSpecification', {
...
EventVenue.property('openingHours', {
  "name" : "openingHours", 
