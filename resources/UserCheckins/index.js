...
var UserCheckins = resource.define('UserCheckins'); 

UserCheckins.schema.description = "User interaction: Check-in at a place."; 
UserCheckins.persist('fs'); 


UserCheckins.property('additionalType', {
  "name" : "additionalType", 
...
UserCheckins.property('description', {
  "name" : "description", 
...
UserCheckins.property('attendee', {
  "name" : "attendee", 
...
UserCheckins.property('attendees', {
  "name" : "attendees", 
...
UserCheckins.property('duration', {
  "name" : "duration", 
...
UserCheckins.property('location', {
  "name" : "location", 
...
UserCheckins.property('performer', {
  "name" : "performer", 
...
UserCheckins.property('performers', {
  "name" : "performers", 
...
UserCheckins.property('startDate', {
  "name" : "startDate", 
...
UserCheckins.property('subEvent', {
  "name" : "subEvent", 
...
UserCheckins.property('subEvents', {
  "name" : "subEvents", 
...
UserCheckins.property('superEvent', {
  "name" : "superEvent", 
