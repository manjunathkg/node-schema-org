...
var EatAction = resource.define('EatAction'); 

EatAction.schema.description = "The act of swallowing solid objects."; 
EatAction.persist('fs'); 


EatAction.property('additionalType', {
  "name" : "additionalType", 
...
EatAction.property('description', {
  "name" : "description", 
...
EatAction.property('participant', {
  "name" : "participant", 
