...
var TVEpisode = resource.define('TVEpisode'); 

TVEpisode.schema.description = "An episode of a TV series or season."; 
TVEpisode.persist('fs'); 


TVEpisode.property('additionalType', {
  "name" : "additionalType", 
...
TVEpisode.property('description', {
  "name" : "description", 
...
TVEpisode.property('accountablePerson', {
...
TVEpisode.property('aggregateRating', {
...
TVEpisode.property('alternativeHeadline', {
...
TVEpisode.property('associatedMedia', {
...
TVEpisode.property('contentLocation', {
...
TVEpisode.property('contentRating', {
  "name" : "contentRating", 
...
TVEpisode.property('contributor', {
  "name" : "contributor", 
...
TVEpisode.property('copyrightHolder', {
...
TVEpisode.property('copyrightYear', {
  "name" : "copyrightYear", 
...
TVEpisode.property('dateCreated', {
  "name" : "dateCreated", 
...
TVEpisode.property('dateModified', {
  "name" : "dateModified", 
...
TVEpisode.property('datePublished', {
  "name" : "datePublished", 
...
TVEpisode.property('discussionUrl', {
  "name" : "discussionUrl", 
...
TVEpisode.property('educationalAlignment', {
...
TVEpisode.property('educationalUse', {
  "name" : "educationalUse", 
...
TVEpisode.property('interactionCount', {
...
TVEpisode.property('interactivityType', {
...
TVEpisode.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
TVEpisode.property('isFamilyFriendly', {
...
TVEpisode.property('learningResourceType', {
...
TVEpisode.property('publishingPrinciples', {
...
TVEpisode.property('sourceOrganization', {
...
TVEpisode.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
TVEpisode.property('timeRequired', {
  "name" : "timeRequired", 
...
TVEpisode.property('typicalAgeRange', {
...
TVEpisode.property('episodeNumber', {
  "name" : "episodeNumber", 
...
TVEpisode.property('partOfSeason', {
  "name" : "partOfSeason", 
  "displayName" : "Part Ofseason", 
  "description" : "The season to which this episode belongs.", 
"type":"object","properties" : {"TVSeason" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


TVEpisode.property('partOfTVSeries', {
  "name" : "partOfTVSeries", 
  "displayName" : "Part Oftvseries", 
  "description" : "The TV series to which this episode or season belongs.", 
"type":"object","properties" : {"TVSeries" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


TVEpisode.property('producer', {
  "name" : "producer", 
...
TVEpisode.property('productionCompany', {
