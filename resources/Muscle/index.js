...
var Muscle = resource.define('Muscle'); 

Muscle.schema.description = "A muscle is an anatomical structure consisting of a contractile form of tissue that animals use to effect movement."; 
Muscle.persist('fs'); 


Muscle.property('additionalType', {
  "name" : "additionalType", 
...
Muscle.property('medicineSystem', {
  "name" : "medicineSystem", 
...
Muscle.property('recognizingAuthority', {
...
Muscle.property('relevantSpecialty', {
...
Muscle.property('associatedPathophysiology', {
...
Muscle.property('relatedCondition', {
...
Muscle.property('relatedTherapy', {
  "name" : "relatedTherapy", 
...
Muscle.property('nerve', {
  "name" : "nerve", 
  "displayName" : "Nerve", 
  "description" : "The underlying innervation associated with the muscle.", 
"type":"object","properties" : {"Nerve" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


Muscle.property('origin', {
  "name" : "origin", 
  "displayName" : "Origin", 
