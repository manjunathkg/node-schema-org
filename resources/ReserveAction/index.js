...
var ReserveAction = resource.define('ReserveAction'); 

ReserveAction.schema.description = "Reserving a concrete object.Related actions:ScheduleAction: Unlike ScheduleAction, ReserveAction reserves concrete objects (e.g. a table, a hotel) towards a time slot / spatial allocation."; 
ReserveAction.persist('fs'); 


ReserveAction.property('additionalType', {
  "name" : "additionalType", 
...
ReserveAction.property('description', {
  "name" : "description", 
...
ReserveAction.property('endTime', {
  "name" : "endTime", 
...
ReserveAction.property('instrument', {
  "name" : "instrument", 
...
ReserveAction.property('location', {
  "name" : "location", 
...
ReserveAction.property('participant', {
  "name" : "participant", 
...
ReserveAction.property('startTime', {
  "name" : "startTime", 
...
ReserveAction.property('scheduledTime', {
  "name" : "scheduledTime", 
