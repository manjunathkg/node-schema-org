...
var ShoeStore = resource.define('ShoeStore'); 

ShoeStore.schema.description = "A shoe store."; 
ShoeStore.persist('fs'); 


ShoeStore.property('additionalType', {
  "name" : "additionalType", 
...
ShoeStore.property('description', {
  "name" : "description", 
...
ShoeStore.property('aggregateRating', {
...
ShoeStore.property('containedIn', {
  "name" : "containedIn", 
...
ShoeStore.property('globalLocationNumber', {
...
ShoeStore.property('interactionCount', {
...
ShoeStore.property('openingHoursSpecification', {
...
ShoeStore.property('contactPoint', {
  "name" : "contactPoint", 
...
ShoeStore.property('contactPoints', {
  "name" : "contactPoints", 
...
ShoeStore.property('foundingDate', {
  "name" : "foundingDate", 
...
ShoeStore.property('currenciesAccepted', {
...
ShoeStore.property('openingHours', {
  "name" : "openingHours", 
...
ShoeStore.property('paymentAccepted', {
