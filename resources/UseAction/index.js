...
var UseAction = resource.define('UseAction'); 

UseAction.schema.description = "The act of applying an object to its intended purpose."; 
UseAction.persist('fs'); 


UseAction.property('additionalType', {
  "name" : "additionalType", 
...
UseAction.property('description', {
  "name" : "description", 
...
UseAction.property('participant', {
  "name" : "participant", 
