...
var SportsClub = resource.define('SportsClub'); 

SportsClub.schema.description = "A sports club."; 
SportsClub.persist('fs'); 


SportsClub.property('additionalType', {
  "name" : "additionalType", 
...
SportsClub.property('description', {
  "name" : "description", 
...
SportsClub.property('aggregateRating', {
...
SportsClub.property('containedIn', {
  "name" : "containedIn", 
...
SportsClub.property('globalLocationNumber', {
...
SportsClub.property('interactionCount', {
...
SportsClub.property('openingHoursSpecification', {
...
SportsClub.property('contactPoint', {
  "name" : "contactPoint", 
...
SportsClub.property('contactPoints', {
  "name" : "contactPoints", 
...
SportsClub.property('foundingDate', {
  "name" : "foundingDate", 
...
SportsClub.property('makesOffer', {
  "name" : "makesOffer", 
...
SportsClub.property('currenciesAccepted', {
...
SportsClub.property('openingHours', {
  "name" : "openingHours", 
...
SportsClub.property('paymentAccepted', {
...
SportsClub.property('priceRange', {
  "name" : "priceRange", 
