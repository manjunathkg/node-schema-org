...
var DonateAction = resource.define('DonateAction'); 

DonateAction.schema.description = "The act of providing goods, services, or money without compensation, often for philanthropic reasons."; 
DonateAction.persist('fs'); 


DonateAction.property('additionalType', {
  "name" : "additionalType", 
...
DonateAction.property('description', {
  "name" : "description", 
...
DonateAction.property('instrument', {
  "name" : "instrument", 
...
DonateAction.property('location', {
  "name" : "location", 
...
DonateAction.property('participant', {
  "name" : "participant", 
...
DonateAction.property('startTime', {
  "name" : "startTime", 
...
DonateAction.property('recipient', {
  "name" : "recipient", 
