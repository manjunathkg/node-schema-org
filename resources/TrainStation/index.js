...
var TrainStation = resource.define('TrainStation'); 

TrainStation.schema.description = "A train station."; 
TrainStation.persist('fs'); 


TrainStation.property('additionalType', {
  "name" : "additionalType", 
...
TrainStation.property('description', {
  "name" : "description", 
...
TrainStation.property('aggregateRating', {
...
TrainStation.property('containedIn', {
  "name" : "containedIn", 
...
TrainStation.property('faxNumber', {
  "name" : "faxNumber", 
...
TrainStation.property('globalLocationNumber', {
...
TrainStation.property('interactionCount', {
...
TrainStation.property('openingHoursSpecification', {
...
TrainStation.property('telephone', {
  "name" : "telephone", 
...
TrainStation.property('openingHours', {
  "name" : "openingHours", 
