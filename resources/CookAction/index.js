...
var CookAction = resource.define('CookAction'); 

CookAction.schema.description = "The act of producing/preparing food."; 
CookAction.persist('fs'); 


CookAction.property('additionalType', {
  "name" : "additionalType", 
...
CookAction.property('description', {
  "name" : "description", 
...
CookAction.property('instrument', {
  "name" : "instrument", 
...
CookAction.property('participant', {
  "name" : "participant", 
...
CookAction.property('foodEstablishment', {
  "name" : "foodEstablishment", 
  "displayName" : "Food Establishment", 
  "description" : "A sub property of location. The specific food establishment where the action occurreed.", 
"type":"object","properties" : {"FoodEstablishment" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}},"Place" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


CookAction.property('foodEvent', {
  "name" : "foodEvent", 
  "displayName" : "Food Event", 
  "description" : "A sub property of location. The specific food event where the action occurred.", 
"type":"object","properties" : {"FoodEvent" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


CookAction.property('recipe', {
  "name" : "recipe", 
  "displayName" : "Recipe", 
  "description" : "A sub property of instrument. The recipe/instructions used to perform the action.", 
"type":"object","properties" : {"Recipe" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 
