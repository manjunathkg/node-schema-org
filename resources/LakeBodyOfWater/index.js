...
var LakeBodyOfWater = resource.define('LakeBodyOfWater'); 

LakeBodyOfWater.schema.description = "A lake (for example, Lake Pontrachain)."; 
LakeBodyOfWater.persist('fs'); 


LakeBodyOfWater.property('additionalType', {
  "name" : "additionalType", 
...
LakeBodyOfWater.property('description', {
  "name" : "description", 
...
LakeBodyOfWater.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
LakeBodyOfWater.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
LakeBodyOfWater.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
LakeBodyOfWater.property('aggregateRating', {
...
LakeBodyOfWater.property('containedIn', {
  "name" : "containedIn", 
...
LakeBodyOfWater.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
LakeBodyOfWater.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
LakeBodyOfWater.property('faxNumber', {
  "name" : "faxNumber", 
...
LakeBodyOfWater.property('globalLocationNumber', {
...
LakeBodyOfWater.property('interactionCount', {
...
LakeBodyOfWater.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
LakeBodyOfWater.property('openingHoursSpecification', {
...
LakeBodyOfWater.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
LakeBodyOfWater.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
LakeBodyOfWater.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
LakeBodyOfWater.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
LakeBodyOfWater.property('telephone', {
  "name" : "telephone", 
