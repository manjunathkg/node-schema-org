...
var Canal = resource.define('Canal'); 

Canal.schema.description = "A canal, like the Panama Canal"; 
Canal.persist('fs'); 


Canal.property('additionalType', {
  "name" : "additionalType", 
...
Canal.property('aggregateRating', {
...
Canal.property('globalLocationNumber', {
...
Canal.property('interactionCount', {
...
Canal.property('openingHoursSpecification', {
