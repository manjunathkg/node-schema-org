...
var MovieRentalStore = resource.define('MovieRentalStore'); 

MovieRentalStore.schema.description = "A movie rental store."; 
MovieRentalStore.persist('fs'); 


MovieRentalStore.property('additionalType', {
  "name" : "additionalType", 
...
MovieRentalStore.property('description', {
  "name" : "description", 
...
MovieRentalStore.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MovieRentalStore.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MovieRentalStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MovieRentalStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
MovieRentalStore.property('aggregateRating', {
...
MovieRentalStore.property('containedIn', {
  "name" : "containedIn", 
...
MovieRentalStore.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
MovieRentalStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
MovieRentalStore.property('faxNumber', {
  "name" : "faxNumber", 
...
MovieRentalStore.property('globalLocationNumber', {
...
MovieRentalStore.property('interactionCount', {
...
MovieRentalStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
MovieRentalStore.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
MovieRentalStore.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
MovieRentalStore.property('openingHoursSpecification', {
...
MovieRentalStore.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
MovieRentalStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
MovieRentalStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MovieRentalStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MovieRentalStore.property('telephone', {
  "name" : "telephone", 
...
MovieRentalStore.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
MovieRentalStore.property('contactPoint', {
  "name" : "contactPoint", 
...
MovieRentalStore.property('contactPoints', {
  "name" : "contactPoints", 
...
MovieRentalStore.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
MovieRentalStore.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
MovieRentalStore.property('employee', {
  "name" : "employee", 
...
MovieRentalStore.property('employees', {
  "name" : "employees", 
...
MovieRentalStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
MovieRentalStore.property('founders', {
  "name" : "founders", 
...
MovieRentalStore.property('foundingDate', {
  "name" : "foundingDate", 
...
MovieRentalStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
MovieRentalStore.property('legalName', {
  "name" : "legalName", 
...
MovieRentalStore.property('location', {
  "name" : "location", 
...
MovieRentalStore.property('makesOffer', {
  "name" : "makesOffer", 
...
MovieRentalStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
MovieRentalStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
MovieRentalStore.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
MovieRentalStore.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
MovieRentalStore.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
MovieRentalStore.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
MovieRentalStore.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
MovieRentalStore.property('branchOf', {
  "name" : "branchOf", 
...
MovieRentalStore.property('currenciesAccepted', {
...
MovieRentalStore.property('openingHours', {
  "name" : "openingHours", 
...
MovieRentalStore.property('paymentAccepted', {
...
MovieRentalStore.property('priceRange', {
  "name" : "priceRange", 
