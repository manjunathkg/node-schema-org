...
var GolfCourse = resource.define('GolfCourse'); 

GolfCourse.schema.description = "A golf course."; 
GolfCourse.persist('fs'); 


GolfCourse.property('additionalType', {
  "name" : "additionalType", 
...
GolfCourse.property('description', {
  "name" : "description", 
...
GolfCourse.property('aggregateRating', {
...
GolfCourse.property('containedIn', {
  "name" : "containedIn", 
...
GolfCourse.property('globalLocationNumber', {
...
GolfCourse.property('interactionCount', {
...
GolfCourse.property('openingHoursSpecification', {
...
GolfCourse.property('contactPoint', {
  "name" : "contactPoint", 
...
GolfCourse.property('contactPoints', {
  "name" : "contactPoints", 
...
GolfCourse.property('foundingDate', {
  "name" : "foundingDate", 
...
GolfCourse.property('makesOffer', {
  "name" : "makesOffer", 
...
GolfCourse.property('currenciesAccepted', {
...
GolfCourse.property('openingHours', {
  "name" : "openingHours", 
...
GolfCourse.property('paymentAccepted', {
...
GolfCourse.property('priceRange', {
  "name" : "priceRange", 
