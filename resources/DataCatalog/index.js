...
var DataCatalog = resource.define('DataCatalog'); 

DataCatalog.schema.description = "A collection of datasets."; 
DataCatalog.persist('fs'); 


DataCatalog.property('additionalType', {
  "name" : "additionalType", 
...
DataCatalog.property('description', {
  "name" : "description", 
...
DataCatalog.property('accountablePerson', {
...
DataCatalog.property('aggregateRating', {
...
DataCatalog.property('alternativeHeadline', {
...
DataCatalog.property('associatedMedia', {
...
DataCatalog.property('contentLocation', {
...
DataCatalog.property('contentRating', {
  "name" : "contentRating", 
...
DataCatalog.property('contributor', {
  "name" : "contributor", 
...
DataCatalog.property('copyrightHolder', {
...
DataCatalog.property('copyrightYear', {
  "name" : "copyrightYear", 
...
DataCatalog.property('dateCreated', {
  "name" : "dateCreated", 
...
DataCatalog.property('dateModified', {
  "name" : "dateModified", 
...
DataCatalog.property('datePublished', {
  "name" : "datePublished", 
...
DataCatalog.property('discussionUrl', {
  "name" : "discussionUrl", 
...
DataCatalog.property('educationalAlignment', {
...
DataCatalog.property('educationalUse', {
  "name" : "educationalUse", 
...
DataCatalog.property('encodings', {
  "name" : "encodings", 
...
DataCatalog.property('inLanguage', {
  "name" : "inLanguage", 
...
DataCatalog.property('interactionCount', {
...
DataCatalog.property('interactivityType', {
...
DataCatalog.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
DataCatalog.property('isFamilyFriendly', {
...
DataCatalog.property('learningResourceType', {
...
DataCatalog.property('publisher', {
  "name" : "publisher", 
...
DataCatalog.property('publishingPrinciples', {
...
DataCatalog.property('sourceOrganization', {
...
DataCatalog.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
DataCatalog.property('timeRequired', {
  "name" : "timeRequired", 
...
DataCatalog.property('typicalAgeRange', {
...
DataCatalog.property('dataset', {
  "name" : "dataset", 
  "displayName" : "Dataset", 
  "description" : "A dataset contained in a catalog.", 
"type":"object","properties" : {"Dataset" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 
