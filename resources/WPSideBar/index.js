...
var WPSideBar = resource.define('WPSideBar'); 

WPSideBar.schema.description = "A sidebar section of the page."; 
WPSideBar.persist('fs'); 


WPSideBar.property('additionalType', {
  "name" : "additionalType", 
...
WPSideBar.property('description', {
  "name" : "description", 
...
WPSideBar.property('accountablePerson', {
...
WPSideBar.property('aggregateRating', {
...
WPSideBar.property('alternativeHeadline', {
...
WPSideBar.property('associatedMedia', {
...
WPSideBar.property('contentLocation', {
...
WPSideBar.property('contentRating', {
  "name" : "contentRating", 
...
WPSideBar.property('contributor', {
  "name" : "contributor", 
...
WPSideBar.property('copyrightHolder', {
...
WPSideBar.property('copyrightYear', {
  "name" : "copyrightYear", 
...
WPSideBar.property('dateCreated', {
  "name" : "dateCreated", 
...
WPSideBar.property('dateModified', {
  "name" : "dateModified", 
...
WPSideBar.property('datePublished', {
  "name" : "datePublished", 
...
WPSideBar.property('discussionUrl', {
  "name" : "discussionUrl", 
...
WPSideBar.property('educationalAlignment', {
...
WPSideBar.property('educationalUse', {
  "name" : "educationalUse", 
...
WPSideBar.property('interactionCount', {
...
WPSideBar.property('interactivityType', {
...
WPSideBar.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
WPSideBar.property('isFamilyFriendly', {
...
WPSideBar.property('learningResourceType', {
...
WPSideBar.property('publishingPrinciples', {
...
WPSideBar.property('sourceOrganization', {
...
WPSideBar.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
WPSideBar.property('timeRequired', {
  "name" : "timeRequired", 
...
WPSideBar.property('typicalAgeRange', {
