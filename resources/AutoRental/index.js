...
var AutoRental = resource.define('AutoRental'); 

AutoRental.schema.description = "A car rental business."; 
AutoRental.persist('fs'); 


AutoRental.property('additionalType', {
  "name" : "additionalType", 
...
AutoRental.property('description', {
  "name" : "description", 
...
AutoRental.property('aggregateRating', {
...
AutoRental.property('containedIn', {
  "name" : "containedIn", 
...
AutoRental.property('globalLocationNumber', {
...
AutoRental.property('interactionCount', {
...
AutoRental.property('openingHoursSpecification', {
...
AutoRental.property('contactPoint', {
  "name" : "contactPoint", 
...
AutoRental.property('contactPoints', {
  "name" : "contactPoints", 
...
AutoRental.property('foundingDate', {
  "name" : "foundingDate", 
...
AutoRental.property('makesOffer', {
  "name" : "makesOffer", 
...
AutoRental.property('currenciesAccepted', {
...
AutoRental.property('openingHours', {
  "name" : "openingHours", 
...
AutoRental.property('paymentAccepted', {
...
AutoRental.property('priceRange', {
  "name" : "priceRange", 
