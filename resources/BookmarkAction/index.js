...
var BookmarkAction = resource.define('BookmarkAction'); 

BookmarkAction.schema.description = "An agent bookmarks/flags/labels/tags/marks an object."; 
BookmarkAction.persist('fs'); 


BookmarkAction.property('additionalType', {
  "name" : "additionalType", 
...
BookmarkAction.property('description', {
  "name" : "description", 
...
BookmarkAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
BookmarkAction.property('endTime', {
  "name" : "endTime", 
...
BookmarkAction.property('instrument', {
  "name" : "instrument", 
...
BookmarkAction.property('location', {
  "name" : "location", 
...
BookmarkAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
BookmarkAction.property('participant', {
  "name" : "participant", 
...
BookmarkAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
BookmarkAction.property('startTime', {
  "name" : "startTime", 
