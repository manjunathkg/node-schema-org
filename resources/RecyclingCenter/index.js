...
var RecyclingCenter = resource.define('RecyclingCenter'); 

RecyclingCenter.schema.description = "A recycling center."; 
RecyclingCenter.persist('fs'); 


RecyclingCenter.property('additionalType', {
  "name" : "additionalType", 
...
RecyclingCenter.property('description', {
  "name" : "description", 
...
RecyclingCenter.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
RecyclingCenter.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
RecyclingCenter.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
RecyclingCenter.property('aggregateRating', {
...
RecyclingCenter.property('containedIn', {
  "name" : "containedIn", 
...
RecyclingCenter.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
RecyclingCenter.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
RecyclingCenter.property('faxNumber', {
  "name" : "faxNumber", 
...
RecyclingCenter.property('globalLocationNumber', {
...
RecyclingCenter.property('interactionCount', {
...
RecyclingCenter.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
RecyclingCenter.property('openingHoursSpecification', {
...
RecyclingCenter.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
RecyclingCenter.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
RecyclingCenter.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
RecyclingCenter.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
RecyclingCenter.property('telephone', {
  "name" : "telephone", 
...
RecyclingCenter.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
RecyclingCenter.property('contactPoint', {
  "name" : "contactPoint", 
...
RecyclingCenter.property('contactPoints', {
  "name" : "contactPoints", 
...
RecyclingCenter.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
RecyclingCenter.property('employee', {
  "name" : "employee", 
...
RecyclingCenter.property('employees', {
  "name" : "employees", 
...
RecyclingCenter.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
RecyclingCenter.property('founders', {
  "name" : "founders", 
...
RecyclingCenter.property('foundingDate', {
  "name" : "foundingDate", 
...
RecyclingCenter.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
RecyclingCenter.property('legalName', {
  "name" : "legalName", 
...
RecyclingCenter.property('location', {
  "name" : "location", 
...
RecyclingCenter.property('makesOffer', {
  "name" : "makesOffer", 
...
RecyclingCenter.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
RecyclingCenter.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
RecyclingCenter.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
RecyclingCenter.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
RecyclingCenter.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
RecyclingCenter.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
RecyclingCenter.property('branchOf', {
  "name" : "branchOf", 
...
RecyclingCenter.property('currenciesAccepted', {
...
RecyclingCenter.property('openingHours', {
  "name" : "openingHours", 
...
RecyclingCenter.property('paymentAccepted', {
...
RecyclingCenter.property('priceRange', {
  "name" : "priceRange", 
