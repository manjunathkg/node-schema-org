...
var DownloadAction = resource.define('DownloadAction'); 

DownloadAction.schema.description = "The act of downloading an object."; 
DownloadAction.persist('fs'); 


DownloadAction.property('additionalType', {
  "name" : "additionalType", 
...
DownloadAction.property('description', {
  "name" : "description", 
...
DownloadAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
DownloadAction.property('endTime', {
  "name" : "endTime", 
...
DownloadAction.property('instrument', {
  "name" : "instrument", 
...
DownloadAction.property('location', {
  "name" : "location", 
...
DownloadAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
DownloadAction.property('participant', {
  "name" : "participant", 
...
DownloadAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
DownloadAction.property('startTime', {
  "name" : "startTime", 
...
DownloadAction.property('fromLocation', {
  "name" : "fromLocation", 
...
DownloadAction.property('toLocation', {
  "name" : "toLocation", 
