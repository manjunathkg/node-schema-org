...
var Recipe = resource.define('Recipe'); 

Recipe.schema.description = "A recipe."; 
Recipe.persist('fs'); 


Recipe.property('additionalType', {
  "name" : "additionalType", 
...
Recipe.property('accountablePerson', {
...
Recipe.property('aggregateRating', {
...
Recipe.property('alternativeHeadline', {
...
Recipe.property('associatedMedia', {
...
Recipe.property('contentLocation', {
...
Recipe.property('copyrightHolder', {
...
Recipe.property('educationalAlignment', {
...
Recipe.property('educationalUse', {
  "name" : "educationalUse", 
...
Recipe.property('interactionCount', {
...
Recipe.property('interactivityType', {
...
Recipe.property('isFamilyFriendly', {
...
Recipe.property('learningResourceType', {
...
Recipe.property('publishingPrinciples', {
...
Recipe.property('sourceOrganization', {
...
Recipe.property('typicalAgeRange', {
...
Recipe.property('nutrition', {
  "name" : "nutrition", 
  "displayName" : "Nutrition", 
  "description" : "Nutrition information about the recipe.", 
"type":"object","properties" : {"NutritionInformation" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


Recipe.property('prepTime', {
  "name" : "prepTime", 
...
Recipe.property('recipeCategory', {
  "name" : "recipeCategory", 
...
Recipe.property('recipeCuisine', {
  "name" : "recipeCuisine", 
  "displayName" : "Recipe Cuisine", 
  "description" : "The cuisine of the recipe (for example, French or Ethopian).", 
"type":  "string" 
}); 


Recipe.property('recipeInstructions', {
