...
var BuyAction = resource.define('BuyAction'); 

BuyAction.schema.description = "The act of giving money to a seller in exchange for goods or services rendered. An agent buys an object, product, or service from a seller for a price. Reciprocal of SellAction."; 
BuyAction.persist('fs'); 


BuyAction.property('additionalType', {
  "name" : "additionalType", 
...
BuyAction.property('description', {
  "name" : "description", 
...
BuyAction.property('participant', {
  "name" : "participant", 
...
BuyAction.property('warrantyPromise', {
