...
var CatholicChurch = resource.define('CatholicChurch'); 

CatholicChurch.schema.description = "A Catholic church."; 
CatholicChurch.persist('fs'); 


CatholicChurch.property('additionalType', {
  "name" : "additionalType", 
...
CatholicChurch.property('description', {
  "name" : "description", 
...
CatholicChurch.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
CatholicChurch.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
CatholicChurch.property('aggregateRating', {
...
CatholicChurch.property('containedIn', {
  "name" : "containedIn", 
...
CatholicChurch.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
CatholicChurch.property('faxNumber', {
  "name" : "faxNumber", 
...
CatholicChurch.property('globalLocationNumber', {
...
CatholicChurch.property('interactionCount', {
...
CatholicChurch.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
CatholicChurch.property('openingHoursSpecification', {
...
CatholicChurch.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
CatholicChurch.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
CatholicChurch.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
CatholicChurch.property('telephone', {
  "name" : "telephone", 
...
CatholicChurch.property('openingHours', {
  "name" : "openingHours", 
