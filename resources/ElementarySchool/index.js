...
var ElementarySchool = resource.define('ElementarySchool'); 

ElementarySchool.schema.description = "An elementary school."; 
ElementarySchool.persist('fs'); 


ElementarySchool.property('additionalType', {
  "name" : "additionalType", 
...
ElementarySchool.property('description', {
  "name" : "description", 
...
ElementarySchool.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
ElementarySchool.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
ElementarySchool.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ElementarySchool.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
ElementarySchool.property('aggregateRating', {
...
ElementarySchool.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
ElementarySchool.property('contactPoint', {
  "name" : "contactPoint", 
...
ElementarySchool.property('contactPoints', {
  "name" : "contactPoints", 
...
ElementarySchool.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
ElementarySchool.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
ElementarySchool.property('employee', {
  "name" : "employee", 
...
ElementarySchool.property('employees', {
  "name" : "employees", 
...
ElementarySchool.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
ElementarySchool.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
ElementarySchool.property('faxNumber', {
  "name" : "faxNumber", 
...
ElementarySchool.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
ElementarySchool.property('founders', {
  "name" : "founders", 
...
ElementarySchool.property('foundingDate', {
  "name" : "foundingDate", 
...
ElementarySchool.property('globalLocationNumber', {
...
ElementarySchool.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
ElementarySchool.property('interactionCount', {
...
ElementarySchool.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
ElementarySchool.property('legalName', {
  "name" : "legalName", 
...
ElementarySchool.property('location', {
  "name" : "location", 
...
ElementarySchool.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
ElementarySchool.property('makesOffer', {
  "name" : "makesOffer", 
...
ElementarySchool.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
ElementarySchool.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
ElementarySchool.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
ElementarySchool.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
ElementarySchool.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
ElementarySchool.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
ElementarySchool.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
ElementarySchool.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
ElementarySchool.property('telephone', {
  "name" : "telephone", 
...
ElementarySchool.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
ElementarySchool.property('alumni', {
  "name" : "alumni", 
  "displayName" : "Alumni", 
