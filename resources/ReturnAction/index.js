...
var ReturnAction = resource.define('ReturnAction'); 

ReturnAction.schema.description = "The act of returning to the origin that which was previously received (concrete objects) or taken (ownership)."; 
ReturnAction.persist('fs'); 


ReturnAction.property('additionalType', {
  "name" : "additionalType", 
...
ReturnAction.property('description', {
  "name" : "description", 
...
ReturnAction.property('instrument', {
  "name" : "instrument", 
...
ReturnAction.property('location', {
  "name" : "location", 
...
ReturnAction.property('participant', {
  "name" : "participant", 
...
ReturnAction.property('startTime', {
  "name" : "startTime", 
...
ReturnAction.property('fromLocation', {
  "name" : "fromLocation", 
...
ReturnAction.property('toLocation', {
  "name" : "toLocation", 
...
ReturnAction.property('recipient', {
  "name" : "recipient", 
