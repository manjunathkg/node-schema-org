...
var PetStore = resource.define('PetStore'); 

PetStore.schema.description = "A pet store."; 
PetStore.persist('fs'); 


PetStore.property('additionalType', {
  "name" : "additionalType", 
...
PetStore.property('aggregateRating', {
...
PetStore.property('globalLocationNumber', {
...
PetStore.property('interactionCount', {
...
PetStore.property('openingHoursSpecification', {
...
PetStore.property('contactPoint', {
  "name" : "contactPoint", 
...
PetStore.property('contactPoints', {
  "name" : "contactPoints", 
...
PetStore.property('foundingDate', {
  "name" : "foundingDate", 
...
PetStore.property('currenciesAccepted', {
...
PetStore.property('openingHours', {
  "name" : "openingHours", 
...
PetStore.property('paymentAccepted', {
