...
var Offer = resource.define('Offer'); 

Offer.schema.description = "An offer to sell an item—for example, an offer to sell a product, the DVD of a movie, or tickets to an event."; 
Offer.persist('fs'); 


Offer.property('additionalType', {
  "name" : "additionalType", 
...
Offer.property('acceptedPaymentMethod', {
...
Offer.property('advanceBookingRequirement', {
...
Offer.property('aggregateRating', {
...
Offer.property('availabilityEnds', {
...
Offer.property('availabilityStarts', {
...
Offer.property('availableAtOrFrom', {
...
Offer.property('availableDeliveryMethod', {
...
Offer.property('businessFunction', {
...
Offer.property('deliveryLeadTime', {
...
Offer.property('eligibleCustomerType', {
...
Offer.property('eligibleDuration', {
...
Offer.property('eligibleQuantity', {
...
Offer.property('eligibleTransactionVolume', {
...
Offer.property('priceSpecification', {
...
Offer.property('priceValidUntil', {
