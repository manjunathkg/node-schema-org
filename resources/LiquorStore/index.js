...
var LiquorStore = resource.define('LiquorStore'); 

LiquorStore.schema.description = "A liquor store."; 
LiquorStore.persist('fs'); 


LiquorStore.property('additionalType', {
  "name" : "additionalType", 
...
LiquorStore.property('description', {
  "name" : "description", 
...
LiquorStore.property('aggregateRating', {
...
LiquorStore.property('containedIn', {
  "name" : "containedIn", 
...
LiquorStore.property('faxNumber', {
  "name" : "faxNumber", 
...
LiquorStore.property('globalLocationNumber', {
...
LiquorStore.property('interactionCount', {
...
LiquorStore.property('openingHoursSpecification', {
...
LiquorStore.property('telephone', {
  "name" : "telephone", 
...
LiquorStore.property('contactPoint', {
  "name" : "contactPoint", 
...
LiquorStore.property('contactPoints', {
  "name" : "contactPoints", 
...
LiquorStore.property('employees', {
  "name" : "employees", 
...
LiquorStore.property('foundingDate', {
  "name" : "foundingDate", 
...
LiquorStore.property('legalName', {
  "name" : "legalName", 
...
LiquorStore.property('makesOffer', {
  "name" : "makesOffer", 
...
LiquorStore.property('currenciesAccepted', {
...
LiquorStore.property('openingHours', {
  "name" : "openingHours", 
...
LiquorStore.property('paymentAccepted', {
...
LiquorStore.property('priceRange', {
  "name" : "priceRange", 
