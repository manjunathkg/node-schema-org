...
var DepartmentStore = resource.define('DepartmentStore'); 

DepartmentStore.schema.description = "A department store."; 
DepartmentStore.persist('fs'); 


DepartmentStore.property('additionalType', {
  "name" : "additionalType", 
...
DepartmentStore.property('description', {
  "name" : "description", 
...
DepartmentStore.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
DepartmentStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
DepartmentStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
DepartmentStore.property('aggregateRating', {
...
DepartmentStore.property('containedIn', {
  "name" : "containedIn", 
...
DepartmentStore.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
DepartmentStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
DepartmentStore.property('faxNumber', {
  "name" : "faxNumber", 
...
DepartmentStore.property('globalLocationNumber', {
...
DepartmentStore.property('interactionCount', {
...
DepartmentStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
DepartmentStore.property('openingHoursSpecification', {
...
DepartmentStore.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
DepartmentStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
DepartmentStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
DepartmentStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
DepartmentStore.property('telephone', {
  "name" : "telephone", 
...
DepartmentStore.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
DepartmentStore.property('contactPoint', {
  "name" : "contactPoint", 
...
DepartmentStore.property('contactPoints', {
  "name" : "contactPoints", 
...
DepartmentStore.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
DepartmentStore.property('employee', {
  "name" : "employee", 
...
DepartmentStore.property('employees', {
  "name" : "employees", 
...
DepartmentStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
DepartmentStore.property('founders', {
  "name" : "founders", 
...
DepartmentStore.property('foundingDate', {
  "name" : "foundingDate", 
...
DepartmentStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
DepartmentStore.property('legalName', {
  "name" : "legalName", 
...
DepartmentStore.property('location', {
  "name" : "location", 
...
DepartmentStore.property('makesOffer', {
  "name" : "makesOffer", 
...
DepartmentStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
DepartmentStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
DepartmentStore.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
DepartmentStore.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
DepartmentStore.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
DepartmentStore.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
DepartmentStore.property('branchOf', {
  "name" : "branchOf", 
...
DepartmentStore.property('currenciesAccepted', {
...
DepartmentStore.property('openingHours', {
  "name" : "openingHours", 
...
DepartmentStore.property('paymentAccepted', {
...
DepartmentStore.property('priceRange', {
  "name" : "priceRange", 
