...
var NailSalon = resource.define('NailSalon'); 

NailSalon.schema.description = "A nail salon."; 
NailSalon.persist('fs'); 


NailSalon.property('additionalType', {
  "name" : "additionalType", 
...
NailSalon.property('description', {
  "name" : "description", 
...
NailSalon.property('aggregateRating', {
...
NailSalon.property('containedIn', {
  "name" : "containedIn", 
...
NailSalon.property('globalLocationNumber', {
...
NailSalon.property('interactionCount', {
...
NailSalon.property('openingHoursSpecification', {
...
NailSalon.property('contactPoint', {
  "name" : "contactPoint", 
...
NailSalon.property('contactPoints', {
  "name" : "contactPoints", 
...
NailSalon.property('foundingDate', {
  "name" : "foundingDate", 
...
NailSalon.property('currenciesAccepted', {
...
NailSalon.property('openingHours', {
  "name" : "openingHours", 
...
NailSalon.property('paymentAccepted', {
