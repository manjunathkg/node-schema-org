...
var SportingGoodsStore = resource.define('SportingGoodsStore'); 

SportingGoodsStore.schema.description = "A sporting goods store."; 
SportingGoodsStore.persist('fs'); 


SportingGoodsStore.property('additionalType', {
  "name" : "additionalType", 
...
SportingGoodsStore.property('description', {
  "name" : "description", 
...
SportingGoodsStore.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
SportingGoodsStore.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
SportingGoodsStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
SportingGoodsStore.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
SportingGoodsStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
SportingGoodsStore.property('aggregateRating', {
...
SportingGoodsStore.property('containedIn', {
  "name" : "containedIn", 
...
SportingGoodsStore.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
SportingGoodsStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
SportingGoodsStore.property('faxNumber', {
  "name" : "faxNumber", 
...
SportingGoodsStore.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
SportingGoodsStore.property('globalLocationNumber', {
...
SportingGoodsStore.property('interactionCount', {
...
SportingGoodsStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
SportingGoodsStore.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
SportingGoodsStore.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
SportingGoodsStore.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
SportingGoodsStore.property('openingHoursSpecification', {
...
SportingGoodsStore.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
SportingGoodsStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
SportingGoodsStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
SportingGoodsStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
SportingGoodsStore.property('telephone', {
  "name" : "telephone", 
...
SportingGoodsStore.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
SportingGoodsStore.property('contactPoint', {
  "name" : "contactPoint", 
...
SportingGoodsStore.property('contactPoints', {
  "name" : "contactPoints", 
...
SportingGoodsStore.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
SportingGoodsStore.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
SportingGoodsStore.property('employee', {
  "name" : "employee", 
...
SportingGoodsStore.property('employees', {
  "name" : "employees", 
...
SportingGoodsStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
SportingGoodsStore.property('founders', {
  "name" : "founders", 
...
SportingGoodsStore.property('foundingDate', {
  "name" : "foundingDate", 
...
SportingGoodsStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
SportingGoodsStore.property('legalName', {
  "name" : "legalName", 
...
SportingGoodsStore.property('location', {
  "name" : "location", 
...
SportingGoodsStore.property('makesOffer', {
  "name" : "makesOffer", 
...
SportingGoodsStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
SportingGoodsStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
SportingGoodsStore.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
SportingGoodsStore.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
SportingGoodsStore.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
SportingGoodsStore.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
SportingGoodsStore.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
SportingGoodsStore.property('branchOf', {
  "name" : "branchOf", 
...
SportingGoodsStore.property('currenciesAccepted', {
...
SportingGoodsStore.property('openingHours', {
  "name" : "openingHours", 
...
SportingGoodsStore.property('paymentAccepted', {
...
SportingGoodsStore.property('priceRange', {
  "name" : "priceRange", 
