...
var GatedResidenceCommunity = resource.define('GatedResidenceCommunity'); 

GatedResidenceCommunity.schema.description = "Residence type: Gated community."; 
GatedResidenceCommunity.persist('fs'); 


GatedResidenceCommunity.property('additionalType', {
  "name" : "additionalType", 
...
GatedResidenceCommunity.property('description', {
  "name" : "description", 
...
GatedResidenceCommunity.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
GatedResidenceCommunity.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
GatedResidenceCommunity.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
GatedResidenceCommunity.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
GatedResidenceCommunity.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
GatedResidenceCommunity.property('aggregateRating', {
...
GatedResidenceCommunity.property('containedIn', {
  "name" : "containedIn", 
...
GatedResidenceCommunity.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
GatedResidenceCommunity.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
GatedResidenceCommunity.property('faxNumber', {
  "name" : "faxNumber", 
...
GatedResidenceCommunity.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
GatedResidenceCommunity.property('globalLocationNumber', {
...
GatedResidenceCommunity.property('interactionCount', {
...
GatedResidenceCommunity.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
GatedResidenceCommunity.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
GatedResidenceCommunity.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
GatedResidenceCommunity.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
GatedResidenceCommunity.property('openingHoursSpecification', {
...
GatedResidenceCommunity.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
GatedResidenceCommunity.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
GatedResidenceCommunity.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
GatedResidenceCommunity.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
GatedResidenceCommunity.property('telephone', {
  "name" : "telephone", 
