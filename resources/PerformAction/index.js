...
var PerformAction = resource.define('PerformAction'); 

PerformAction.schema.description = "The act of participating in performance arts."; 
PerformAction.persist('fs'); 


PerformAction.property('additionalType', {
  "name" : "additionalType", 
...
PerformAction.property('description', {
  "name" : "description", 
...
PerformAction.property('endTime', {
  "name" : "endTime", 
...
PerformAction.property('instrument', {
  "name" : "instrument", 
...
PerformAction.property('location', {
  "name" : "location", 
...
PerformAction.property('participant', {
  "name" : "participant", 
...
PerformAction.property('startTime', {
  "name" : "startTime", 
...
PerformAction.property('audience', {
  "name" : "audience", 
...
PerformAction.property('entertainmentBusiness', {
  "name" : "entertainmentBusiness", 
  "displayName" : "Entertainment Business", 
  "description" : "A sub property of location. The entertainment business where the action occurred.", 
"type":"object","properties" : {"EntertainmentBusiness" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 
