...
var FinancialService = resource.define('FinancialService'); 

FinancialService.schema.description = "Financial services business."; 
FinancialService.persist('fs'); 


FinancialService.property('additionalType', {
  "name" : "additionalType", 
...
FinancialService.property('description', {
  "name" : "description", 
...
FinancialService.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
FinancialService.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
FinancialService.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
FinancialService.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
FinancialService.property('aggregateRating', {
...
FinancialService.property('containedIn', {
  "name" : "containedIn", 
...
FinancialService.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
FinancialService.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
FinancialService.property('faxNumber', {
  "name" : "faxNumber", 
...
FinancialService.property('globalLocationNumber', {
...
FinancialService.property('interactionCount', {
...
FinancialService.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
FinancialService.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
FinancialService.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
FinancialService.property('openingHoursSpecification', {
...
FinancialService.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
FinancialService.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
FinancialService.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
FinancialService.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
FinancialService.property('telephone', {
  "name" : "telephone", 
...
FinancialService.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
FinancialService.property('contactPoint', {
  "name" : "contactPoint", 
...
FinancialService.property('contactPoints', {
  "name" : "contactPoints", 
...
FinancialService.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
FinancialService.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
FinancialService.property('employee', {
  "name" : "employee", 
...
FinancialService.property('employees', {
  "name" : "employees", 
...
FinancialService.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
FinancialService.property('founders', {
  "name" : "founders", 
...
FinancialService.property('foundingDate', {
  "name" : "foundingDate", 
...
FinancialService.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
FinancialService.property('legalName', {
  "name" : "legalName", 
...
FinancialService.property('location', {
  "name" : "location", 
...
FinancialService.property('makesOffer', {
  "name" : "makesOffer", 
...
FinancialService.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
FinancialService.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
FinancialService.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
FinancialService.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
FinancialService.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
FinancialService.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
FinancialService.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
FinancialService.property('branchOf', {
  "name" : "branchOf", 
...
FinancialService.property('currenciesAccepted', {
...
FinancialService.property('openingHours', {
  "name" : "openingHours", 
...
FinancialService.property('paymentAccepted', {
...
FinancialService.property('priceRange', {
  "name" : "priceRange", 
