...
var Museum = resource.define('Museum'); 

Museum.schema.description = "A museum."; 
Museum.persist('fs'); 


Museum.property('additionalType', {
  "name" : "additionalType", 
...
Museum.property('aggregateRating', {
...
Museum.property('globalLocationNumber', {
...
Museum.property('interactionCount', {
...
Museum.property('openingHoursSpecification', {
