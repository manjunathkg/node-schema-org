...
var VisualArtsEvent = resource.define('VisualArtsEvent'); 

VisualArtsEvent.schema.description = "Event type: Visual arts event."; 
VisualArtsEvent.persist('fs'); 


VisualArtsEvent.property('additionalType', {
  "name" : "additionalType", 
...
VisualArtsEvent.property('description', {
  "name" : "description", 
...
VisualArtsEvent.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
VisualArtsEvent.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
VisualArtsEvent.property('attendee', {
  "name" : "attendee", 
...
VisualArtsEvent.property('attendees', {
  "name" : "attendees", 
...
VisualArtsEvent.property('duration', {
  "name" : "duration", 
...
VisualArtsEvent.property('endDate', {
  "name" : "endDate", 
...
VisualArtsEvent.property('location', {
  "name" : "location", 
...
VisualArtsEvent.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
VisualArtsEvent.property('performer', {
  "name" : "performer", 
...
VisualArtsEvent.property('performers', {
  "name" : "performers", 
...
VisualArtsEvent.property('startDate', {
  "name" : "startDate", 
...
VisualArtsEvent.property('subEvent', {
  "name" : "subEvent", 
...
VisualArtsEvent.property('subEvents', {
  "name" : "subEvents", 
...
VisualArtsEvent.property('superEvent', {
  "name" : "superEvent", 
