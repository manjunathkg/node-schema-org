...
var AutoPartsStore = resource.define('AutoPartsStore'); 

AutoPartsStore.schema.description = "An auto parts store."; 
AutoPartsStore.persist('fs'); 


AutoPartsStore.property('additionalType', {
  "name" : "additionalType", 
...
AutoPartsStore.property('description', {
  "name" : "description", 
...
AutoPartsStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
AutoPartsStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
AutoPartsStore.property('aggregateRating', {
...
AutoPartsStore.property('containedIn', {
  "name" : "containedIn", 
...
AutoPartsStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
AutoPartsStore.property('faxNumber', {
  "name" : "faxNumber", 
...
AutoPartsStore.property('globalLocationNumber', {
...
AutoPartsStore.property('interactionCount', {
...
AutoPartsStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
AutoPartsStore.property('openingHoursSpecification', {
...
AutoPartsStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
AutoPartsStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
AutoPartsStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
AutoPartsStore.property('telephone', {
  "name" : "telephone", 
...
AutoPartsStore.property('contactPoint', {
  "name" : "contactPoint", 
...
AutoPartsStore.property('contactPoints', {
  "name" : "contactPoints", 
...
AutoPartsStore.property('employee', {
  "name" : "employee", 
...
AutoPartsStore.property('employees', {
  "name" : "employees", 
...
AutoPartsStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
AutoPartsStore.property('founders', {
  "name" : "founders", 
...
AutoPartsStore.property('foundingDate', {
  "name" : "foundingDate", 
...
AutoPartsStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
AutoPartsStore.property('legalName', {
  "name" : "legalName", 
...
AutoPartsStore.property('location', {
  "name" : "location", 
...
AutoPartsStore.property('makesOffer', {
  "name" : "makesOffer", 
...
AutoPartsStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
AutoPartsStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
AutoPartsStore.property('branchOf', {
  "name" : "branchOf", 
...
AutoPartsStore.property('currenciesAccepted', {
...
AutoPartsStore.property('openingHours', {
  "name" : "openingHours", 
...
AutoPartsStore.property('paymentAccepted', {
...
AutoPartsStore.property('priceRange', {
  "name" : "priceRange", 
