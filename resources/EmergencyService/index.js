...
var EmergencyService = resource.define('EmergencyService'); 

EmergencyService.schema.description = "An emergency service, such as a fire station or ER."; 
EmergencyService.persist('fs'); 


EmergencyService.property('additionalType', {
  "name" : "additionalType", 
...
EmergencyService.property('description', {
  "name" : "description", 
...
EmergencyService.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
EmergencyService.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
EmergencyService.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
EmergencyService.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
EmergencyService.property('aggregateRating', {
...
EmergencyService.property('containedIn', {
  "name" : "containedIn", 
...
EmergencyService.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
EmergencyService.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
EmergencyService.property('faxNumber', {
  "name" : "faxNumber", 
...
EmergencyService.property('globalLocationNumber', {
...
EmergencyService.property('interactionCount', {
...
EmergencyService.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
EmergencyService.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
EmergencyService.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
EmergencyService.property('openingHoursSpecification', {
...
EmergencyService.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
EmergencyService.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
EmergencyService.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
EmergencyService.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
EmergencyService.property('telephone', {
  "name" : "telephone", 
...
EmergencyService.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
EmergencyService.property('contactPoint', {
  "name" : "contactPoint", 
...
EmergencyService.property('contactPoints', {
  "name" : "contactPoints", 
...
EmergencyService.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
EmergencyService.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
EmergencyService.property('employee', {
  "name" : "employee", 
...
EmergencyService.property('employees', {
  "name" : "employees", 
...
EmergencyService.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
EmergencyService.property('founders', {
  "name" : "founders", 
...
EmergencyService.property('foundingDate', {
  "name" : "foundingDate", 
...
EmergencyService.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
EmergencyService.property('legalName', {
  "name" : "legalName", 
...
EmergencyService.property('location', {
  "name" : "location", 
...
EmergencyService.property('makesOffer', {
  "name" : "makesOffer", 
...
EmergencyService.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
EmergencyService.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
EmergencyService.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
EmergencyService.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
EmergencyService.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
EmergencyService.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
EmergencyService.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
EmergencyService.property('branchOf', {
  "name" : "branchOf", 
...
EmergencyService.property('currenciesAccepted', {
...
EmergencyService.property('openingHours', {
  "name" : "openingHours", 
...
EmergencyService.property('paymentAccepted', {
...
EmergencyService.property('priceRange', {
  "name" : "priceRange", 
