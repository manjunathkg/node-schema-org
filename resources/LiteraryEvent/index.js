...
var LiteraryEvent = resource.define('LiteraryEvent'); 

LiteraryEvent.schema.description = "Event type: Literary event."; 
LiteraryEvent.persist('fs'); 


LiteraryEvent.property('additionalType', {
  "name" : "additionalType", 
...
LiteraryEvent.property('description', {
  "name" : "description", 
...
LiteraryEvent.property('attendee', {
  "name" : "attendee", 
...
LiteraryEvent.property('attendees', {
  "name" : "attendees", 
...
LiteraryEvent.property('duration', {
  "name" : "duration", 
...
LiteraryEvent.property('endDate', {
  "name" : "endDate", 
...
LiteraryEvent.property('location', {
  "name" : "location", 
...
LiteraryEvent.property('performer', {
  "name" : "performer", 
...
LiteraryEvent.property('performers', {
  "name" : "performers", 
...
LiteraryEvent.property('startDate', {
  "name" : "startDate", 
...
LiteraryEvent.property('subEvent', {
  "name" : "subEvent", 
...
LiteraryEvent.property('subEvents', {
  "name" : "subEvents", 
...
LiteraryEvent.property('superEvent', {
  "name" : "superEvent", 
