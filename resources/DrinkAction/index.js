...
var DrinkAction = resource.define('DrinkAction'); 

DrinkAction.schema.description = "The act of swallowing liquids."; 
DrinkAction.persist('fs'); 


DrinkAction.property('additionalType', {
  "name" : "additionalType", 
...
DrinkAction.property('description', {
  "name" : "description", 
...
DrinkAction.property('instrument', {
  "name" : "instrument", 
...
DrinkAction.property('participant', {
  "name" : "participant", 
...
DrinkAction.property('startTime', {
  "name" : "startTime", 
