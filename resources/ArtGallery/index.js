...
var ArtGallery = resource.define('ArtGallery'); 

ArtGallery.schema.description = "An art gallery."; 
ArtGallery.persist('fs'); 


ArtGallery.property('additionalType', {
  "name" : "additionalType", 
...
ArtGallery.property('description', {
  "name" : "description", 
...
ArtGallery.property('aggregateRating', {
...
ArtGallery.property('containedIn', {
  "name" : "containedIn", 
...
ArtGallery.property('globalLocationNumber', {
...
ArtGallery.property('interactionCount', {
...
ArtGallery.property('openingHoursSpecification', {
...
ArtGallery.property('contactPoint', {
  "name" : "contactPoint", 
...
ArtGallery.property('contactPoints', {
  "name" : "contactPoints", 
...
ArtGallery.property('foundingDate', {
  "name" : "foundingDate", 
...
ArtGallery.property('makesOffer', {
  "name" : "makesOffer", 
...
ArtGallery.property('currenciesAccepted', {
...
ArtGallery.property('openingHours', {
  "name" : "openingHours", 
...
ArtGallery.property('paymentAccepted', {
...
ArtGallery.property('priceRange', {
  "name" : "priceRange", 
