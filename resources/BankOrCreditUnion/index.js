...
var BankOrCreditUnion = resource.define('BankOrCreditUnion'); 

BankOrCreditUnion.schema.description = "Bank or credit union."; 
BankOrCreditUnion.persist('fs'); 


BankOrCreditUnion.property('additionalType', {
  "name" : "additionalType", 
...
BankOrCreditUnion.property('description', {
  "name" : "description", 
...
BankOrCreditUnion.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
BankOrCreditUnion.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
BankOrCreditUnion.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
BankOrCreditUnion.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
BankOrCreditUnion.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
BankOrCreditUnion.property('aggregateRating', {
...
BankOrCreditUnion.property('containedIn', {
  "name" : "containedIn", 
...
BankOrCreditUnion.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
BankOrCreditUnion.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
BankOrCreditUnion.property('faxNumber', {
  "name" : "faxNumber", 
...
BankOrCreditUnion.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
BankOrCreditUnion.property('globalLocationNumber', {
...
BankOrCreditUnion.property('interactionCount', {
...
BankOrCreditUnion.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
BankOrCreditUnion.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
BankOrCreditUnion.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
BankOrCreditUnion.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
BankOrCreditUnion.property('openingHoursSpecification', {
...
BankOrCreditUnion.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
BankOrCreditUnion.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
BankOrCreditUnion.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
BankOrCreditUnion.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
BankOrCreditUnion.property('telephone', {
  "name" : "telephone", 
...
BankOrCreditUnion.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
BankOrCreditUnion.property('contactPoint', {
  "name" : "contactPoint", 
...
BankOrCreditUnion.property('contactPoints', {
  "name" : "contactPoints", 
...
BankOrCreditUnion.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
BankOrCreditUnion.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
BankOrCreditUnion.property('employee', {
  "name" : "employee", 
...
BankOrCreditUnion.property('employees', {
  "name" : "employees", 
...
BankOrCreditUnion.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
BankOrCreditUnion.property('founders', {
  "name" : "founders", 
...
BankOrCreditUnion.property('foundingDate', {
  "name" : "foundingDate", 
...
BankOrCreditUnion.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
BankOrCreditUnion.property('legalName', {
  "name" : "legalName", 
...
BankOrCreditUnion.property('location', {
  "name" : "location", 
...
BankOrCreditUnion.property('makesOffer', {
  "name" : "makesOffer", 
...
BankOrCreditUnion.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
BankOrCreditUnion.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
BankOrCreditUnion.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
BankOrCreditUnion.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
BankOrCreditUnion.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
BankOrCreditUnion.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
BankOrCreditUnion.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
BankOrCreditUnion.property('branchOf', {
  "name" : "branchOf", 
...
BankOrCreditUnion.property('currenciesAccepted', {
...
BankOrCreditUnion.property('openingHours', {
  "name" : "openingHours", 
...
BankOrCreditUnion.property('paymentAccepted', {
...
BankOrCreditUnion.property('priceRange', {
  "name" : "priceRange", 
