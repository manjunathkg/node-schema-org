...
var City = resource.define('City'); 

City.schema.description = "A city or town."; 
City.persist('fs'); 


City.property('additionalType', {
  "name" : "additionalType", 
...
City.property('globalLocationNumber', {
...
City.property('interactionCount', {
...
City.property('openingHoursSpecification', {
