...
var VideoObject = resource.define('VideoObject'); 

VideoObject.schema.description = "A video file."; 
VideoObject.persist('fs'); 


VideoObject.property('additionalType', {
  "name" : "additionalType", 
...
VideoObject.property('description', {
  "name" : "description", 
...
VideoObject.property('accountablePerson', {
...
VideoObject.property('aggregateRating', {
...
VideoObject.property('alternativeHeadline', {
...
VideoObject.property('associatedMedia', {
...
VideoObject.property('contentLocation', {
...
VideoObject.property('contentRating', {
  "name" : "contentRating", 
...
VideoObject.property('contributor', {
  "name" : "contributor", 
...
VideoObject.property('copyrightHolder', {
...
VideoObject.property('copyrightYear', {
  "name" : "copyrightYear", 
...
VideoObject.property('dateCreated', {
  "name" : "dateCreated", 
...
VideoObject.property('dateModified', {
  "name" : "dateModified", 
...
VideoObject.property('datePublished', {
  "name" : "datePublished", 
...
VideoObject.property('discussionUrl', {
  "name" : "discussionUrl", 
...
VideoObject.property('educationalAlignment', {
...
VideoObject.property('educationalUse', {
  "name" : "educationalUse", 
...
VideoObject.property('encodings', {
  "name" : "encodings", 
...
VideoObject.property('inLanguage', {
  "name" : "inLanguage", 
...
VideoObject.property('interactionCount', {
...
VideoObject.property('interactivityType', {
...
VideoObject.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
VideoObject.property('isFamilyFriendly', {
...
VideoObject.property('learningResourceType', {
...
VideoObject.property('publisher', {
  "name" : "publisher", 
...
VideoObject.property('publishingPrinciples', {
...
VideoObject.property('sourceOrganization', {
...
VideoObject.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
VideoObject.property('timeRequired', {
  "name" : "timeRequired", 
...
VideoObject.property('typicalAgeRange', {
...
VideoObject.property('associatedArticle', {
...
VideoObject.property('contentSize', {
  "name" : "contentSize", 
...
VideoObject.property('contentUrl', {
  "name" : "contentUrl", 
...
VideoObject.property('encodesCreativeWork', {
...
VideoObject.property('encodingFormat', {
  "name" : "encodingFormat", 
...
VideoObject.property('playerType', {
  "name" : "playerType", 
...
VideoObject.property('regionsAllowed', {
  "name" : "regionsAllowed", 
...
VideoObject.property('requiresSubscription', {
...
VideoObject.property('uploadDate', {
  "name" : "uploadDate", 
...
VideoObject.property('productionCompany', {
...
VideoObject.property('thumbnail', {
  "name" : "thumbnail", 
...
VideoObject.property('transcript', {
  "name" : "transcript", 
...
VideoObject.property('videoFrameSize', {
  "name" : "videoFrameSize", 
  "displayName" : "Video Framesize", 
  "description" : "The frame size of the video.", 
"type":  "string" 
}); 


VideoObject.property('videoQuality', {
  "name" : "videoQuality", 
