...
var TelevisionStation = resource.define('TelevisionStation'); 

TelevisionStation.schema.description = "A television station."; 
TelevisionStation.persist('fs'); 


TelevisionStation.property('additionalType', {
  "name" : "additionalType", 
...
TelevisionStation.property('description', {
  "name" : "description", 
...
TelevisionStation.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
TelevisionStation.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
TelevisionStation.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
TelevisionStation.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
TelevisionStation.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
TelevisionStation.property('aggregateRating', {
...
TelevisionStation.property('containedIn', {
  "name" : "containedIn", 
...
TelevisionStation.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
TelevisionStation.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
TelevisionStation.property('faxNumber', {
  "name" : "faxNumber", 
...
TelevisionStation.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
TelevisionStation.property('globalLocationNumber', {
...
TelevisionStation.property('interactionCount', {
...
TelevisionStation.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
TelevisionStation.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
TelevisionStation.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
TelevisionStation.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
TelevisionStation.property('openingHoursSpecification', {
...
TelevisionStation.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
TelevisionStation.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
TelevisionStation.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
TelevisionStation.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
TelevisionStation.property('telephone', {
  "name" : "telephone", 
...
TelevisionStation.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
TelevisionStation.property('contactPoint', {
  "name" : "contactPoint", 
...
TelevisionStation.property('contactPoints', {
  "name" : "contactPoints", 
...
TelevisionStation.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
TelevisionStation.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
TelevisionStation.property('employee', {
  "name" : "employee", 
...
TelevisionStation.property('employees', {
  "name" : "employees", 
...
TelevisionStation.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
TelevisionStation.property('founders', {
  "name" : "founders", 
...
TelevisionStation.property('foundingDate', {
  "name" : "foundingDate", 
...
TelevisionStation.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
TelevisionStation.property('legalName', {
  "name" : "legalName", 
...
TelevisionStation.property('location', {
  "name" : "location", 
...
TelevisionStation.property('makesOffer', {
  "name" : "makesOffer", 
...
TelevisionStation.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
TelevisionStation.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
TelevisionStation.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
TelevisionStation.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
TelevisionStation.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
TelevisionStation.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
TelevisionStation.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
TelevisionStation.property('branchOf', {
  "name" : "branchOf", 
...
TelevisionStation.property('currenciesAccepted', {
...
TelevisionStation.property('openingHours', {
  "name" : "openingHours", 
...
TelevisionStation.property('paymentAccepted', {
...
TelevisionStation.property('priceRange', {
  "name" : "priceRange", 
