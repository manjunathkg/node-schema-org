...
var CommunicateAction = resource.define('CommunicateAction'); 

CommunicateAction.schema.description = "The act of conveying information to another person via a communication medium (instrument) such as speech, email, or telephone conversation."; 
CommunicateAction.persist('fs'); 


CommunicateAction.property('additionalType', {
  "name" : "additionalType", 
...
CommunicateAction.property('description', {
  "name" : "description", 
...
CommunicateAction.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
CommunicateAction.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
CommunicateAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
CommunicateAction.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
CommunicateAction.property('agent', {
  "name" : "agent", 
  "displayName" : "Agent", 
...
CommunicateAction.property('endTime', {
  "name" : "endTime", 
...
CommunicateAction.property('instrument', {
  "name" : "instrument", 
...
CommunicateAction.property('location', {
  "name" : "location", 
...
CommunicateAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
CommunicateAction.property('participant', {
  "name" : "participant", 
...
CommunicateAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
CommunicateAction.property('startTime', {
  "name" : "startTime", 
...
CommunicateAction.property('about', {
  "name" : "about", 
  "displayName" : "About", 
...
CommunicateAction.property('language', {
  "name" : "language", 
...
CommunicateAction.property('recipient', {
  "name" : "recipient", 
