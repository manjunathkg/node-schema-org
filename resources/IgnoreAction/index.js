...
var IgnoreAction = resource.define('IgnoreAction'); 

IgnoreAction.schema.description = "The act of intentionally disregarding the object. An agent ignores an object."; 
IgnoreAction.persist('fs'); 


IgnoreAction.property('additionalType', {
  "name" : "additionalType", 
...
IgnoreAction.property('description', {
  "name" : "description", 
...
IgnoreAction.property('instrument', {
  "name" : "instrument", 
...
IgnoreAction.property('location', {
  "name" : "location", 
...
IgnoreAction.property('participant', {
  "name" : "participant", 
...
IgnoreAction.property('startTime', {
  "name" : "startTime", 
