...
var UserBlocks = resource.define('UserBlocks'); 

UserBlocks.schema.description = "User interaction: Block this content."; 
UserBlocks.persist('fs'); 


UserBlocks.property('additionalType', {
  "name" : "additionalType", 
...
UserBlocks.property('description', {
  "name" : "description", 
...
UserBlocks.property('performers', {
  "name" : "performers", 
...
UserBlocks.property('superEvent', {
  "name" : "superEvent", 
