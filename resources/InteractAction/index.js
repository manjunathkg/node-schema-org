...
var InteractAction = resource.define('InteractAction'); 

InteractAction.schema.description = "The act of interacting with another person or organization."; 
InteractAction.persist('fs'); 


InteractAction.property('additionalType', {
  "name" : "additionalType", 
...
InteractAction.property('description', {
  "name" : "description", 
...
InteractAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
InteractAction.property('endTime', {
  "name" : "endTime", 
...
InteractAction.property('instrument', {
  "name" : "instrument", 
...
InteractAction.property('location', {
  "name" : "location", 
...
InteractAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
InteractAction.property('participant', {
  "name" : "participant", 
...
InteractAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
InteractAction.property('startTime', {
  "name" : "startTime", 
