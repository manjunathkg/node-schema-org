...
var HighSchool = resource.define('HighSchool'); 

HighSchool.schema.description = "A high school."; 
HighSchool.persist('fs'); 


HighSchool.property('additionalType', {
  "name" : "additionalType", 
...
HighSchool.property('description', {
  "name" : "description", 
...
HighSchool.property('aggregateRating', {
...
HighSchool.property('contactPoint', {
  "name" : "contactPoint", 
...
HighSchool.property('contactPoints', {
  "name" : "contactPoints", 
...
HighSchool.property('foundingDate', {
  "name" : "foundingDate", 
...
HighSchool.property('globalLocationNumber', {
...
HighSchool.property('interactionCount', {
...
HighSchool.property('makesOffer', {
  "name" : "makesOffer", 
