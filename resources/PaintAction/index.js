...
var PaintAction = resource.define('PaintAction'); 

PaintAction.schema.description = "The act of producing a painting, typically with paint and canvas as instruments."; 
PaintAction.persist('fs'); 


PaintAction.property('additionalType', {
  "name" : "additionalType", 
...
PaintAction.property('description', {
  "name" : "description", 
...
PaintAction.property('instrument', {
  "name" : "instrument", 
...
PaintAction.property('participant', {
  "name" : "participant", 
...
PaintAction.property('startTime', {
  "name" : "startTime", 
