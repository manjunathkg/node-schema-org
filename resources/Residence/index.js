...
var Residence = resource.define('Residence'); 

Residence.schema.description = "The place where a person lives."; 
Residence.persist('fs'); 


Residence.property('additionalType', {
  "name" : "additionalType", 
...
Residence.property('description', {
  "name" : "description", 
...
Residence.property('aggregateRating', {
...
Residence.property('containedIn', {
  "name" : "containedIn", 
...
Residence.property('globalLocationNumber', {
...
Residence.property('interactionCount', {
...
Residence.property('openingHoursSpecification', {
