...
var LendAction = resource.define('LendAction'); 

LendAction.schema.description = "The act of providing an object under an agreement that it will be returned at a later date. Reciprocal of BorrowAction.Related actions:BorrowAction: Reciprocal of LendAction."; 
LendAction.persist('fs'); 


LendAction.property('additionalType', {
  "name" : "additionalType", 
...
LendAction.property('description', {
  "name" : "description", 
...
LendAction.property('instrument', {
  "name" : "instrument", 
...
LendAction.property('participant', {
  "name" : "participant", 
...
LendAction.property('fromLocation', {
  "name" : "fromLocation", 
...
LendAction.property('toLocation', {
  "name" : "toLocation", 
