...
var UnRegisterAction = resource.define('UnRegisterAction'); 

UnRegisterAction.schema.description = "The act of un-registering from a service.Related actions:RegisterAction: Antagonym of UnRegisterAction.Leave: Unlike LeaveAction, UnRegisterAction implies that you are unregistering from a service you werer previously registered, rather than leaving a team/group of people."; 
UnRegisterAction.persist('fs'); 


UnRegisterAction.property('additionalType', {
  "name" : "additionalType", 
...
UnRegisterAction.property('description', {
  "name" : "description", 
...
UnRegisterAction.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
UnRegisterAction.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
UnRegisterAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
UnRegisterAction.property('agent', {
  "name" : "agent", 
  "displayName" : "Agent", 
...
UnRegisterAction.property('endTime', {
  "name" : "endTime", 
...
UnRegisterAction.property('instrument', {
  "name" : "instrument", 
...
UnRegisterAction.property('location', {
  "name" : "location", 
...
UnRegisterAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
UnRegisterAction.property('participant', {
  "name" : "participant", 
...
UnRegisterAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
UnRegisterAction.property('startTime', {
  "name" : "startTime", 
