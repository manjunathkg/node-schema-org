...
var CheckoutPage = resource.define('CheckoutPage'); 

CheckoutPage.schema.description = "Web page type: Checkout page."; 
CheckoutPage.persist('fs'); 


CheckoutPage.property('additionalType', {
  "name" : "additionalType", 
...
CheckoutPage.property('description', {
  "name" : "description", 
...
CheckoutPage.property('accountablePerson', {
...
CheckoutPage.property('aggregateRating', {
...
CheckoutPage.property('alternativeHeadline', {
...
CheckoutPage.property('associatedMedia', {
...
CheckoutPage.property('audience', {
  "name" : "audience", 
...
CheckoutPage.property('citation', {
  "name" : "citation", 
...
CheckoutPage.property('contentLocation', {
...
CheckoutPage.property('contentRating', {
  "name" : "contentRating", 
...
CheckoutPage.property('contributor', {
  "name" : "contributor", 
...
CheckoutPage.property('copyrightHolder', {
...
CheckoutPage.property('copyrightYear', {
  "name" : "copyrightYear", 
...
CheckoutPage.property('dateCreated', {
  "name" : "dateCreated", 
...
CheckoutPage.property('dateModified', {
  "name" : "dateModified", 
...
CheckoutPage.property('datePublished', {
  "name" : "datePublished", 
...
CheckoutPage.property('discussionUrl', {
  "name" : "discussionUrl", 
...
CheckoutPage.property('educationalAlignment', {
...
CheckoutPage.property('educationalUse', {
  "name" : "educationalUse", 
...
CheckoutPage.property('encoding', {
  "name" : "encoding", 
...
CheckoutPage.property('encodings', {
  "name" : "encodings", 
...
CheckoutPage.property('headline', {
  "name" : "headline", 
...
CheckoutPage.property('inLanguage', {
  "name" : "inLanguage", 
...
CheckoutPage.property('interactionCount', {
...
CheckoutPage.property('interactivityType', {
...
CheckoutPage.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
CheckoutPage.property('isFamilyFriendly', {
...
CheckoutPage.property('keywords', {
  "name" : "keywords", 
...
CheckoutPage.property('learningResourceType', {
...
CheckoutPage.property('mentions', {
  "name" : "mentions", 
...
CheckoutPage.property('provider', {
  "name" : "provider", 
...
CheckoutPage.property('publisher', {
  "name" : "publisher", 
...
CheckoutPage.property('publishingPrinciples', {
...
CheckoutPage.property('sourceOrganization', {
...
CheckoutPage.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
CheckoutPage.property('timeRequired', {
  "name" : "timeRequired", 
...
CheckoutPage.property('typicalAgeRange', {
...
CheckoutPage.property('breadcrumb', {
  "name" : "breadcrumb", 
...
CheckoutPage.property('isPartOf', {
  "name" : "isPartOf", 
...
CheckoutPage.property('lastReviewed', {
  "name" : "lastReviewed", 
...
CheckoutPage.property('mainContentOfPage', {
...
CheckoutPage.property('primaryImageOfPage', {
...
CheckoutPage.property('relatedLink', {
  "name" : "relatedLink", 
...
CheckoutPage.property('reviewedBy', {
  "name" : "reviewedBy", 
...
CheckoutPage.property('significantLink', {
...
CheckoutPage.property('significantLinks', {
...
CheckoutPage.property('specialty', {
  "name" : "specialty", 
