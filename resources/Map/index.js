...
var Map = resource.define('Map'); 

Map.schema.description = "A map."; 
Map.persist('fs'); 


Map.property('additionalType', {
  "name" : "additionalType", 
...
Map.property('accountablePerson', {
...
Map.property('alternativeHeadline', {
...
Map.property('educationalAlignment', {
...
Map.property('interactivityType', {
...
Map.property('learningResourceType', {
...
Map.property('publishingPrinciples', {
...
Map.property('sourceOrganization', {
