...
var ReceiveAction = resource.define('ReceiveAction'); 

ReceiveAction.schema.description = "The act of physically/electronically taking delivery of an object thathas been transferred from an origin to a destination. Reciprocal of SendAction.Related actions:SendAction: The reciprocal of ReceiveAction.TakeAction: Unlike TakeAction, ReceiveAction does not imply that the ownership has been transfered (e.g. I can receive a package, but it does not mean the package is now mine)."; 
ReceiveAction.persist('fs'); 


ReceiveAction.property('additionalType', {
  "name" : "additionalType", 
...
ReceiveAction.property('description', {
  "name" : "description", 
...
ReceiveAction.property('endTime', {
  "name" : "endTime", 
...
ReceiveAction.property('instrument', {
  "name" : "instrument", 
...
ReceiveAction.property('location', {
  "name" : "location", 
...
ReceiveAction.property('participant', {
  "name" : "participant", 
...
ReceiveAction.property('startTime', {
  "name" : "startTime", 
...
ReceiveAction.property('fromLocation', {
  "name" : "fromLocation", 
...
ReceiveAction.property('toLocation', {
  "name" : "toLocation", 
...
ReceiveAction.property('deliveryMethod', {
  "name" : "deliveryMethod", 
