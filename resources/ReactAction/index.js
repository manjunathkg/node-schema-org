...
var ReactAction = resource.define('ReactAction'); 

ReactAction.schema.description = "The act of responding instinctively and emotionally to an object, expressing a sentiment."; 
ReactAction.persist('fs'); 


ReactAction.property('additionalType', {
  "name" : "additionalType", 
...
ReactAction.property('description', {
  "name" : "description", 
...
ReactAction.property('instrument', {
  "name" : "instrument", 
...
ReactAction.property('participant', {
  "name" : "participant", 
...
ReactAction.property('startTime', {
  "name" : "startTime", 
