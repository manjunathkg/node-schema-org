...
var Beach = resource.define('Beach'); 

Beach.schema.description = "Beach."; 
Beach.persist('fs'); 


Beach.property('additionalType', {
  "name" : "additionalType", 
...
Beach.property('aggregateRating', {
...
Beach.property('globalLocationNumber', {
...
Beach.property('interactionCount', {
...
Beach.property('openingHoursSpecification', {
