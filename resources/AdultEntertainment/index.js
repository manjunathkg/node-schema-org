...
var AdultEntertainment = resource.define('AdultEntertainment'); 

AdultEntertainment.schema.description = "An adult entertainment establishment."; 
AdultEntertainment.persist('fs'); 


AdultEntertainment.property('additionalType', {
  "name" : "additionalType", 
...
AdultEntertainment.property('description', {
  "name" : "description", 
...
AdultEntertainment.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
AdultEntertainment.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
AdultEntertainment.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
AdultEntertainment.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
AdultEntertainment.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
AdultEntertainment.property('aggregateRating', {
...
AdultEntertainment.property('containedIn', {
  "name" : "containedIn", 
...
AdultEntertainment.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
AdultEntertainment.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
AdultEntertainment.property('faxNumber', {
  "name" : "faxNumber", 
...
AdultEntertainment.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
AdultEntertainment.property('globalLocationNumber', {
...
AdultEntertainment.property('interactionCount', {
...
AdultEntertainment.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
AdultEntertainment.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
AdultEntertainment.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
AdultEntertainment.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
AdultEntertainment.property('openingHoursSpecification', {
...
AdultEntertainment.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
AdultEntertainment.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
AdultEntertainment.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
AdultEntertainment.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
AdultEntertainment.property('telephone', {
  "name" : "telephone", 
...
AdultEntertainment.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
AdultEntertainment.property('contactPoint', {
  "name" : "contactPoint", 
...
AdultEntertainment.property('contactPoints', {
  "name" : "contactPoints", 
...
AdultEntertainment.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
AdultEntertainment.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
AdultEntertainment.property('employee', {
  "name" : "employee", 
...
AdultEntertainment.property('employees', {
  "name" : "employees", 
...
AdultEntertainment.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
AdultEntertainment.property('founders', {
  "name" : "founders", 
...
AdultEntertainment.property('foundingDate', {
  "name" : "foundingDate", 
...
AdultEntertainment.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
AdultEntertainment.property('legalName', {
  "name" : "legalName", 
...
AdultEntertainment.property('location', {
  "name" : "location", 
...
AdultEntertainment.property('makesOffer', {
  "name" : "makesOffer", 
...
AdultEntertainment.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
AdultEntertainment.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
AdultEntertainment.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
AdultEntertainment.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
AdultEntertainment.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
AdultEntertainment.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
AdultEntertainment.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
AdultEntertainment.property('branchOf', {
  "name" : "branchOf", 
...
AdultEntertainment.property('currenciesAccepted', {
...
AdultEntertainment.property('openingHours', {
  "name" : "openingHours", 
...
AdultEntertainment.property('paymentAccepted', {
...
AdultEntertainment.property('priceRange', {
  "name" : "priceRange", 
