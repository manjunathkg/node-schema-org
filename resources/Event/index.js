...
var Event = resource.define('Event'); 

Event.schema.description = "An event happening at a certain time at a certain location."; 
Event.persist('fs'); 


Event.property('additionalType', {
  "name" : "additionalType", 
