...
var PhotographAction = resource.define('PhotographAction'); 

PhotographAction.schema.description = "The act of capturing still images of objects using a camera."; 
PhotographAction.persist('fs'); 


PhotographAction.property('additionalType', {
  "name" : "additionalType", 
...
PhotographAction.property('description', {
  "name" : "description", 
...
PhotographAction.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
PhotographAction.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
PhotographAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
PhotographAction.property('agent', {
  "name" : "agent", 
  "displayName" : "Agent", 
...
PhotographAction.property('endTime', {
  "name" : "endTime", 
...
PhotographAction.property('instrument', {
  "name" : "instrument", 
...
PhotographAction.property('location', {
  "name" : "location", 
...
PhotographAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
PhotographAction.property('participant', {
  "name" : "participant", 
...
PhotographAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
PhotographAction.property('startTime', {
  "name" : "startTime", 
