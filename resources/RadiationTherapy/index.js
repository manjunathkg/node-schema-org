...
var RadiationTherapy = resource.define('RadiationTherapy'); 

RadiationTherapy.schema.description = "A process of care using radiation aimed at improving a health condition."; 
RadiationTherapy.persist('fs'); 


RadiationTherapy.property('additionalType', {
  "name" : "additionalType", 
...
RadiationTherapy.property('description', {
  "name" : "description", 
...
RadiationTherapy.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
RadiationTherapy.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
RadiationTherapy.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
RadiationTherapy.property('alternateName', {
  "name" : "alternateName", 
...
RadiationTherapy.property('code', {
  "name" : "code", 
  "displayName" : "Code", 
...
RadiationTherapy.property('guideline', {
  "name" : "guideline", 
...
RadiationTherapy.property('medicineSystem', {
  "name" : "medicineSystem", 
...
RadiationTherapy.property('recognizingAuthority', {
...
RadiationTherapy.property('relevantSpecialty', {
...
RadiationTherapy.property('study', {
  "name" : "study", 
  "displayName" : "Study", 
...
RadiationTherapy.property('adverseOutcome', {
  "name" : "adverseOutcome", 
...
RadiationTherapy.property('contraindication', {
...
RadiationTherapy.property('duplicateTherapy', {
...
RadiationTherapy.property('indication', {
  "name" : "indication", 
...
RadiationTherapy.property('seriousAdverseOutcome', {
