...
var Synagogue = resource.define('Synagogue'); 

Synagogue.schema.description = "A synagogue."; 
Synagogue.persist('fs'); 


Synagogue.property('additionalType', {
  "name" : "additionalType", 
...
Synagogue.property('description', {
  "name" : "description", 
...
Synagogue.property('aggregateRating', {
...
Synagogue.property('containedIn', {
  "name" : "containedIn", 
...
Synagogue.property('globalLocationNumber', {
...
Synagogue.property('interactionCount', {
...
Synagogue.property('openingHoursSpecification', {
...
Synagogue.property('openingHours', {
  "name" : "openingHours", 
