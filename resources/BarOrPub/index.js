...
var BarOrPub = resource.define('BarOrPub'); 

BarOrPub.schema.description = "A bar or pub."; 
BarOrPub.persist('fs'); 


BarOrPub.property('additionalType', {
  "name" : "additionalType", 
...
BarOrPub.property('aggregateRating', {
...
BarOrPub.property('globalLocationNumber', {
...
BarOrPub.property('interactionCount', {
...
BarOrPub.property('openingHoursSpecification', {
...
BarOrPub.property('contactPoint', {
  "name" : "contactPoint", 
...
BarOrPub.property('contactPoints', {
  "name" : "contactPoints", 
...
BarOrPub.property('foundingDate', {
  "name" : "foundingDate", 
...
BarOrPub.property('currenciesAccepted', {
...
BarOrPub.property('openingHours', {
  "name" : "openingHours", 
...
BarOrPub.property('paymentAccepted', {
...
BarOrPub.property('acceptsReservations', {
...
BarOrPub.property('servesCuisine', {
  "name" : "servesCuisine", 
