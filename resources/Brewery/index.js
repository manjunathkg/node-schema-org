...
var Brewery = resource.define('Brewery'); 

Brewery.schema.description = "Brewery."; 
Brewery.persist('fs'); 


Brewery.property('additionalType', {
  "name" : "additionalType", 
...
Brewery.property('aggregateRating', {
...
Brewery.property('globalLocationNumber', {
...
Brewery.property('interactionCount', {
...
Brewery.property('openingHoursSpecification', {
...
Brewery.property('contactPoints', {
  "name" : "contactPoints", 
...
Brewery.property('currenciesAccepted', {
...
Brewery.property('paymentAccepted', {
...
Brewery.property('acceptsReservations', {
...
Brewery.property('servesCuisine', {
  "name" : "servesCuisine", 
