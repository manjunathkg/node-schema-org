...
JoinAction.property('description', {
  "name" : "description", 
...
JoinAction.property('instrument', {
  "name" : "instrument", 
...
JoinAction.property('participant', {
  "name" : "participant", 
