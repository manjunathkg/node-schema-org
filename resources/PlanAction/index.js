...
var PlanAction = resource.define('PlanAction'); 

PlanAction.schema.description = "The act of planning the execution of an event/task/action/reservation/plan to a future date."; 
PlanAction.persist('fs'); 


PlanAction.property('additionalType', {
  "name" : "additionalType", 
...
PlanAction.property('description', {
  "name" : "description", 
...
PlanAction.property('instrument', {
  "name" : "instrument", 
...
PlanAction.property('participant', {
  "name" : "participant", 
...
PlanAction.property('scheduledTime', {
  "name" : "scheduledTime", 
