...
var AgreeAction = resource.define('AgreeAction'); 

AgreeAction.schema.description = "The act of expressing a consistency of opinion with the object. An agent agrees to/about an object (a proposition, topic or theme) with participants."; 
AgreeAction.persist('fs'); 


AgreeAction.property('additionalType', {
  "name" : "additionalType", 
...
AgreeAction.property('description', {
  "name" : "description", 
...
AgreeAction.property('instrument', {
  "name" : "instrument", 
...
AgreeAction.property('participant', {
  "name" : "participant", 
...
AgreeAction.property('startTime', {
  "name" : "startTime", 
