...
var ChildrensEvent = resource.define('ChildrensEvent'); 

ChildrensEvent.schema.description = "Event type: Children&#x27;s event."; 
ChildrensEvent.persist('fs'); 


ChildrensEvent.property('additionalType', {
  "name" : "additionalType", 
...
ChildrensEvent.property('description', {
  "name" : "description", 
...
ChildrensEvent.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ChildrensEvent.property('attendee', {
  "name" : "attendee", 
...
ChildrensEvent.property('attendees', {
  "name" : "attendees", 
...
ChildrensEvent.property('duration', {
  "name" : "duration", 
...
ChildrensEvent.property('endDate', {
  "name" : "endDate", 
...
ChildrensEvent.property('location', {
  "name" : "location", 
...
ChildrensEvent.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
ChildrensEvent.property('performer', {
  "name" : "performer", 
...
ChildrensEvent.property('performers', {
  "name" : "performers", 
...
ChildrensEvent.property('startDate', {
  "name" : "startDate", 
...
ChildrensEvent.property('subEvent', {
  "name" : "subEvent", 
...
ChildrensEvent.property('subEvents', {
  "name" : "subEvents", 
...
ChildrensEvent.property('superEvent', {
  "name" : "superEvent", 
