...
var BikeStore = resource.define('BikeStore'); 

BikeStore.schema.description = "A bike store."; 
BikeStore.persist('fs'); 


BikeStore.property('additionalType', {
  "name" : "additionalType", 
...
BikeStore.property('description', {
  "name" : "description", 
...
BikeStore.property('aggregateRating', {
...
BikeStore.property('containedIn', {
  "name" : "containedIn", 
...
BikeStore.property('globalLocationNumber', {
...
BikeStore.property('interactionCount', {
...
BikeStore.property('openingHoursSpecification', {
...
BikeStore.property('contactPoint', {
  "name" : "contactPoint", 
...
BikeStore.property('contactPoints', {
  "name" : "contactPoints", 
...
BikeStore.property('foundingDate', {
  "name" : "foundingDate", 
...
BikeStore.property('currenciesAccepted', {
...
BikeStore.property('openingHours', {
  "name" : "openingHours", 
...
BikeStore.property('paymentAccepted', {
