...
var MotorcycleDealer = resource.define('MotorcycleDealer'); 

MotorcycleDealer.schema.description = "A motorcycle dealer."; 
MotorcycleDealer.persist('fs'); 


MotorcycleDealer.property('additionalType', {
  "name" : "additionalType", 
...
MotorcycleDealer.property('description', {
  "name" : "description", 
...
MotorcycleDealer.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MotorcycleDealer.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MotorcycleDealer.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MotorcycleDealer.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
MotorcycleDealer.property('aggregateRating', {
...
MotorcycleDealer.property('containedIn', {
  "name" : "containedIn", 
...
MotorcycleDealer.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
MotorcycleDealer.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
MotorcycleDealer.property('faxNumber', {
  "name" : "faxNumber", 
...
MotorcycleDealer.property('globalLocationNumber', {
...
MotorcycleDealer.property('interactionCount', {
...
MotorcycleDealer.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
MotorcycleDealer.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
MotorcycleDealer.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
MotorcycleDealer.property('openingHoursSpecification', {
...
MotorcycleDealer.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
MotorcycleDealer.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
MotorcycleDealer.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MotorcycleDealer.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MotorcycleDealer.property('telephone', {
  "name" : "telephone", 
...
MotorcycleDealer.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
MotorcycleDealer.property('contactPoint', {
  "name" : "contactPoint", 
...
MotorcycleDealer.property('contactPoints', {
  "name" : "contactPoints", 
...
MotorcycleDealer.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
MotorcycleDealer.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
MotorcycleDealer.property('employee', {
  "name" : "employee", 
...
MotorcycleDealer.property('employees', {
  "name" : "employees", 
...
MotorcycleDealer.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
MotorcycleDealer.property('founders', {
  "name" : "founders", 
...
MotorcycleDealer.property('foundingDate', {
  "name" : "foundingDate", 
...
MotorcycleDealer.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
MotorcycleDealer.property('legalName', {
  "name" : "legalName", 
...
MotorcycleDealer.property('location', {
  "name" : "location", 
...
MotorcycleDealer.property('makesOffer', {
  "name" : "makesOffer", 
...
MotorcycleDealer.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
MotorcycleDealer.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
MotorcycleDealer.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
MotorcycleDealer.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
MotorcycleDealer.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
MotorcycleDealer.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
MotorcycleDealer.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
MotorcycleDealer.property('branchOf', {
  "name" : "branchOf", 
...
MotorcycleDealer.property('currenciesAccepted', {
...
MotorcycleDealer.property('openingHours', {
  "name" : "openingHours", 
...
MotorcycleDealer.property('paymentAccepted', {
...
MotorcycleDealer.property('priceRange', {
  "name" : "priceRange", 
