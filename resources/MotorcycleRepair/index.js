...
var MotorcycleRepair = resource.define('MotorcycleRepair'); 

MotorcycleRepair.schema.description = "A motorcycle repair shop."; 
MotorcycleRepair.persist('fs'); 


MotorcycleRepair.property('additionalType', {
  "name" : "additionalType", 
...
MotorcycleRepair.property('description', {
  "name" : "description", 
...
MotorcycleRepair.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MotorcycleRepair.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MotorcycleRepair.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MotorcycleRepair.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
MotorcycleRepair.property('aggregateRating', {
...
MotorcycleRepair.property('containedIn', {
  "name" : "containedIn", 
...
MotorcycleRepair.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
MotorcycleRepair.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
MotorcycleRepair.property('faxNumber', {
  "name" : "faxNumber", 
...
MotorcycleRepair.property('globalLocationNumber', {
...
MotorcycleRepair.property('interactionCount', {
...
MotorcycleRepair.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
MotorcycleRepair.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
MotorcycleRepair.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
MotorcycleRepair.property('openingHoursSpecification', {
...
MotorcycleRepair.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
MotorcycleRepair.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
MotorcycleRepair.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MotorcycleRepair.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MotorcycleRepair.property('telephone', {
  "name" : "telephone", 
...
MotorcycleRepair.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
MotorcycleRepair.property('contactPoint', {
  "name" : "contactPoint", 
...
MotorcycleRepair.property('contactPoints', {
  "name" : "contactPoints", 
...
MotorcycleRepair.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
MotorcycleRepair.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
MotorcycleRepair.property('employee', {
  "name" : "employee", 
...
MotorcycleRepair.property('employees', {
  "name" : "employees", 
...
MotorcycleRepair.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
MotorcycleRepair.property('founders', {
  "name" : "founders", 
...
MotorcycleRepair.property('foundingDate', {
  "name" : "foundingDate", 
...
MotorcycleRepair.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
MotorcycleRepair.property('legalName', {
  "name" : "legalName", 
...
MotorcycleRepair.property('location', {
  "name" : "location", 
...
MotorcycleRepair.property('makesOffer', {
  "name" : "makesOffer", 
...
MotorcycleRepair.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
MotorcycleRepair.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
MotorcycleRepair.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
MotorcycleRepair.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
MotorcycleRepair.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
MotorcycleRepair.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
MotorcycleRepair.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
MotorcycleRepair.property('branchOf', {
  "name" : "branchOf", 
...
MotorcycleRepair.property('currenciesAccepted', {
...
MotorcycleRepair.property('openingHours', {
  "name" : "openingHours", 
...
MotorcycleRepair.property('paymentAccepted', {
...
MotorcycleRepair.property('priceRange', {
  "name" : "priceRange", 
