...
var Locksmith = resource.define('Locksmith'); 

Locksmith.schema.description = "A locksmith."; 
Locksmith.persist('fs'); 


Locksmith.property('additionalType', {
  "name" : "additionalType", 
...
Locksmith.property('description', {
  "name" : "description", 
...
Locksmith.property('aggregateRating', {
...
Locksmith.property('containedIn', {
  "name" : "containedIn", 
...
Locksmith.property('globalLocationNumber', {
...
Locksmith.property('interactionCount', {
...
Locksmith.property('openingHoursSpecification', {
...
Locksmith.property('contactPoint', {
  "name" : "contactPoint", 
...
Locksmith.property('contactPoints', {
  "name" : "contactPoints", 
...
Locksmith.property('foundingDate', {
  "name" : "foundingDate", 
...
Locksmith.property('currenciesAccepted', {
...
Locksmith.property('openingHours', {
  "name" : "openingHours", 
...
Locksmith.property('paymentAccepted', {
