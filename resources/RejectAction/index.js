...
var RejectAction = resource.define('RejectAction'); 

RejectAction.schema.description = "The act of rejecting to/adopting an object.Related actions:AcceptAction: The antagonym of RejectAction."; 
RejectAction.persist('fs'); 


RejectAction.property('additionalType', {
  "name" : "additionalType", 
...
RejectAction.property('description', {
  "name" : "description", 
...
RejectAction.property('instrument', {
  "name" : "instrument", 
...
RejectAction.property('location', {
  "name" : "location", 
...
RejectAction.property('participant', {
  "name" : "participant", 
...
RejectAction.property('startTime', {
  "name" : "startTime", 
