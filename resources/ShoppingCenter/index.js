...
var ShoppingCenter = resource.define('ShoppingCenter'); 

ShoppingCenter.schema.description = "A shopping center or mall."; 
ShoppingCenter.persist('fs'); 


ShoppingCenter.property('additionalType', {
  "name" : "additionalType", 
...
ShoppingCenter.property('description', {
  "name" : "description", 
...
ShoppingCenter.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ShoppingCenter.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
ShoppingCenter.property('aggregateRating', {
...
ShoppingCenter.property('containedIn', {
  "name" : "containedIn", 
...
ShoppingCenter.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
ShoppingCenter.property('faxNumber', {
  "name" : "faxNumber", 
...
ShoppingCenter.property('globalLocationNumber', {
...
ShoppingCenter.property('interactionCount', {
...
ShoppingCenter.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
ShoppingCenter.property('openingHoursSpecification', {
...
ShoppingCenter.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
ShoppingCenter.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
ShoppingCenter.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
ShoppingCenter.property('telephone', {
  "name" : "telephone", 
...
ShoppingCenter.property('contactPoint', {
  "name" : "contactPoint", 
...
ShoppingCenter.property('contactPoints', {
  "name" : "contactPoints", 
...
ShoppingCenter.property('employee', {
  "name" : "employee", 
...
ShoppingCenter.property('employees', {
  "name" : "employees", 
...
ShoppingCenter.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
ShoppingCenter.property('founders', {
  "name" : "founders", 
...
ShoppingCenter.property('foundingDate', {
  "name" : "foundingDate", 
...
ShoppingCenter.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
ShoppingCenter.property('legalName', {
  "name" : "legalName", 
...
ShoppingCenter.property('location', {
  "name" : "location", 
...
ShoppingCenter.property('makesOffer', {
  "name" : "makesOffer", 
...
ShoppingCenter.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
ShoppingCenter.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
ShoppingCenter.property('branchOf', {
  "name" : "branchOf", 
...
ShoppingCenter.property('currenciesAccepted', {
...
ShoppingCenter.property('openingHours', {
  "name" : "openingHours", 
...
ShoppingCenter.property('paymentAccepted', {
...
ShoppingCenter.property('priceRange', {
  "name" : "priceRange", 
