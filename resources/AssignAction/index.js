...
var AssignAction = resource.define('AssignAction'); 

AssignAction.schema.description = "The act of allocating an action/event/task to some destination (someone or something)."; 
AssignAction.persist('fs'); 


AssignAction.property('additionalType', {
  "name" : "additionalType", 
...
AssignAction.property('description', {
  "name" : "description", 
...
AssignAction.property('instrument', {
  "name" : "instrument", 
...
AssignAction.property('location', {
  "name" : "location", 
...
AssignAction.property('participant', {
  "name" : "participant", 
...
AssignAction.property('startTime', {
  "name" : "startTime", 
