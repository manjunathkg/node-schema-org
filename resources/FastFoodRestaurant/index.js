...
var FastFoodRestaurant = resource.define('FastFoodRestaurant'); 

FastFoodRestaurant.schema.description = "A fast-food restaurant."; 
FastFoodRestaurant.persist('fs'); 


FastFoodRestaurant.property('additionalType', {
  "name" : "additionalType", 
...
FastFoodRestaurant.property('description', {
  "name" : "description", 
...
FastFoodRestaurant.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
FastFoodRestaurant.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
FastFoodRestaurant.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
FastFoodRestaurant.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
FastFoodRestaurant.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
FastFoodRestaurant.property('aggregateRating', {
...
FastFoodRestaurant.property('containedIn', {
  "name" : "containedIn", 
...
FastFoodRestaurant.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
FastFoodRestaurant.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
FastFoodRestaurant.property('faxNumber', {
  "name" : "faxNumber", 
...
FastFoodRestaurant.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
FastFoodRestaurant.property('globalLocationNumber', {
...
FastFoodRestaurant.property('interactionCount', {
...
FastFoodRestaurant.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
FastFoodRestaurant.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
FastFoodRestaurant.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
FastFoodRestaurant.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
FastFoodRestaurant.property('openingHoursSpecification', {
...
FastFoodRestaurant.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
FastFoodRestaurant.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
FastFoodRestaurant.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
FastFoodRestaurant.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
FastFoodRestaurant.property('telephone', {
  "name" : "telephone", 
...
FastFoodRestaurant.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
FastFoodRestaurant.property('contactPoint', {
  "name" : "contactPoint", 
...
FastFoodRestaurant.property('contactPoints', {
  "name" : "contactPoints", 
...
FastFoodRestaurant.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
FastFoodRestaurant.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
FastFoodRestaurant.property('employee', {
  "name" : "employee", 
...
FastFoodRestaurant.property('employees', {
  "name" : "employees", 
...
FastFoodRestaurant.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
FastFoodRestaurant.property('founders', {
  "name" : "founders", 
...
FastFoodRestaurant.property('foundingDate', {
  "name" : "foundingDate", 
...
FastFoodRestaurant.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
FastFoodRestaurant.property('legalName', {
  "name" : "legalName", 
...
FastFoodRestaurant.property('location', {
  "name" : "location", 
...
FastFoodRestaurant.property('makesOffer', {
  "name" : "makesOffer", 
...
FastFoodRestaurant.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
FastFoodRestaurant.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
FastFoodRestaurant.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
FastFoodRestaurant.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
FastFoodRestaurant.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
FastFoodRestaurant.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
FastFoodRestaurant.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
FastFoodRestaurant.property('branchOf', {
  "name" : "branchOf", 
...
FastFoodRestaurant.property('currenciesAccepted', {
...
FastFoodRestaurant.property('openingHours', {
  "name" : "openingHours", 
...
FastFoodRestaurant.property('paymentAccepted', {
...
FastFoodRestaurant.property('priceRange', {
  "name" : "priceRange", 
...
FastFoodRestaurant.property('acceptsReservations', {
  "name" : "acceptsReservations", 
  "displayName" : "Accepts Reservations", 
  "description" : "Either Yes/No, or a URL at which reservations can be made.", 
 "type":"object", "properties" : { "id":{"type" : "array"}} 
}); 


FastFoodRestaurant.property('menu', {
  "name" : "menu", 
  "displayName" : "Menu", 
...
FastFoodRestaurant.property('servesCuisine', {
  "name" : "servesCuisine", 
  "displayName" : "Serves Cuisine", 
