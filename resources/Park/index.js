...
var Park = resource.define('Park'); 

Park.schema.description = "A park."; 
Park.persist('fs'); 


Park.property('additionalType', {
  "name" : "additionalType", 
...
Park.property('globalLocationNumber', {
...
Park.property('interactionCount', {
...
Park.property('openingHoursSpecification', {
