...
var PalliativeProcedure = resource.define('PalliativeProcedure'); 

PalliativeProcedure.schema.description = "A medical procedure intended primarly for palliative purposes, aimed at relieving the symptoms of an underlying health condition."; 
PalliativeProcedure.persist('fs'); 


PalliativeProcedure.property('additionalType', {
  "name" : "additionalType", 
...
PalliativeProcedure.property('description', {
  "name" : "description", 
...
PalliativeProcedure.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
PalliativeProcedure.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
PalliativeProcedure.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
PalliativeProcedure.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
PalliativeProcedure.property('alternateName', {
  "name" : "alternateName", 
...
PalliativeProcedure.property('code', {
  "name" : "code", 
  "displayName" : "Code", 
...
PalliativeProcedure.property('guideline', {
  "name" : "guideline", 
...
PalliativeProcedure.property('medicineSystem', {
  "name" : "medicineSystem", 
...
PalliativeProcedure.property('recognizingAuthority', {
...
PalliativeProcedure.property('relevantSpecialty', {
...
PalliativeProcedure.property('study', {
  "name" : "study", 
  "displayName" : "Study", 
...
PalliativeProcedure.property('adverseOutcome', {
  "name" : "adverseOutcome", 
...
PalliativeProcedure.property('contraindication', {
...
PalliativeProcedure.property('duplicateTherapy', {
...
PalliativeProcedure.property('indication', {
  "name" : "indication", 
...
PalliativeProcedure.property('seriousAdverseOutcome', {
...
PalliativeProcedure.property('followup', {
  "name" : "followup", 
...
PalliativeProcedure.property('howPerformed', {
  "name" : "howPerformed", 
...
PalliativeProcedure.property('preparation', {
  "name" : "preparation", 
...
PalliativeProcedure.property('procedureType', {
  "name" : "procedureType", 
