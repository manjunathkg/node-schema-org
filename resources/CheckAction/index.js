...
var CheckAction = resource.define('CheckAction'); 

CheckAction.schema.description = "An agent inspects/determines/investigates/inquire or examine an object&#x27;s accuracy/quality/condition or state."; 
CheckAction.persist('fs'); 


CheckAction.property('additionalType', {
  "name" : "additionalType", 
...
CheckAction.property('description', {
  "name" : "description", 
...
CheckAction.property('instrument', {
  "name" : "instrument", 
...
CheckAction.property('participant', {
  "name" : "participant", 
...
CheckAction.property('startTime', {
  "name" : "startTime", 
