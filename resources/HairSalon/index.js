...
var HairSalon = resource.define('HairSalon'); 

HairSalon.schema.description = "A hair salon."; 
HairSalon.persist('fs'); 


HairSalon.property('additionalType', {
  "name" : "additionalType", 
...
HairSalon.property('description', {
  "name" : "description", 
...
HairSalon.property('aggregateRating', {
...
HairSalon.property('containedIn', {
  "name" : "containedIn", 
...
HairSalon.property('globalLocationNumber', {
...
HairSalon.property('interactionCount', {
...
HairSalon.property('openingHoursSpecification', {
...
HairSalon.property('contactPoint', {
  "name" : "contactPoint", 
...
HairSalon.property('contactPoints', {
  "name" : "contactPoints", 
...
HairSalon.property('foundingDate', {
  "name" : "foundingDate", 
...
HairSalon.property('currenciesAccepted', {
...
HairSalon.property('openingHours', {
  "name" : "openingHours", 
...
HairSalon.property('paymentAccepted', {
