...
var Dentist = resource.define('Dentist'); 

Dentist.schema.description = "A dentist."; 
Dentist.persist('fs'); 


Dentist.property('additionalType', {
  "name" : "additionalType", 
...
Dentist.property('aggregateRating', {
...
Dentist.property('globalLocationNumber', {
...
Dentist.property('interactionCount', {
...
Dentist.property('openingHoursSpecification', {
...
Dentist.property('contactPoints', {
  "name" : "contactPoints", 
...
Dentist.property('currenciesAccepted', {
...
Dentist.property('paymentAccepted', {
