...
var AskAction = resource.define('AskAction'); 

AskAction.schema.description = "The act of posing a question / favor to someone.Related actions:ReplyAction: Appears generally as a response to AskAction."; 
AskAction.persist('fs'); 


AskAction.property('additionalType', {
  "name" : "additionalType", 
...
AskAction.property('description', {
  "name" : "description", 
...
AskAction.property('participant', {
  "name" : "participant", 
