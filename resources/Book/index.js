...
var Book = resource.define('Book'); 

Book.schema.description = "A book."; 
Book.persist('fs'); 


Book.property('additionalType', {
  "name" : "additionalType", 
...
Book.property('accountablePerson', {
...
Book.property('alternativeHeadline', {
...
Book.property('educationalAlignment', {
...
Book.property('interactionCount', {
...
Book.property('interactivityType', {
...
Book.property('isFamilyFriendly', {
...
Book.property('learningResourceType', {
...
Book.property('publishingPrinciples', {
...
Book.property('sourceOrganization', {
...
Book.property('bookFormat', {
  "name" : "bookFormat", 
  "displayName" : "Book Format", 
  "description" : "The format of the book.", 
"type":"object","properties" : {"BookFormatType" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


Book.property('illustrator', {
  "name" : "illustrator", 
...
Book.property('numberOfPages', {
  "name" : "numberOfPages", 
  "displayName" : "Number Ofpages", 
