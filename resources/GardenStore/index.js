...
var GardenStore = resource.define('GardenStore'); 

GardenStore.schema.description = "A garden store."; 
GardenStore.persist('fs'); 


GardenStore.property('additionalType', {
  "name" : "additionalType", 
...
GardenStore.property('description', {
  "name" : "description", 
...
GardenStore.property('aggregateRating', {
...
GardenStore.property('containedIn', {
  "name" : "containedIn", 
...
GardenStore.property('faxNumber', {
  "name" : "faxNumber", 
...
GardenStore.property('globalLocationNumber', {
...
GardenStore.property('interactionCount', {
...
GardenStore.property('openingHoursSpecification', {
...
GardenStore.property('telephone', {
  "name" : "telephone", 
...
GardenStore.property('contactPoint', {
  "name" : "contactPoint", 
...
GardenStore.property('contactPoints', {
  "name" : "contactPoints", 
...
GardenStore.property('employees', {
  "name" : "employees", 
...
GardenStore.property('foundingDate', {
  "name" : "foundingDate", 
...
GardenStore.property('legalName', {
  "name" : "legalName", 
...
GardenStore.property('makesOffer', {
  "name" : "makesOffer", 
...
GardenStore.property('currenciesAccepted', {
...
GardenStore.property('openingHours', {
  "name" : "openingHours", 
...
GardenStore.property('paymentAccepted', {
...
GardenStore.property('priceRange', {
  "name" : "priceRange", 
