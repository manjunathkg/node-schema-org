...
var Bakery = resource.define('Bakery'); 

Bakery.schema.description = "A bakery."; 
Bakery.persist('fs'); 


Bakery.property('additionalType', {
  "name" : "additionalType", 
...
Bakery.property('aggregateRating', {
...
Bakery.property('globalLocationNumber', {
...
Bakery.property('interactionCount', {
...
Bakery.property('openingHoursSpecification', {
...
Bakery.property('currenciesAccepted', {
...
Bakery.property('paymentAccepted', {
...
Bakery.property('acceptsReservations', {
