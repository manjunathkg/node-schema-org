...
var DrugStrength = resource.define('DrugStrength'); 

DrugStrength.schema.description = "A specific strength in which a medical drug is available in a specific country."; 
DrugStrength.persist('fs'); 


DrugStrength.property('additionalType', {
  "name" : "additionalType", 
...
DrugStrength.property('description', {
  "name" : "description", 
...
DrugStrength.property('alternateName', {
  "name" : "alternateName", 
...
DrugStrength.property('guideline', {
  "name" : "guideline", 
...
DrugStrength.property('medicineSystem', {
  "name" : "medicineSystem", 
...
DrugStrength.property('recognizingAuthority', {
...
DrugStrength.property('relevantSpecialty', {
...
DrugStrength.property('activeIngredient', {
...
DrugStrength.property('availableIn', {
  "name" : "availableIn", 
...
DrugStrength.property('strengthUnit', {
  "name" : "strengthUnit", 
...
DrugStrength.property('strengthValue', {
  "name" : "strengthValue", 
  "displayName" : "Strength Value", 
