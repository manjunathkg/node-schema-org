...
var UserInteraction = resource.define('UserInteraction'); 

UserInteraction.schema.description = "A user interacting with a page"; 
UserInteraction.persist('fs'); 


UserInteraction.property('additionalType', {
  "name" : "additionalType", 
...
UserInteraction.property('description', {
  "name" : "description", 
...
UserInteraction.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
UserInteraction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
UserInteraction.property('attendee', {
  "name" : "attendee", 
...
UserInteraction.property('attendees', {
  "name" : "attendees", 
...
UserInteraction.property('duration', {
  "name" : "duration", 
...
UserInteraction.property('endDate', {
  "name" : "endDate", 
...
UserInteraction.property('location', {
  "name" : "location", 
...
UserInteraction.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
UserInteraction.property('performer', {
  "name" : "performer", 
...
UserInteraction.property('performers', {
  "name" : "performers", 
...
UserInteraction.property('startDate', {
  "name" : "startDate", 
...
UserInteraction.property('subEvent', {
  "name" : "subEvent", 
...
UserInteraction.property('subEvents', {
  "name" : "subEvents", 
...
UserInteraction.property('superEvent', {
  "name" : "superEvent", 
