...
var WPFooter = resource.define('WPFooter'); 

WPFooter.schema.description = "The footer section of the page."; 
WPFooter.persist('fs'); 


WPFooter.property('additionalType', {
  "name" : "additionalType", 
...
WPFooter.property('accountablePerson', {
...
WPFooter.property('aggregateRating', {
...
WPFooter.property('alternativeHeadline', {
...
WPFooter.property('associatedMedia', {
...
WPFooter.property('contentLocation', {
...
WPFooter.property('contentRating', {
  "name" : "contentRating", 
...
WPFooter.property('copyrightHolder', {
...
WPFooter.property('copyrightYear', {
  "name" : "copyrightYear", 
...
WPFooter.property('dateModified', {
  "name" : "dateModified", 
...
WPFooter.property('datePublished', {
  "name" : "datePublished", 
...
WPFooter.property('discussionUrl', {
  "name" : "discussionUrl", 
...
WPFooter.property('educationalAlignment', {
...
WPFooter.property('educationalUse', {
  "name" : "educationalUse", 
...
WPFooter.property('interactionCount', {
...
WPFooter.property('interactivityType', {
...
WPFooter.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
WPFooter.property('isFamilyFriendly', {
...
WPFooter.property('learningResourceType', {
...
WPFooter.property('publishingPrinciples', {
...
WPFooter.property('sourceOrganization', {
...
WPFooter.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
WPFooter.property('timeRequired', {
  "name" : "timeRequired", 
...
WPFooter.property('typicalAgeRange', {
