...
var BlogPosting = resource.define('BlogPosting'); 

BlogPosting.schema.description = "A blog post."; 
BlogPosting.persist('fs'); 


BlogPosting.property('additionalType', {
  "name" : "additionalType", 
...
BlogPosting.property('description', {
  "name" : "description", 
...
BlogPosting.property('accountablePerson', {
...
BlogPosting.property('aggregateRating', {
...
BlogPosting.property('alternativeHeadline', {
...
BlogPosting.property('associatedMedia', {
...
BlogPosting.property('contentLocation', {
...
BlogPosting.property('contentRating', {
  "name" : "contentRating", 
...
BlogPosting.property('contributor', {
  "name" : "contributor", 
...
BlogPosting.property('copyrightHolder', {
...
BlogPosting.property('copyrightYear', {
  "name" : "copyrightYear", 
...
BlogPosting.property('dateCreated', {
  "name" : "dateCreated", 
...
BlogPosting.property('dateModified', {
  "name" : "dateModified", 
...
BlogPosting.property('datePublished', {
  "name" : "datePublished", 
...
BlogPosting.property('discussionUrl', {
  "name" : "discussionUrl", 
...
BlogPosting.property('educationalAlignment', {
...
BlogPosting.property('educationalUse', {
  "name" : "educationalUse", 
...
BlogPosting.property('encodings', {
  "name" : "encodings", 
...
BlogPosting.property('inLanguage', {
  "name" : "inLanguage", 
...
BlogPosting.property('interactionCount', {
...
BlogPosting.property('interactivityType', {
...
BlogPosting.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
BlogPosting.property('isFamilyFriendly', {
...
BlogPosting.property('learningResourceType', {
...
BlogPosting.property('publisher', {
  "name" : "publisher", 
...
BlogPosting.property('publishingPrinciples', {
...
BlogPosting.property('sourceOrganization', {
...
BlogPosting.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
BlogPosting.property('timeRequired', {
  "name" : "timeRequired", 
...
BlogPosting.property('typicalAgeRange', {
...
BlogPosting.property('articleBody', {
  "name" : "articleBody", 
...
BlogPosting.property('articleSection', {
  "name" : "articleSection", 
...
BlogPosting.property('wordCount', {
  "name" : "wordCount", 
