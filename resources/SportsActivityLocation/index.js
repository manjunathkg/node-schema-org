...
var SportsActivityLocation = resource.define('SportsActivityLocation'); 

SportsActivityLocation.schema.description = "A sports location, such as a playing field."; 
SportsActivityLocation.persist('fs'); 


SportsActivityLocation.property('additionalType', {
  "name" : "additionalType", 
...
SportsActivityLocation.property('description', {
  "name" : "description", 
...
SportsActivityLocation.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
SportsActivityLocation.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
SportsActivityLocation.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
SportsActivityLocation.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
SportsActivityLocation.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
SportsActivityLocation.property('aggregateRating', {
...
SportsActivityLocation.property('containedIn', {
  "name" : "containedIn", 
...
SportsActivityLocation.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
SportsActivityLocation.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
SportsActivityLocation.property('faxNumber', {
  "name" : "faxNumber", 
...
SportsActivityLocation.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
SportsActivityLocation.property('globalLocationNumber', {
...
SportsActivityLocation.property('interactionCount', {
...
SportsActivityLocation.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
SportsActivityLocation.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
SportsActivityLocation.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
SportsActivityLocation.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
SportsActivityLocation.property('openingHoursSpecification', {
...
SportsActivityLocation.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
SportsActivityLocation.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
SportsActivityLocation.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
SportsActivityLocation.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
SportsActivityLocation.property('telephone', {
  "name" : "telephone", 
...
SportsActivityLocation.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
SportsActivityLocation.property('contactPoint', {
  "name" : "contactPoint", 
...
SportsActivityLocation.property('contactPoints', {
  "name" : "contactPoints", 
...
SportsActivityLocation.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
SportsActivityLocation.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
SportsActivityLocation.property('employee', {
  "name" : "employee", 
...
SportsActivityLocation.property('employees', {
  "name" : "employees", 
...
SportsActivityLocation.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
SportsActivityLocation.property('founders', {
  "name" : "founders", 
...
SportsActivityLocation.property('foundingDate', {
  "name" : "foundingDate", 
...
SportsActivityLocation.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
SportsActivityLocation.property('legalName', {
  "name" : "legalName", 
...
SportsActivityLocation.property('location', {
  "name" : "location", 
...
SportsActivityLocation.property('makesOffer', {
  "name" : "makesOffer", 
...
SportsActivityLocation.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
SportsActivityLocation.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
SportsActivityLocation.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
SportsActivityLocation.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
SportsActivityLocation.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
SportsActivityLocation.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
SportsActivityLocation.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
SportsActivityLocation.property('branchOf', {
  "name" : "branchOf", 
...
SportsActivityLocation.property('currenciesAccepted', {
...
SportsActivityLocation.property('openingHours', {
  "name" : "openingHours", 
...
SportsActivityLocation.property('paymentAccepted', {
...
SportsActivityLocation.property('priceRange', {
  "name" : "priceRange", 
