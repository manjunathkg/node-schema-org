...
var OceanBodyOfWater = resource.define('OceanBodyOfWater'); 

OceanBodyOfWater.schema.description = "An ocean (for example, the Pacific)."; 
OceanBodyOfWater.persist('fs'); 


OceanBodyOfWater.property('additionalType', {
  "name" : "additionalType", 
...
OceanBodyOfWater.property('description', {
  "name" : "description", 
...
OceanBodyOfWater.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
OceanBodyOfWater.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
OceanBodyOfWater.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
OceanBodyOfWater.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
OceanBodyOfWater.property('aggregateRating', {
...
OceanBodyOfWater.property('containedIn', {
  "name" : "containedIn", 
...
OceanBodyOfWater.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
OceanBodyOfWater.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
OceanBodyOfWater.property('faxNumber', {
  "name" : "faxNumber", 
...
OceanBodyOfWater.property('globalLocationNumber', {
...
OceanBodyOfWater.property('interactionCount', {
...
OceanBodyOfWater.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
OceanBodyOfWater.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
OceanBodyOfWater.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
OceanBodyOfWater.property('openingHoursSpecification', {
...
OceanBodyOfWater.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
OceanBodyOfWater.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
OceanBodyOfWater.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
OceanBodyOfWater.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
OceanBodyOfWater.property('telephone', {
  "name" : "telephone", 
