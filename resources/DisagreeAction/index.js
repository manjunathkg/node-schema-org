...
var DisagreeAction = resource.define('DisagreeAction'); 

DisagreeAction.schema.description = "The act of expressing a difference of opinion with the object. An agent disagrees to/about an object (a proposition, topic or theme) with participants."; 
DisagreeAction.persist('fs'); 


DisagreeAction.property('additionalType', {
  "name" : "additionalType", 
...
DisagreeAction.property('description', {
  "name" : "description", 
...
DisagreeAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
DisagreeAction.property('endTime', {
  "name" : "endTime", 
...
DisagreeAction.property('instrument', {
  "name" : "instrument", 
...
DisagreeAction.property('location', {
  "name" : "location", 
...
DisagreeAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
DisagreeAction.property('participant', {
  "name" : "participant", 
...
DisagreeAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
DisagreeAction.property('startTime', {
  "name" : "startTime", 
