...
var Restaurant = resource.define('Restaurant'); 

Restaurant.schema.description = "A restaurant."; 
Restaurant.persist('fs'); 


Restaurant.property('additionalType', {
  "name" : "additionalType", 
...
Restaurant.property('description', {
  "name" : "description", 
...
Restaurant.property('aggregateRating', {
...
Restaurant.property('containedIn', {
  "name" : "containedIn", 
...
Restaurant.property('globalLocationNumber', {
...
Restaurant.property('interactionCount', {
...
Restaurant.property('openingHoursSpecification', {
...
Restaurant.property('contactPoint', {
  "name" : "contactPoint", 
...
Restaurant.property('contactPoints', {
  "name" : "contactPoints", 
...
Restaurant.property('foundingDate', {
  "name" : "foundingDate", 
...
Restaurant.property('makesOffer', {
  "name" : "makesOffer", 
...
Restaurant.property('currenciesAccepted', {
...
Restaurant.property('openingHours', {
  "name" : "openingHours", 
...
Restaurant.property('paymentAccepted', {
...
Restaurant.property('priceRange', {
  "name" : "priceRange", 
...
Restaurant.property('acceptsReservations', {
...
Restaurant.property('servesCuisine', {
  "name" : "servesCuisine", 
