...
var TouristAttraction = resource.define('TouristAttraction'); 

TouristAttraction.schema.description = "A tourist attraction."; 
TouristAttraction.persist('fs'); 


TouristAttraction.property('additionalType', {
  "name" : "additionalType", 
...
TouristAttraction.property('description', {
  "name" : "description", 
...
TouristAttraction.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
TouristAttraction.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
TouristAttraction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
TouristAttraction.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
TouristAttraction.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
TouristAttraction.property('aggregateRating', {
...
TouristAttraction.property('containedIn', {
  "name" : "containedIn", 
...
TouristAttraction.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
TouristAttraction.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
TouristAttraction.property('faxNumber', {
  "name" : "faxNumber", 
...
TouristAttraction.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
TouristAttraction.property('globalLocationNumber', {
...
TouristAttraction.property('interactionCount', {
...
TouristAttraction.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
TouristAttraction.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
TouristAttraction.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
TouristAttraction.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
TouristAttraction.property('openingHoursSpecification', {
...
TouristAttraction.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
TouristAttraction.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
TouristAttraction.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
TouristAttraction.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
TouristAttraction.property('telephone', {
  "name" : "telephone", 
