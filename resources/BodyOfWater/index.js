...
var BodyOfWater = resource.define('BodyOfWater'); 

BodyOfWater.schema.description = "A body of water, such as a sea, ocean, or lake."; 
BodyOfWater.persist('fs'); 


BodyOfWater.property('additionalType', {
  "name" : "additionalType", 
...
BodyOfWater.property('description', {
  "name" : "description", 
...
BodyOfWater.property('aggregateRating', {
...
BodyOfWater.property('containedIn', {
  "name" : "containedIn", 
...
BodyOfWater.property('faxNumber', {
  "name" : "faxNumber", 
...
BodyOfWater.property('globalLocationNumber', {
...
BodyOfWater.property('interactionCount', {
...
BodyOfWater.property('openingHoursSpecification', {
...
BodyOfWater.property('telephone', {
  "name" : "telephone", 
