...
var VideoGallery = resource.define('VideoGallery'); 

VideoGallery.schema.description = "Web page type: Video gallery page."; 
VideoGallery.persist('fs'); 


VideoGallery.property('additionalType', {
  "name" : "additionalType", 
...
VideoGallery.property('description', {
  "name" : "description", 
...
VideoGallery.property('accountablePerson', {
...
VideoGallery.property('aggregateRating', {
...
VideoGallery.property('alternativeHeadline', {
...
VideoGallery.property('associatedMedia', {
...
VideoGallery.property('audience', {
  "name" : "audience", 
...
VideoGallery.property('citation', {
  "name" : "citation", 
...
VideoGallery.property('contentLocation', {
...
VideoGallery.property('contentRating', {
  "name" : "contentRating", 
...
VideoGallery.property('contributor', {
  "name" : "contributor", 
...
VideoGallery.property('copyrightHolder', {
...
VideoGallery.property('copyrightYear', {
  "name" : "copyrightYear", 
...
VideoGallery.property('dateCreated', {
  "name" : "dateCreated", 
...
VideoGallery.property('dateModified', {
  "name" : "dateModified", 
...
VideoGallery.property('datePublished', {
  "name" : "datePublished", 
...
VideoGallery.property('discussionUrl', {
  "name" : "discussionUrl", 
...
VideoGallery.property('educationalAlignment', {
...
VideoGallery.property('educationalUse', {
  "name" : "educationalUse", 
...
VideoGallery.property('encoding', {
  "name" : "encoding", 
...
VideoGallery.property('encodings', {
  "name" : "encodings", 
...
VideoGallery.property('headline', {
  "name" : "headline", 
...
VideoGallery.property('inLanguage', {
  "name" : "inLanguage", 
...
VideoGallery.property('interactionCount', {
...
VideoGallery.property('interactivityType', {
...
VideoGallery.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
VideoGallery.property('isFamilyFriendly', {
...
VideoGallery.property('keywords', {
  "name" : "keywords", 
...
VideoGallery.property('learningResourceType', {
...
VideoGallery.property('mentions', {
  "name" : "mentions", 
...
VideoGallery.property('provider', {
  "name" : "provider", 
...
VideoGallery.property('publisher', {
  "name" : "publisher", 
...
VideoGallery.property('publishingPrinciples', {
...
VideoGallery.property('sourceOrganization', {
...
VideoGallery.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
VideoGallery.property('timeRequired', {
  "name" : "timeRequired", 
...
VideoGallery.property('typicalAgeRange', {
...
VideoGallery.property('breadcrumb', {
  "name" : "breadcrumb", 
...
VideoGallery.property('isPartOf', {
  "name" : "isPartOf", 
...
VideoGallery.property('lastReviewed', {
  "name" : "lastReviewed", 
...
VideoGallery.property('mainContentOfPage', {
...
VideoGallery.property('primaryImageOfPage', {
...
VideoGallery.property('relatedLink', {
  "name" : "relatedLink", 
...
VideoGallery.property('reviewedBy', {
  "name" : "reviewedBy", 
...
VideoGallery.property('significantLink', {
...
VideoGallery.property('significantLinks', {
...
VideoGallery.property('specialty', {
  "name" : "specialty", 
