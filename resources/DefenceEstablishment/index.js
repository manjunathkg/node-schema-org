...
var DefenceEstablishment = resource.define('DefenceEstablishment'); 

DefenceEstablishment.schema.description = "A defence establishment, such as an army or navy base."; 
DefenceEstablishment.persist('fs'); 


DefenceEstablishment.property('additionalType', {
  "name" : "additionalType", 
...
DefenceEstablishment.property('description', {
  "name" : "description", 
...
DefenceEstablishment.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
DefenceEstablishment.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
DefenceEstablishment.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
DefenceEstablishment.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
DefenceEstablishment.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
DefenceEstablishment.property('aggregateRating', {
...
DefenceEstablishment.property('containedIn', {
  "name" : "containedIn", 
...
DefenceEstablishment.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
DefenceEstablishment.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
DefenceEstablishment.property('faxNumber', {
  "name" : "faxNumber", 
...
DefenceEstablishment.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
DefenceEstablishment.property('globalLocationNumber', {
...
DefenceEstablishment.property('interactionCount', {
...
DefenceEstablishment.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
DefenceEstablishment.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
DefenceEstablishment.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
DefenceEstablishment.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
DefenceEstablishment.property('openingHoursSpecification', {
...
DefenceEstablishment.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
DefenceEstablishment.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
DefenceEstablishment.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
DefenceEstablishment.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
DefenceEstablishment.property('telephone', {
  "name" : "telephone", 
...
DefenceEstablishment.property('openingHours', {
  "name" : "openingHours", 
