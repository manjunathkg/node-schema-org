...
var MensClothingStore = resource.define('MensClothingStore'); 

MensClothingStore.schema.description = "A men&#x27;s clothing store."; 
MensClothingStore.persist('fs'); 


MensClothingStore.property('additionalType', {
  "name" : "additionalType", 
...
MensClothingStore.property('description', {
  "name" : "description", 
...
MensClothingStore.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MensClothingStore.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MensClothingStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MensClothingStore.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
MensClothingStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
MensClothingStore.property('aggregateRating', {
...
MensClothingStore.property('containedIn', {
  "name" : "containedIn", 
...
MensClothingStore.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
MensClothingStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
MensClothingStore.property('faxNumber', {
  "name" : "faxNumber", 
...
MensClothingStore.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
MensClothingStore.property('globalLocationNumber', {
...
MensClothingStore.property('interactionCount', {
...
MensClothingStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
MensClothingStore.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
MensClothingStore.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
MensClothingStore.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
MensClothingStore.property('openingHoursSpecification', {
...
MensClothingStore.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
MensClothingStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
MensClothingStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MensClothingStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MensClothingStore.property('telephone', {
  "name" : "telephone", 
...
MensClothingStore.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
MensClothingStore.property('contactPoint', {
  "name" : "contactPoint", 
...
MensClothingStore.property('contactPoints', {
  "name" : "contactPoints", 
...
MensClothingStore.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
MensClothingStore.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
MensClothingStore.property('employee', {
  "name" : "employee", 
...
MensClothingStore.property('employees', {
  "name" : "employees", 
...
MensClothingStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
MensClothingStore.property('founders', {
  "name" : "founders", 
...
MensClothingStore.property('foundingDate', {
  "name" : "foundingDate", 
...
MensClothingStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
MensClothingStore.property('legalName', {
  "name" : "legalName", 
...
MensClothingStore.property('location', {
  "name" : "location", 
...
MensClothingStore.property('makesOffer', {
  "name" : "makesOffer", 
...
MensClothingStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
MensClothingStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
MensClothingStore.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
MensClothingStore.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
MensClothingStore.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
MensClothingStore.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
MensClothingStore.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
MensClothingStore.property('branchOf', {
  "name" : "branchOf", 
...
MensClothingStore.property('currenciesAccepted', {
...
MensClothingStore.property('openingHours', {
  "name" : "openingHours", 
...
MensClothingStore.property('paymentAccepted', {
...
MensClothingStore.property('priceRange', {
  "name" : "priceRange", 
