...
var TheaterGroup = resource.define('TheaterGroup'); 

TheaterGroup.schema.description = "A theater group or company—for example, the Royal Shakespeare Company or Druid Theatre."; 
TheaterGroup.persist('fs'); 


TheaterGroup.property('additionalType', {
  "name" : "additionalType", 
...
TheaterGroup.property('description', {
  "name" : "description", 
...
TheaterGroup.property('aggregateRating', {
...
TheaterGroup.property('contactPoint', {
  "name" : "contactPoint", 
...
TheaterGroup.property('contactPoints', {
  "name" : "contactPoints", 
...
TheaterGroup.property('employee', {
  "name" : "employee", 
...
TheaterGroup.property('employees', {
  "name" : "employees", 
...
TheaterGroup.property('faxNumber', {
  "name" : "faxNumber", 
...
TheaterGroup.property('founders', {
  "name" : "founders", 
...
TheaterGroup.property('foundingDate', {
  "name" : "foundingDate", 
...
TheaterGroup.property('globalLocationNumber', {
...
TheaterGroup.property('interactionCount', {
...
TheaterGroup.property('legalName', {
  "name" : "legalName", 
...
TheaterGroup.property('location', {
  "name" : "location", 
...
TheaterGroup.property('makesOffer', {
  "name" : "makesOffer", 
...
TheaterGroup.property('telephone', {
  "name" : "telephone", 
