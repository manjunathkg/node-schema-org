...
var ReadAction = resource.define('ReadAction'); 

ReadAction.schema.description = "The act of consuming written content."; 
ReadAction.persist('fs'); 


ReadAction.property('additionalType', {
  "name" : "additionalType", 
...
ReadAction.property('description', {
  "name" : "description", 
...
ReadAction.property('instrument', {
  "name" : "instrument", 
...
ReadAction.property('participant', {
  "name" : "participant", 
