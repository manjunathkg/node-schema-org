...
var AuthorizeAction = resource.define('AuthorizeAction'); 

AuthorizeAction.schema.description = "The act of granting permission to an object."; 
AuthorizeAction.persist('fs'); 


AuthorizeAction.property('additionalType', {
  "name" : "additionalType", 
...
AuthorizeAction.property('description', {
  "name" : "description", 
...
AuthorizeAction.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
AuthorizeAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
AuthorizeAction.property('agent', {
  "name" : "agent", 
  "displayName" : "Agent", 
...
AuthorizeAction.property('endTime', {
  "name" : "endTime", 
...
AuthorizeAction.property('instrument', {
  "name" : "instrument", 
...
AuthorizeAction.property('location', {
  "name" : "location", 
...
AuthorizeAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
AuthorizeAction.property('participant', {
  "name" : "participant", 
...
AuthorizeAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
AuthorizeAction.property('startTime', {
  "name" : "startTime", 
...
AuthorizeAction.property('purpose', {
  "name" : "purpose", 
  "displayName" : "Purpose", 
...
AuthorizeAction.property('recipient', {
  "name" : "recipient", 
