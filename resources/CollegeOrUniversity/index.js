...
CollegeOrUniversity.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
CollegeOrUniversity.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
CollegeOrUniversity.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
CollegeOrUniversity.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
CollegeOrUniversity.property('aggregateRating', {
...
CollegeOrUniversity.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
CollegeOrUniversity.property('contactPoint', {
  "name" : "contactPoint", 
...
CollegeOrUniversity.property('contactPoints', {
  "name" : "contactPoints", 
...
CollegeOrUniversity.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
CollegeOrUniversity.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
CollegeOrUniversity.property('employee', {
  "name" : "employee", 
...
CollegeOrUniversity.property('employees', {
  "name" : "employees", 
...
CollegeOrUniversity.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
CollegeOrUniversity.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
CollegeOrUniversity.property('faxNumber', {
  "name" : "faxNumber", 
...
CollegeOrUniversity.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
CollegeOrUniversity.property('founders', {
  "name" : "founders", 
...
CollegeOrUniversity.property('foundingDate', {
  "name" : "foundingDate", 
...
CollegeOrUniversity.property('globalLocationNumber', {
...
CollegeOrUniversity.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
CollegeOrUniversity.property('interactionCount', {
...
CollegeOrUniversity.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
CollegeOrUniversity.property('legalName', {
  "name" : "legalName", 
...
CollegeOrUniversity.property('location', {
  "name" : "location", 
...
CollegeOrUniversity.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
CollegeOrUniversity.property('makesOffer', {
  "name" : "makesOffer", 
...
CollegeOrUniversity.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
CollegeOrUniversity.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
CollegeOrUniversity.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
CollegeOrUniversity.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
CollegeOrUniversity.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
CollegeOrUniversity.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
CollegeOrUniversity.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
CollegeOrUniversity.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
CollegeOrUniversity.property('telephone', {
  "name" : "telephone", 
...
CollegeOrUniversity.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
CollegeOrUniversity.property('alumni', {
  "name" : "alumni", 
  "displayName" : "Alumni", 
