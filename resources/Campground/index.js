...
var Campground = resource.define('Campground'); 

Campground.schema.description = "A campground."; 
Campground.persist('fs'); 


Campground.property('additionalType', {
  "name" : "additionalType", 
...
Campground.property('aggregateRating', {
...
Campground.property('containedIn', {
  "name" : "containedIn", 
...
Campground.property('globalLocationNumber', {
...
Campground.property('interactionCount', {
...
Campground.property('openingHoursSpecification', {
...
Campground.property('openingHours', {
  "name" : "openingHours", 
