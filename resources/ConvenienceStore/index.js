...
var ConvenienceStore = resource.define('ConvenienceStore'); 

ConvenienceStore.schema.description = "A convenience store."; 
ConvenienceStore.persist('fs'); 


ConvenienceStore.property('additionalType', {
  "name" : "additionalType", 
...
ConvenienceStore.property('description', {
  "name" : "description", 
...
ConvenienceStore.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
ConvenienceStore.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
ConvenienceStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ConvenienceStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
ConvenienceStore.property('aggregateRating', {
...
ConvenienceStore.property('containedIn', {
  "name" : "containedIn", 
...
ConvenienceStore.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
ConvenienceStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
ConvenienceStore.property('faxNumber', {
  "name" : "faxNumber", 
...
ConvenienceStore.property('globalLocationNumber', {
...
ConvenienceStore.property('interactionCount', {
...
ConvenienceStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
ConvenienceStore.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
ConvenienceStore.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
ConvenienceStore.property('openingHoursSpecification', {
...
ConvenienceStore.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
ConvenienceStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
ConvenienceStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
ConvenienceStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
ConvenienceStore.property('telephone', {
  "name" : "telephone", 
...
ConvenienceStore.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
ConvenienceStore.property('contactPoint', {
  "name" : "contactPoint", 
...
ConvenienceStore.property('contactPoints', {
  "name" : "contactPoints", 
...
ConvenienceStore.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
ConvenienceStore.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
ConvenienceStore.property('employee', {
  "name" : "employee", 
...
ConvenienceStore.property('employees', {
  "name" : "employees", 
...
ConvenienceStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
ConvenienceStore.property('founders', {
  "name" : "founders", 
...
ConvenienceStore.property('foundingDate', {
  "name" : "foundingDate", 
...
ConvenienceStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
ConvenienceStore.property('legalName', {
  "name" : "legalName", 
...
ConvenienceStore.property('location', {
  "name" : "location", 
...
ConvenienceStore.property('makesOffer', {
  "name" : "makesOffer", 
...
ConvenienceStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
ConvenienceStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
ConvenienceStore.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
ConvenienceStore.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
ConvenienceStore.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
ConvenienceStore.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
ConvenienceStore.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
ConvenienceStore.property('branchOf', {
  "name" : "branchOf", 
...
ConvenienceStore.property('currenciesAccepted', {
...
ConvenienceStore.property('openingHours', {
  "name" : "openingHours", 
...
ConvenienceStore.property('paymentAccepted', {
...
ConvenienceStore.property('priceRange', {
  "name" : "priceRange", 
