...
var MusicRecording = resource.define('MusicRecording'); 

MusicRecording.schema.description = "A music recording (track), usually a single song."; 
MusicRecording.persist('fs'); 


MusicRecording.property('additionalType', {
  "name" : "additionalType", 
...
MusicRecording.property('description', {
  "name" : "description", 
...
MusicRecording.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MusicRecording.property('accountablePerson', {
...
MusicRecording.property('aggregateRating', {
...
MusicRecording.property('alternativeHeadline', {
...
MusicRecording.property('associatedMedia', {
...
MusicRecording.property('audience', {
  "name" : "audience", 
...
MusicRecording.property('author', {
  "name" : "author", 
  "displayName" : "Author", 
...
MusicRecording.property('awards', {
  "name" : "awards", 
  "displayName" : "Awards", 
...
MusicRecording.property('citation', {
  "name" : "citation", 
...
MusicRecording.property('comment', {
  "name" : "comment", 
  "displayName" : "Comment", 
...
MusicRecording.property('contentLocation', {
...
MusicRecording.property('contentRating', {
  "name" : "contentRating", 
...
MusicRecording.property('contributor', {
  "name" : "contributor", 
...
MusicRecording.property('copyrightHolder', {
...
MusicRecording.property('copyrightYear', {
  "name" : "copyrightYear", 
...
MusicRecording.property('creator', {
  "name" : "creator", 
  "displayName" : "Creator", 
...
MusicRecording.property('dateCreated', {
  "name" : "dateCreated", 
...
MusicRecording.property('dateModified', {
  "name" : "dateModified", 
...
MusicRecording.property('datePublished', {
  "name" : "datePublished", 
...
MusicRecording.property('discussionUrl', {
  "name" : "discussionUrl", 
...
MusicRecording.property('editor', {
  "name" : "editor", 
  "displayName" : "Editor", 
...
MusicRecording.property('educationalAlignment', {
...
MusicRecording.property('educationalUse', {
  "name" : "educationalUse", 
...
MusicRecording.property('encoding', {
  "name" : "encoding", 
...
MusicRecording.property('encodings', {
  "name" : "encodings", 
...
MusicRecording.property('headline', {
  "name" : "headline", 
...
MusicRecording.property('inLanguage', {
  "name" : "inLanguage", 
...
MusicRecording.property('interactionCount', {
...
MusicRecording.property('interactivityType', {
...
MusicRecording.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
MusicRecording.property('isFamilyFriendly', {
...
MusicRecording.property('keywords', {
  "name" : "keywords", 
...
MusicRecording.property('learningResourceType', {
...
MusicRecording.property('mentions', {
  "name" : "mentions", 
...
MusicRecording.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
MusicRecording.property('provider', {
  "name" : "provider", 
...
MusicRecording.property('publisher', {
  "name" : "publisher", 
...
MusicRecording.property('publishingPrinciples', {
...
MusicRecording.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MusicRecording.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MusicRecording.property('sourceOrganization', {
...
MusicRecording.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
MusicRecording.property('timeRequired', {
  "name" : "timeRequired", 
...
MusicRecording.property('typicalAgeRange', {
...
MusicRecording.property('version', {
  "name" : "version", 
  "displayName" : "Version", 
...
MusicRecording.property('byArtist', {
  "name" : "byArtist", 
  "displayName" : "By Artist", 
  "description" : "The artist that performed this album or recording.", 
"type":"object","properties" : {"MusicGroup" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


MusicRecording.property('duration', {
  "name" : "duration", 
...
MusicRecording.property('inAlbum', {
  "name" : "inAlbum", 
  "displayName" : "In Album", 
  "description" : "The album to which this recording belongs.", 
"type":"object","properties" : {"MusicAlbum" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


MusicRecording.property('inPlaylist', {
  "name" : "inPlaylist", 
  "displayName" : "In Playlist", 
  "description" : "The playlist to which this recording belongs.", 
"type":"object","properties" : {"MusicPlaylist" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 
