...
var SearchResultsPage = resource.define('SearchResultsPage'); 

SearchResultsPage.schema.description = "Web page type: Search results page."; 
SearchResultsPage.persist('fs'); 


SearchResultsPage.property('additionalType', {
  "name" : "additionalType", 
...
SearchResultsPage.property('description', {
  "name" : "description", 
...
SearchResultsPage.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
SearchResultsPage.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
SearchResultsPage.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
SearchResultsPage.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
SearchResultsPage.property('about', {
  "name" : "about", 
  "displayName" : "About", 
...
SearchResultsPage.property('accountablePerson', {
...
SearchResultsPage.property('aggregateRating', {
...
SearchResultsPage.property('alternativeHeadline', {
...
SearchResultsPage.property('associatedMedia', {
...
SearchResultsPage.property('audience', {
  "name" : "audience", 
...
SearchResultsPage.property('audio', {
  "name" : "audio", 
  "displayName" : "Audio", 
...
SearchResultsPage.property('author', {
  "name" : "author", 
  "displayName" : "Author", 
...
SearchResultsPage.property('award', {
  "name" : "award", 
  "displayName" : "Award", 
...
SearchResultsPage.property('awards', {
  "name" : "awards", 
  "displayName" : "Awards", 
...
SearchResultsPage.property('citation', {
  "name" : "citation", 
...
SearchResultsPage.property('comment', {
  "name" : "comment", 
  "displayName" : "Comment", 
...
SearchResultsPage.property('contentLocation', {
...
SearchResultsPage.property('contentRating', {
  "name" : "contentRating", 
...
SearchResultsPage.property('contributor', {
  "name" : "contributor", 
...
SearchResultsPage.property('copyrightHolder', {
...
SearchResultsPage.property('copyrightYear', {
  "name" : "copyrightYear", 
...
SearchResultsPage.property('creator', {
  "name" : "creator", 
  "displayName" : "Creator", 
...
SearchResultsPage.property('dateCreated', {
  "name" : "dateCreated", 
...
SearchResultsPage.property('dateModified', {
  "name" : "dateModified", 
...
SearchResultsPage.property('datePublished', {
  "name" : "datePublished", 
...
SearchResultsPage.property('discussionUrl', {
  "name" : "discussionUrl", 
...
SearchResultsPage.property('editor', {
  "name" : "editor", 
  "displayName" : "Editor", 
...
SearchResultsPage.property('educationalAlignment', {
...
SearchResultsPage.property('educationalUse', {
  "name" : "educationalUse", 
...
SearchResultsPage.property('encoding', {
  "name" : "encoding", 
...
SearchResultsPage.property('encodings', {
  "name" : "encodings", 
...
SearchResultsPage.property('genre', {
  "name" : "genre", 
  "displayName" : "Genre", 
...
SearchResultsPage.property('headline', {
  "name" : "headline", 
...
SearchResultsPage.property('inLanguage', {
  "name" : "inLanguage", 
...
SearchResultsPage.property('interactionCount', {
...
SearchResultsPage.property('interactivityType', {
...
SearchResultsPage.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
SearchResultsPage.property('isFamilyFriendly', {
...
SearchResultsPage.property('keywords', {
  "name" : "keywords", 
...
SearchResultsPage.property('learningResourceType', {
...
SearchResultsPage.property('mentions', {
  "name" : "mentions", 
...
SearchResultsPage.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
SearchResultsPage.property('provider', {
  "name" : "provider", 
...
SearchResultsPage.property('publisher', {
  "name" : "publisher", 
...
SearchResultsPage.property('publishingPrinciples', {
...
SearchResultsPage.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
SearchResultsPage.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
SearchResultsPage.property('sourceOrganization', {
...
SearchResultsPage.property('text', {
  "name" : "text", 
  "displayName" : "Text", 
...
SearchResultsPage.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
SearchResultsPage.property('timeRequired', {
  "name" : "timeRequired", 
...
SearchResultsPage.property('typicalAgeRange', {
...
SearchResultsPage.property('version', {
  "name" : "version", 
  "displayName" : "Version", 
...
SearchResultsPage.property('video', {
  "name" : "video", 
  "displayName" : "Video", 
...
SearchResultsPage.property('breadcrumb', {
  "name" : "breadcrumb", 
...
SearchResultsPage.property('isPartOf', {
  "name" : "isPartOf", 
...
SearchResultsPage.property('lastReviewed', {
  "name" : "lastReviewed", 
...
SearchResultsPage.property('mainContentOfPage', {
...
SearchResultsPage.property('primaryImageOfPage', {
...
SearchResultsPage.property('relatedLink', {
  "name" : "relatedLink", 
...
SearchResultsPage.property('reviewedBy', {
  "name" : "reviewedBy", 
...
SearchResultsPage.property('significantLink', {
...
SearchResultsPage.property('significantLinks', {
...
SearchResultsPage.property('specialty', {
  "name" : "specialty", 
