...
var Embassy = resource.define('Embassy'); 

Embassy.schema.description = "An embassy."; 
Embassy.persist('fs'); 


Embassy.property('additionalType', {
  "name" : "additionalType", 
...
Embassy.property('aggregateRating', {
...
Embassy.property('globalLocationNumber', {
...
Embassy.property('interactionCount', {
...
Embassy.property('openingHoursSpecification', {
