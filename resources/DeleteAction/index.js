...
var DeleteAction = resource.define('DeleteAction'); 

DeleteAction.schema.description = "The act of editing a recipient by removing one of its objects."; 
DeleteAction.persist('fs'); 


DeleteAction.property('additionalType', {
  "name" : "additionalType", 
...
DeleteAction.property('description', {
  "name" : "description", 
...
DeleteAction.property('instrument', {
  "name" : "instrument", 
...
DeleteAction.property('location', {
  "name" : "location", 
...
DeleteAction.property('participant', {
  "name" : "participant", 
...
DeleteAction.property('startTime', {
  "name" : "startTime", 
...
DeleteAction.property('collection', {
  "name" : "collection", 
