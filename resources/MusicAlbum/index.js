...
var MusicAlbum = resource.define('MusicAlbum'); 

MusicAlbum.schema.description = "A collection of music tracks."; 
MusicAlbum.persist('fs'); 


MusicAlbum.property('additionalType', {
  "name" : "additionalType", 
...
MusicAlbum.property('description', {
  "name" : "description", 
...
MusicAlbum.property('accountablePerson', {
...
MusicAlbum.property('aggregateRating', {
...
MusicAlbum.property('alternativeHeadline', {
...
MusicAlbum.property('associatedMedia', {
...
MusicAlbum.property('contentLocation', {
...
MusicAlbum.property('contentRating', {
  "name" : "contentRating", 
...
MusicAlbum.property('contributor', {
  "name" : "contributor", 
...
MusicAlbum.property('copyrightHolder', {
...
MusicAlbum.property('copyrightYear', {
  "name" : "copyrightYear", 
...
MusicAlbum.property('dateCreated', {
  "name" : "dateCreated", 
...
MusicAlbum.property('dateModified', {
  "name" : "dateModified", 
...
MusicAlbum.property('datePublished', {
  "name" : "datePublished", 
...
MusicAlbum.property('discussionUrl', {
  "name" : "discussionUrl", 
...
MusicAlbum.property('educationalAlignment', {
...
MusicAlbum.property('educationalUse', {
  "name" : "educationalUse", 
...
MusicAlbum.property('inLanguage', {
  "name" : "inLanguage", 
...
MusicAlbum.property('interactionCount', {
...
MusicAlbum.property('interactivityType', {
...
MusicAlbum.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
MusicAlbum.property('isFamilyFriendly', {
...
MusicAlbum.property('learningResourceType', {
...
MusicAlbum.property('publishingPrinciples', {
...
MusicAlbum.property('sourceOrganization', {
...
MusicAlbum.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
MusicAlbum.property('timeRequired', {
  "name" : "timeRequired", 
...
MusicAlbum.property('typicalAgeRange', {
