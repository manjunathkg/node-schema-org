...
var DDxElement = resource.define('DDxElement'); 

DDxElement.schema.description = "An alternative, closely-related condition typically considered later in the differential diagnosis process along with the signs that are used to distinguish it."; 
DDxElement.persist('fs'); 


DDxElement.property('additionalType', {
  "name" : "additionalType", 
...
DDxElement.property('description', {
  "name" : "description", 
...
DDxElement.property('alternateName', {
  "name" : "alternateName", 
...
DDxElement.property('medicineSystem', {
  "name" : "medicineSystem", 
...
DDxElement.property('recognizingAuthority', {
...
DDxElement.property('relevantSpecialty', {
...
DDxElement.property('distinguishingSign', {
  "name" : "distinguishingSign", 
  "displayName" : "Distinguishing Sign", 
