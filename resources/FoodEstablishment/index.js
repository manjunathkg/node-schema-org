...
FoodEstablishment.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
FoodEstablishment.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
FoodEstablishment.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
FoodEstablishment.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
FoodEstablishment.property('aggregateRating', {
...
FoodEstablishment.property('containedIn', {
  "name" : "containedIn", 
...
FoodEstablishment.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
FoodEstablishment.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
FoodEstablishment.property('faxNumber', {
  "name" : "faxNumber", 
...
FoodEstablishment.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
FoodEstablishment.property('globalLocationNumber', {
...
FoodEstablishment.property('interactionCount', {
...
FoodEstablishment.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
FoodEstablishment.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
FoodEstablishment.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
FoodEstablishment.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
FoodEstablishment.property('openingHoursSpecification', {
...
FoodEstablishment.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
FoodEstablishment.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
FoodEstablishment.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
FoodEstablishment.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
FoodEstablishment.property('telephone', {
  "name" : "telephone", 
...
FoodEstablishment.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
FoodEstablishment.property('contactPoint', {
  "name" : "contactPoint", 
...
FoodEstablishment.property('contactPoints', {
  "name" : "contactPoints", 
...
FoodEstablishment.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
FoodEstablishment.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
FoodEstablishment.property('employee', {
  "name" : "employee", 
...
FoodEstablishment.property('employees', {
  "name" : "employees", 
...
FoodEstablishment.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
FoodEstablishment.property('founders', {
  "name" : "founders", 
...
FoodEstablishment.property('foundingDate', {
  "name" : "foundingDate", 
...
FoodEstablishment.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
FoodEstablishment.property('legalName', {
  "name" : "legalName", 
...
FoodEstablishment.property('location', {
  "name" : "location", 
...
FoodEstablishment.property('makesOffer', {
  "name" : "makesOffer", 
...
FoodEstablishment.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
FoodEstablishment.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
FoodEstablishment.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
FoodEstablishment.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
FoodEstablishment.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
FoodEstablishment.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
FoodEstablishment.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
FoodEstablishment.property('branchOf', {
  "name" : "branchOf", 
...
FoodEstablishment.property('currenciesAccepted', {
...
FoodEstablishment.property('openingHours', {
  "name" : "openingHours", 
...
FoodEstablishment.property('paymentAccepted', {
...
FoodEstablishment.property('priceRange', {
  "name" : "priceRange", 
...
FoodEstablishment.property('acceptsReservations', {
...
FoodEstablishment.property('menu', {
  "name" : "menu", 
  "displayName" : "Menu", 
...
FoodEstablishment.property('servesCuisine', {
  "name" : "servesCuisine", 
