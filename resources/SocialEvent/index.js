...
var SocialEvent = resource.define('SocialEvent'); 

SocialEvent.schema.description = "Event type: Social event."; 
SocialEvent.persist('fs'); 


SocialEvent.property('additionalType', {
  "name" : "additionalType", 
...
SocialEvent.property('description', {
  "name" : "description", 
...
SocialEvent.property('attendees', {
  "name" : "attendees", 
...
SocialEvent.property('performer', {
  "name" : "performer", 
...
SocialEvent.property('performers', {
  "name" : "performers", 
...
SocialEvent.property('startDate', {
  "name" : "startDate", 
...
SocialEvent.property('subEvents', {
  "name" : "subEvents", 
...
SocialEvent.property('superEvent', {
  "name" : "superEvent", 
