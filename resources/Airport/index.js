...
var Airport = resource.define('Airport'); 

Airport.schema.description = "An airport."; 
Airport.persist('fs'); 


Airport.property('additionalType', {
  "name" : "additionalType", 
...
Airport.property('aggregateRating', {
...
Airport.property('globalLocationNumber', {
...
Airport.property('interactionCount', {
...
Airport.property('openingHoursSpecification', {
