...
var CityHall = resource.define('CityHall'); 

CityHall.schema.description = "A city hall."; 
CityHall.persist('fs'); 


CityHall.property('additionalType', {
  "name" : "additionalType", 
...
CityHall.property('aggregateRating', {
...
CityHall.property('globalLocationNumber', {
...
CityHall.property('interactionCount', {
...
CityHall.property('openingHoursSpecification', {
...
CityHall.property('openingHours', {
  "name" : "openingHours", 
