...
var MedicalRiskCalculator = resource.define('MedicalRiskCalculator'); 

MedicalRiskCalculator.schema.description = "A complex mathematical calculation requiring an online calculator, used to assess prognosis. Note: use the url property of Thing to record any URLs for online calculators."; 
MedicalRiskCalculator.persist('fs'); 


MedicalRiskCalculator.property('additionalType', {
  "name" : "additionalType", 
...
MedicalRiskCalculator.property('description', {
  "name" : "description", 
...
MedicalRiskCalculator.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MedicalRiskCalculator.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MedicalRiskCalculator.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MedicalRiskCalculator.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
MedicalRiskCalculator.property('alternateName', {
  "name" : "alternateName", 
...
MedicalRiskCalculator.property('code', {
  "name" : "code", 
  "displayName" : "Code", 
...
MedicalRiskCalculator.property('guideline', {
  "name" : "guideline", 
...
MedicalRiskCalculator.property('medicineSystem', {
  "name" : "medicineSystem", 
...
MedicalRiskCalculator.property('recognizingAuthority', {
...
MedicalRiskCalculator.property('relevantSpecialty', {
...
MedicalRiskCalculator.property('study', {
  "name" : "study", 
  "displayName" : "Study", 
...
MedicalRiskCalculator.property('estimatesRiskOf', {
...
MedicalRiskCalculator.property('includedRiskFactor', {
