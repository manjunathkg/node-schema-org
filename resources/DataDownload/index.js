...
var DataDownload = resource.define('DataDownload'); 

DataDownload.schema.description = "A dataset in downloadable form."; 
DataDownload.persist('fs'); 


DataDownload.property('additionalType', {
  "name" : "additionalType", 
...
DataDownload.property('description', {
  "name" : "description", 
...
DataDownload.property('accountablePerson', {
...
DataDownload.property('aggregateRating', {
...
DataDownload.property('alternativeHeadline', {
...
DataDownload.property('associatedMedia', {
...
DataDownload.property('audience', {
  "name" : "audience", 
...
DataDownload.property('citation', {
  "name" : "citation", 
...
DataDownload.property('contentLocation', {
...
DataDownload.property('contentRating', {
  "name" : "contentRating", 
...
DataDownload.property('contributor', {
  "name" : "contributor", 
...
DataDownload.property('copyrightHolder', {
...
DataDownload.property('copyrightYear', {
  "name" : "copyrightYear", 
...
DataDownload.property('dateCreated', {
  "name" : "dateCreated", 
...
DataDownload.property('dateModified', {
  "name" : "dateModified", 
...
DataDownload.property('datePublished', {
  "name" : "datePublished", 
...
DataDownload.property('discussionUrl', {
  "name" : "discussionUrl", 
...
DataDownload.property('educationalAlignment', {
...
DataDownload.property('educationalUse', {
  "name" : "educationalUse", 
...
DataDownload.property('encoding', {
  "name" : "encoding", 
...
DataDownload.property('encodings', {
  "name" : "encodings", 
...
DataDownload.property('headline', {
  "name" : "headline", 
...
DataDownload.property('inLanguage', {
  "name" : "inLanguage", 
...
DataDownload.property('interactionCount', {
...
DataDownload.property('interactivityType', {
...
DataDownload.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
DataDownload.property('isFamilyFriendly', {
...
DataDownload.property('keywords', {
  "name" : "keywords", 
...
DataDownload.property('learningResourceType', {
...
DataDownload.property('mentions', {
  "name" : "mentions", 
...
DataDownload.property('provider', {
  "name" : "provider", 
...
DataDownload.property('publisher', {
  "name" : "publisher", 
...
DataDownload.property('publishingPrinciples', {
...
DataDownload.property('sourceOrganization', {
...
DataDownload.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
DataDownload.property('timeRequired', {
  "name" : "timeRequired", 
...
DataDownload.property('typicalAgeRange', {
...
DataDownload.property('associatedArticle', {
...
DataDownload.property('contentSize', {
  "name" : "contentSize", 
...
DataDownload.property('contentUrl', {
  "name" : "contentUrl", 
...
DataDownload.property('duration', {
  "name" : "duration", 
...
DataDownload.property('embedUrl', {
  "name" : "embedUrl", 
...
DataDownload.property('encodesCreativeWork', {
...
DataDownload.property('encodingFormat', {
  "name" : "encodingFormat", 
...
DataDownload.property('playerType', {
  "name" : "playerType", 
...
DataDownload.property('regionsAllowed', {
  "name" : "regionsAllowed", 
...
DataDownload.property('requiresSubscription', {
...
DataDownload.property('uploadDate', {
  "name" : "uploadDate", 
