...
var Courthouse = resource.define('Courthouse'); 

Courthouse.schema.description = "A courthouse."; 
Courthouse.persist('fs'); 


Courthouse.property('additionalType', {
  "name" : "additionalType", 
...
Courthouse.property('description', {
  "name" : "description", 
...
Courthouse.property('aggregateRating', {
...
Courthouse.property('containedIn', {
  "name" : "containedIn", 
...
Courthouse.property('globalLocationNumber', {
...
Courthouse.property('interactionCount', {
...
Courthouse.property('openingHoursSpecification', {
...
Courthouse.property('openingHours', {
  "name" : "openingHours", 
