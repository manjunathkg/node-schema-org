...
var HobbyShop = resource.define('HobbyShop'); 

HobbyShop.schema.description = "A hobby store."; 
HobbyShop.persist('fs'); 


HobbyShop.property('additionalType', {
  "name" : "additionalType", 
...
HobbyShop.property('description', {
  "name" : "description", 
...
HobbyShop.property('aggregateRating', {
...
HobbyShop.property('containedIn', {
  "name" : "containedIn", 
...
HobbyShop.property('globalLocationNumber', {
...
HobbyShop.property('interactionCount', {
...
HobbyShop.property('openingHoursSpecification', {
...
HobbyShop.property('contactPoint', {
  "name" : "contactPoint", 
...
HobbyShop.property('contactPoints', {
  "name" : "contactPoints", 
...
HobbyShop.property('foundingDate', {
  "name" : "foundingDate", 
...
HobbyShop.property('currenciesAccepted', {
...
HobbyShop.property('openingHours', {
  "name" : "openingHours", 
...
HobbyShop.property('paymentAccepted', {
