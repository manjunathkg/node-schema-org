...
var EndorseAction = resource.define('EndorseAction'); 

EndorseAction.schema.description = "An agent approves/certifies/likes/supports/sanction an object."; 
EndorseAction.persist('fs'); 


EndorseAction.property('additionalType', {
  "name" : "additionalType", 
...
EndorseAction.property('description', {
  "name" : "description", 
...
EndorseAction.property('endTime', {
  "name" : "endTime", 
...
EndorseAction.property('instrument', {
  "name" : "instrument", 
...
EndorseAction.property('location', {
  "name" : "location", 
...
EndorseAction.property('participant', {
  "name" : "participant", 
...
EndorseAction.property('startTime', {
  "name" : "startTime", 
...
EndorseAction.property('endorsee', {
  "name" : "endorsee", 
  "displayName" : "Endorsee", 
