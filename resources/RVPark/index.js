...
var RVPark = resource.define('RVPark'); 

RVPark.schema.description = "An RV park."; 
RVPark.persist('fs'); 


RVPark.property('additionalType', {
  "name" : "additionalType", 
...
RVPark.property('aggregateRating', {
...
RVPark.property('globalLocationNumber', {
...
RVPark.property('interactionCount', {
...
RVPark.property('openingHoursSpecification', {
