...
var MobilePhoneStore = resource.define('MobilePhoneStore'); 

MobilePhoneStore.schema.description = "A mobile-phone store."; 
MobilePhoneStore.persist('fs'); 


MobilePhoneStore.property('additionalType', {
  "name" : "additionalType", 
...
MobilePhoneStore.property('description', {
  "name" : "description", 
...
MobilePhoneStore.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MobilePhoneStore.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MobilePhoneStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MobilePhoneStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
MobilePhoneStore.property('aggregateRating', {
...
MobilePhoneStore.property('containedIn', {
  "name" : "containedIn", 
...
MobilePhoneStore.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
MobilePhoneStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
MobilePhoneStore.property('faxNumber', {
  "name" : "faxNumber", 
...
MobilePhoneStore.property('globalLocationNumber', {
...
MobilePhoneStore.property('interactionCount', {
...
MobilePhoneStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
MobilePhoneStore.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
MobilePhoneStore.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
MobilePhoneStore.property('openingHoursSpecification', {
...
MobilePhoneStore.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
MobilePhoneStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
MobilePhoneStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MobilePhoneStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MobilePhoneStore.property('telephone', {
  "name" : "telephone", 
...
MobilePhoneStore.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
MobilePhoneStore.property('contactPoint', {
  "name" : "contactPoint", 
...
MobilePhoneStore.property('contactPoints', {
  "name" : "contactPoints", 
...
MobilePhoneStore.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
MobilePhoneStore.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
MobilePhoneStore.property('employee', {
  "name" : "employee", 
...
MobilePhoneStore.property('employees', {
  "name" : "employees", 
...
MobilePhoneStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
MobilePhoneStore.property('founders', {
  "name" : "founders", 
...
MobilePhoneStore.property('foundingDate', {
  "name" : "foundingDate", 
...
MobilePhoneStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
MobilePhoneStore.property('legalName', {
  "name" : "legalName", 
...
MobilePhoneStore.property('location', {
  "name" : "location", 
...
MobilePhoneStore.property('makesOffer', {
  "name" : "makesOffer", 
...
MobilePhoneStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
MobilePhoneStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
MobilePhoneStore.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
MobilePhoneStore.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
MobilePhoneStore.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
MobilePhoneStore.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
MobilePhoneStore.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
MobilePhoneStore.property('branchOf', {
  "name" : "branchOf", 
...
MobilePhoneStore.property('currenciesAccepted', {
...
MobilePhoneStore.property('openingHours', {
  "name" : "openingHours", 
...
MobilePhoneStore.property('paymentAccepted', {
...
MobilePhoneStore.property('priceRange', {
  "name" : "priceRange", 
