...
var RoofingContractor = resource.define('RoofingContractor'); 

RoofingContractor.schema.description = "A roofing contractor."; 
RoofingContractor.persist('fs'); 


RoofingContractor.property('additionalType', {
  "name" : "additionalType", 
...
RoofingContractor.property('description', {
  "name" : "description", 
...
RoofingContractor.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
RoofingContractor.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
RoofingContractor.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
RoofingContractor.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
RoofingContractor.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
RoofingContractor.property('aggregateRating', {
...
RoofingContractor.property('containedIn', {
  "name" : "containedIn", 
...
RoofingContractor.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
RoofingContractor.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
RoofingContractor.property('faxNumber', {
  "name" : "faxNumber", 
...
RoofingContractor.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
RoofingContractor.property('globalLocationNumber', {
...
RoofingContractor.property('interactionCount', {
...
RoofingContractor.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
RoofingContractor.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
RoofingContractor.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
RoofingContractor.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
RoofingContractor.property('openingHoursSpecification', {
...
RoofingContractor.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
RoofingContractor.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
RoofingContractor.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
RoofingContractor.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
RoofingContractor.property('telephone', {
  "name" : "telephone", 
...
RoofingContractor.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
RoofingContractor.property('contactPoint', {
  "name" : "contactPoint", 
...
RoofingContractor.property('contactPoints', {
  "name" : "contactPoints", 
...
RoofingContractor.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
RoofingContractor.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
RoofingContractor.property('employee', {
  "name" : "employee", 
...
RoofingContractor.property('employees', {
  "name" : "employees", 
...
RoofingContractor.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
RoofingContractor.property('founders', {
  "name" : "founders", 
...
RoofingContractor.property('foundingDate', {
  "name" : "foundingDate", 
...
RoofingContractor.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
RoofingContractor.property('legalName', {
  "name" : "legalName", 
...
RoofingContractor.property('location', {
  "name" : "location", 
...
RoofingContractor.property('makesOffer', {
  "name" : "makesOffer", 
...
RoofingContractor.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
RoofingContractor.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
RoofingContractor.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
RoofingContractor.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
RoofingContractor.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
RoofingContractor.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
RoofingContractor.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
RoofingContractor.property('branchOf', {
  "name" : "branchOf", 
...
RoofingContractor.property('currenciesAccepted', {
...
RoofingContractor.property('openingHours', {
  "name" : "openingHours", 
...
RoofingContractor.property('paymentAccepted', {
...
RoofingContractor.property('priceRange', {
  "name" : "priceRange", 
