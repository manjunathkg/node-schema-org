...
var PayAction = resource.define('PayAction'); 

PayAction.schema.description = "An agent pays a price to a participant."; 
PayAction.persist('fs'); 


PayAction.property('additionalType', {
  "name" : "additionalType", 
...
PayAction.property('description', {
  "name" : "description", 
...
PayAction.property('participant', {
  "name" : "participant", 
