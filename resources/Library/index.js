...
var Library = resource.define('Library'); 

Library.schema.description = "A library."; 
Library.persist('fs'); 


Library.property('additionalType', {
  "name" : "additionalType", 
...
Library.property('aggregateRating', {
...
Library.property('globalLocationNumber', {
...
Library.property('interactionCount', {
...
Library.property('openingHoursSpecification', {
...
Library.property('contactPoints', {
  "name" : "contactPoints", 
...
Library.property('currenciesAccepted', {
...
Library.property('paymentAccepted', {
