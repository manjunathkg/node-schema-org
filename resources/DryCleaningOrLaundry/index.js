...
var DryCleaningOrLaundry = resource.define('DryCleaningOrLaundry'); 

DryCleaningOrLaundry.schema.description = "A dry-cleaning business."; 
DryCleaningOrLaundry.persist('fs'); 


DryCleaningOrLaundry.property('additionalType', {
  "name" : "additionalType", 
...
DryCleaningOrLaundry.property('description', {
  "name" : "description", 
...
DryCleaningOrLaundry.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
DryCleaningOrLaundry.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
DryCleaningOrLaundry.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
DryCleaningOrLaundry.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
DryCleaningOrLaundry.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
DryCleaningOrLaundry.property('aggregateRating', {
...
DryCleaningOrLaundry.property('containedIn', {
  "name" : "containedIn", 
...
DryCleaningOrLaundry.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
DryCleaningOrLaundry.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
DryCleaningOrLaundry.property('faxNumber', {
  "name" : "faxNumber", 
...
DryCleaningOrLaundry.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
DryCleaningOrLaundry.property('globalLocationNumber', {
...
DryCleaningOrLaundry.property('interactionCount', {
...
DryCleaningOrLaundry.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
DryCleaningOrLaundry.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
DryCleaningOrLaundry.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
DryCleaningOrLaundry.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
DryCleaningOrLaundry.property('openingHoursSpecification', {
...
DryCleaningOrLaundry.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
DryCleaningOrLaundry.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
DryCleaningOrLaundry.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
DryCleaningOrLaundry.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
DryCleaningOrLaundry.property('telephone', {
  "name" : "telephone", 
...
DryCleaningOrLaundry.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
DryCleaningOrLaundry.property('contactPoint', {
  "name" : "contactPoint", 
...
DryCleaningOrLaundry.property('contactPoints', {
  "name" : "contactPoints", 
...
DryCleaningOrLaundry.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
DryCleaningOrLaundry.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
DryCleaningOrLaundry.property('employee', {
  "name" : "employee", 
...
DryCleaningOrLaundry.property('employees', {
  "name" : "employees", 
...
DryCleaningOrLaundry.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
DryCleaningOrLaundry.property('founders', {
  "name" : "founders", 
...
DryCleaningOrLaundry.property('foundingDate', {
  "name" : "foundingDate", 
...
DryCleaningOrLaundry.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
DryCleaningOrLaundry.property('legalName', {
  "name" : "legalName", 
...
DryCleaningOrLaundry.property('location', {
  "name" : "location", 
...
DryCleaningOrLaundry.property('makesOffer', {
  "name" : "makesOffer", 
...
DryCleaningOrLaundry.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
DryCleaningOrLaundry.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
DryCleaningOrLaundry.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
DryCleaningOrLaundry.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
DryCleaningOrLaundry.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
DryCleaningOrLaundry.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
DryCleaningOrLaundry.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
DryCleaningOrLaundry.property('branchOf', {
  "name" : "branchOf", 
...
DryCleaningOrLaundry.property('currenciesAccepted', {
...
DryCleaningOrLaundry.property('openingHours', {
  "name" : "openingHours", 
...
DryCleaningOrLaundry.property('paymentAccepted', {
...
DryCleaningOrLaundry.property('priceRange', {
  "name" : "priceRange", 
