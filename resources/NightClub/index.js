...
var NightClub = resource.define('NightClub'); 

NightClub.schema.description = "A nightclub or discotheque."; 
NightClub.persist('fs'); 


NightClub.property('additionalType', {
  "name" : "additionalType", 
...
NightClub.property('description', {
  "name" : "description", 
...
NightClub.property('aggregateRating', {
...
NightClub.property('containedIn', {
  "name" : "containedIn", 
...
NightClub.property('globalLocationNumber', {
...
NightClub.property('interactionCount', {
...
NightClub.property('openingHoursSpecification', {
...
NightClub.property('contactPoint', {
  "name" : "contactPoint", 
...
NightClub.property('contactPoints', {
  "name" : "contactPoints", 
...
NightClub.property('foundingDate', {
  "name" : "foundingDate", 
...
NightClub.property('currenciesAccepted', {
...
NightClub.property('openingHours', {
  "name" : "openingHours", 
...
NightClub.property('paymentAccepted', {
