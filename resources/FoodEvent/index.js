...
var FoodEvent = resource.define('FoodEvent'); 

FoodEvent.schema.description = "Event type: Food event."; 
FoodEvent.persist('fs'); 


FoodEvent.property('additionalType', {
  "name" : "additionalType", 
...
FoodEvent.property('description', {
  "name" : "description", 
