...
var MoveAction = resource.define('MoveAction'); 

MoveAction.schema.description = "The act of an agent relocating to a place.Related actions:TransferAction: Unlike TransferAction, the subject of the move is a living Person or Organization rather than an inanimate object."; 
MoveAction.persist('fs'); 


MoveAction.property('additionalType', {
  "name" : "additionalType", 
...
MoveAction.property('description', {
  "name" : "description", 
...
MoveAction.property('instrument', {
  "name" : "instrument", 
...
MoveAction.property('participant', {
  "name" : "participant", 
...
MoveAction.property('fromLocation', {
  "name" : "fromLocation", 
...
MoveAction.property('toLocation', {
  "name" : "toLocation", 
