...
var UserDownloads = resource.define('UserDownloads'); 

UserDownloads.schema.description = "User interaction: Download of an item."; 
UserDownloads.persist('fs'); 


UserDownloads.property('additionalType', {
  "name" : "additionalType", 
...
UserDownloads.property('description', {
  "name" : "description", 
...
UserDownloads.property('attendee', {
  "name" : "attendee", 
...
UserDownloads.property('attendees', {
  "name" : "attendees", 
...
UserDownloads.property('duration', {
  "name" : "duration", 
...
UserDownloads.property('endDate', {
  "name" : "endDate", 
...
UserDownloads.property('location', {
  "name" : "location", 
...
UserDownloads.property('performer', {
  "name" : "performer", 
...
UserDownloads.property('performers', {
  "name" : "performers", 
...
UserDownloads.property('startDate', {
  "name" : "startDate", 
...
UserDownloads.property('subEvent', {
  "name" : "subEvent", 
...
UserDownloads.property('subEvents', {
  "name" : "subEvents", 
...
UserDownloads.property('superEvent', {
  "name" : "superEvent", 
