...
var PawnShop = resource.define('PawnShop'); 

PawnShop.schema.description = "A pawnstore."; 
PawnShop.persist('fs'); 


PawnShop.property('additionalType', {
  "name" : "additionalType", 
...
PawnShop.property('aggregateRating', {
...
PawnShop.property('globalLocationNumber', {
...
PawnShop.property('interactionCount', {
...
PawnShop.property('openingHoursSpecification', {
...
PawnShop.property('contactPoint', {
  "name" : "contactPoint", 
...
PawnShop.property('contactPoints', {
  "name" : "contactPoints", 
...
PawnShop.property('foundingDate', {
  "name" : "foundingDate", 
...
PawnShop.property('currenciesAccepted', {
...
PawnShop.property('openingHours', {
  "name" : "openingHours", 
...
PawnShop.property('paymentAccepted', {
