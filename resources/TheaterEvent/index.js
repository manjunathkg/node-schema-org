...
var TheaterEvent = resource.define('TheaterEvent'); 

TheaterEvent.schema.description = "Event type: Theater performance."; 
TheaterEvent.persist('fs'); 


TheaterEvent.property('additionalType', {
  "name" : "additionalType", 
...
TheaterEvent.property('description', {
  "name" : "description", 
...
TheaterEvent.property('attendee', {
  "name" : "attendee", 
...
TheaterEvent.property('attendees', {
  "name" : "attendees", 
...
TheaterEvent.property('duration', {
  "name" : "duration", 
...
TheaterEvent.property('location', {
  "name" : "location", 
...
TheaterEvent.property('performer', {
  "name" : "performer", 
...
TheaterEvent.property('performers', {
  "name" : "performers", 
...
TheaterEvent.property('startDate', {
  "name" : "startDate", 
...
TheaterEvent.property('subEvent', {
  "name" : "subEvent", 
...
TheaterEvent.property('subEvents', {
  "name" : "subEvents", 
...
TheaterEvent.property('superEvent', {
  "name" : "superEvent", 
