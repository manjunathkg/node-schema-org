...
var CreateAction = resource.define('CreateAction'); 

CreateAction.schema.description = "The act of deliberately creating/producing/generating/building a result out of the agent."; 
CreateAction.persist('fs'); 


CreateAction.property('additionalType', {
  "name" : "additionalType", 
...
CreateAction.property('description', {
  "name" : "description", 
...
CreateAction.property('instrument', {
  "name" : "instrument", 
...
CreateAction.property('location', {
  "name" : "location", 
...
CreateAction.property('participant', {
  "name" : "participant", 
...
CreateAction.property('startTime', {
  "name" : "startTime", 
