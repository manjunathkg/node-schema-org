...
var ReviewAction = resource.define('ReviewAction'); 

ReviewAction.schema.description = "The act of producing a balanced opinion about the object for an audience. An agent reviews an object with participants resulting in a review."; 
ReviewAction.persist('fs'); 


ReviewAction.property('additionalType', {
  "name" : "additionalType", 
...
ReviewAction.property('description', {
  "name" : "description", 
...
ReviewAction.property('instrument', {
  "name" : "instrument", 
...
ReviewAction.property('location', {
  "name" : "location", 
...
ReviewAction.property('participant', {
  "name" : "participant", 
...
ReviewAction.property('startTime', {
  "name" : "startTime", 
...
ReviewAction.property('resultReview', {
  "name" : "resultReview", 
