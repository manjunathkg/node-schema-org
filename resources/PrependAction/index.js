...
var PrependAction = resource.define('PrependAction'); 

PrependAction.schema.description = "The act of inserting at the beginning if an ordered collection."; 
PrependAction.persist('fs'); 


PrependAction.property('additionalType', {
  "name" : "additionalType", 
...
PrependAction.property('description', {
  "name" : "description", 
...
PrependAction.property('endTime', {
  "name" : "endTime", 
...
PrependAction.property('instrument', {
  "name" : "instrument", 
...
PrependAction.property('location', {
  "name" : "location", 
...
PrependAction.property('participant', {
  "name" : "participant", 
...
PrependAction.property('startTime', {
  "name" : "startTime", 
...
PrependAction.property('collection', {
  "name" : "collection", 
...
PrependAction.property('toLocation', {
  "name" : "toLocation", 
