...
var LoseAction = resource.define('LoseAction'); 

LoseAction.schema.description = "The act of being defeated in a competitive activity."; 
LoseAction.persist('fs'); 


LoseAction.property('additionalType', {
  "name" : "additionalType", 
...
LoseAction.property('description', {
  "name" : "description", 
...
LoseAction.property('instrument', {
  "name" : "instrument", 
...
LoseAction.property('participant', {
  "name" : "participant", 
