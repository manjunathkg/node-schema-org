...
var SingleFamilyResidence = resource.define('SingleFamilyResidence'); 

SingleFamilyResidence.schema.description = "Residence type: Single-family home."; 
SingleFamilyResidence.persist('fs'); 


SingleFamilyResidence.property('additionalType', {
  "name" : "additionalType", 
...
SingleFamilyResidence.property('description', {
  "name" : "description", 
...
SingleFamilyResidence.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
SingleFamilyResidence.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
SingleFamilyResidence.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
SingleFamilyResidence.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
SingleFamilyResidence.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
SingleFamilyResidence.property('aggregateRating', {
...
SingleFamilyResidence.property('containedIn', {
  "name" : "containedIn", 
...
SingleFamilyResidence.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
SingleFamilyResidence.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
SingleFamilyResidence.property('faxNumber', {
  "name" : "faxNumber", 
...
SingleFamilyResidence.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
SingleFamilyResidence.property('globalLocationNumber', {
...
SingleFamilyResidence.property('interactionCount', {
...
SingleFamilyResidence.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
SingleFamilyResidence.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
SingleFamilyResidence.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
SingleFamilyResidence.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
SingleFamilyResidence.property('openingHoursSpecification', {
...
SingleFamilyResidence.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
SingleFamilyResidence.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
SingleFamilyResidence.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
SingleFamilyResidence.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
SingleFamilyResidence.property('telephone', {
  "name" : "telephone", 
