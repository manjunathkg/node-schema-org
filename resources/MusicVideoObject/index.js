...
var MusicVideoObject = resource.define('MusicVideoObject'); 

MusicVideoObject.schema.description = "A music video file."; 
MusicVideoObject.persist('fs'); 


MusicVideoObject.property('additionalType', {
  "name" : "additionalType", 
...
MusicVideoObject.property('description', {
  "name" : "description", 
...
MusicVideoObject.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MusicVideoObject.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MusicVideoObject.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MusicVideoObject.property('about', {
  "name" : "about", 
  "displayName" : "About", 
...
MusicVideoObject.property('accountablePerson', {
...
MusicVideoObject.property('aggregateRating', {
...
MusicVideoObject.property('alternativeHeadline', {
...
MusicVideoObject.property('associatedMedia', {
...
MusicVideoObject.property('audience', {
  "name" : "audience", 
...
MusicVideoObject.property('audio', {
  "name" : "audio", 
  "displayName" : "Audio", 
...
MusicVideoObject.property('author', {
  "name" : "author", 
  "displayName" : "Author", 
...
MusicVideoObject.property('award', {
  "name" : "award", 
  "displayName" : "Award", 
...
MusicVideoObject.property('awards', {
  "name" : "awards", 
  "displayName" : "Awards", 
...
MusicVideoObject.property('citation', {
  "name" : "citation", 
...
MusicVideoObject.property('comment', {
  "name" : "comment", 
  "displayName" : "Comment", 
...
MusicVideoObject.property('contentLocation', {
...
MusicVideoObject.property('contentRating', {
  "name" : "contentRating", 
...
MusicVideoObject.property('contributor', {
  "name" : "contributor", 
...
MusicVideoObject.property('copyrightHolder', {
...
MusicVideoObject.property('copyrightYear', {
  "name" : "copyrightYear", 
...
MusicVideoObject.property('creator', {
  "name" : "creator", 
  "displayName" : "Creator", 
...
MusicVideoObject.property('dateCreated', {
  "name" : "dateCreated", 
...
MusicVideoObject.property('dateModified', {
  "name" : "dateModified", 
...
MusicVideoObject.property('datePublished', {
  "name" : "datePublished", 
...
MusicVideoObject.property('discussionUrl', {
  "name" : "discussionUrl", 
...
MusicVideoObject.property('editor', {
  "name" : "editor", 
  "displayName" : "Editor", 
...
MusicVideoObject.property('educationalAlignment', {
...
MusicVideoObject.property('educationalUse', {
  "name" : "educationalUse", 
...
MusicVideoObject.property('encoding', {
  "name" : "encoding", 
...
MusicVideoObject.property('encodings', {
  "name" : "encodings", 
...
MusicVideoObject.property('genre', {
  "name" : "genre", 
  "displayName" : "Genre", 
...
MusicVideoObject.property('headline', {
  "name" : "headline", 
...
MusicVideoObject.property('inLanguage', {
  "name" : "inLanguage", 
...
MusicVideoObject.property('interactionCount', {
...
MusicVideoObject.property('interactivityType', {
...
MusicVideoObject.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
MusicVideoObject.property('isFamilyFriendly', {
...
MusicVideoObject.property('keywords', {
  "name" : "keywords", 
...
MusicVideoObject.property('learningResourceType', {
...
MusicVideoObject.property('mentions', {
  "name" : "mentions", 
...
MusicVideoObject.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
MusicVideoObject.property('provider', {
  "name" : "provider", 
...
MusicVideoObject.property('publisher', {
  "name" : "publisher", 
...
MusicVideoObject.property('publishingPrinciples', {
...
MusicVideoObject.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MusicVideoObject.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MusicVideoObject.property('sourceOrganization', {
...
MusicVideoObject.property('text', {
  "name" : "text", 
  "displayName" : "Text", 
...
MusicVideoObject.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
MusicVideoObject.property('timeRequired', {
  "name" : "timeRequired", 
...
MusicVideoObject.property('typicalAgeRange', {
...
MusicVideoObject.property('version', {
  "name" : "version", 
  "displayName" : "Version", 
...
MusicVideoObject.property('video', {
  "name" : "video", 
  "displayName" : "Video", 
...
MusicVideoObject.property('associatedArticle', {
...
MusicVideoObject.property('bitrate', {
  "name" : "bitrate", 
  "displayName" : "Bitrate", 
...
MusicVideoObject.property('contentSize', {
  "name" : "contentSize", 
...
MusicVideoObject.property('contentUrl', {
  "name" : "contentUrl", 
...
MusicVideoObject.property('duration', {
  "name" : "duration", 
...
MusicVideoObject.property('embedUrl', {
  "name" : "embedUrl", 
...
MusicVideoObject.property('encodesCreativeWork', {
...
MusicVideoObject.property('encodingFormat', {
  "name" : "encodingFormat", 
...
MusicVideoObject.property('expires', {
  "name" : "expires", 
  "displayName" : "Expires", 
...
MusicVideoObject.property('height', {
  "name" : "height", 
  "displayName" : "Height", 
...
MusicVideoObject.property('playerType', {
  "name" : "playerType", 
...
MusicVideoObject.property('regionsAllowed', {
  "name" : "regionsAllowed", 
...
MusicVideoObject.property('requiresSubscription', {
...
MusicVideoObject.property('uploadDate', {
  "name" : "uploadDate", 
...
MusicVideoObject.property('width', {
  "name" : "width", 
  "displayName" : "Width", 
