...
var BookStore = resource.define('BookStore'); 

BookStore.schema.description = "A bookstore."; 
BookStore.persist('fs'); 


BookStore.property('additionalType', {
  "name" : "additionalType", 
...
BookStore.property('description', {
  "name" : "description", 
...
BookStore.property('aggregateRating', {
...
BookStore.property('containedIn', {
  "name" : "containedIn", 
...
BookStore.property('globalLocationNumber', {
...
BookStore.property('interactionCount', {
...
BookStore.property('openingHoursSpecification', {
...
BookStore.property('contactPoint', {
  "name" : "contactPoint", 
...
BookStore.property('contactPoints', {
  "name" : "contactPoints", 
...
BookStore.property('foundingDate', {
  "name" : "foundingDate", 
...
BookStore.property('currenciesAccepted', {
...
BookStore.property('openingHours', {
  "name" : "openingHours", 
...
BookStore.property('paymentAccepted', {
