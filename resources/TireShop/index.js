...
var TireShop = resource.define('TireShop'); 

TireShop.schema.description = "A tire shop."; 
TireShop.persist('fs'); 


TireShop.property('additionalType', {
  "name" : "additionalType", 
...
TireShop.property('aggregateRating', {
...
TireShop.property('globalLocationNumber', {
...
TireShop.property('interactionCount', {
...
TireShop.property('openingHoursSpecification', {
...
TireShop.property('contactPoint', {
  "name" : "contactPoint", 
...
TireShop.property('contactPoints', {
  "name" : "contactPoints", 
...
TireShop.property('foundingDate', {
  "name" : "foundingDate", 
...
TireShop.property('currenciesAccepted', {
...
TireShop.property('openingHours', {
  "name" : "openingHours", 
...
TireShop.property('paymentAccepted', {
