...
var DanceEvent = resource.define('DanceEvent'); 

DanceEvent.schema.description = "Event type: A social dance."; 
DanceEvent.persist('fs'); 


DanceEvent.property('additionalType', {
  "name" : "additionalType", 
...
DanceEvent.property('description', {
  "name" : "description", 
...
DanceEvent.property('performers', {
  "name" : "performers", 
...
DanceEvent.property('superEvent', {
  "name" : "superEvent", 
