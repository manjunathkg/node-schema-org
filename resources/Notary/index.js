...
var Notary = resource.define('Notary'); 

Notary.schema.description = "A notary."; 
Notary.persist('fs'); 


Notary.property('additionalType', {
  "name" : "additionalType", 
...
Notary.property('aggregateRating', {
...
Notary.property('globalLocationNumber', {
...
Notary.property('interactionCount', {
...
Notary.property('openingHoursSpecification', {
...
Notary.property('currenciesAccepted', {
...
Notary.property('paymentAccepted', {
