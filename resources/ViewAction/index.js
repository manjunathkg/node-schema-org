...
var ViewAction = resource.define('ViewAction'); 

ViewAction.schema.description = "The act of consuming static visual content."; 
ViewAction.persist('fs'); 


ViewAction.property('additionalType', {
  "name" : "additionalType", 
...
ViewAction.property('description', {
  "name" : "description", 
...
ViewAction.property('instrument', {
  "name" : "instrument", 
...
ViewAction.property('participant', {
  "name" : "participant", 
