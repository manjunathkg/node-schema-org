...
var HealthAndBeautyBusiness = resource.define('HealthAndBeautyBusiness'); 

HealthAndBeautyBusiness.schema.description = "Health and beauty."; 
HealthAndBeautyBusiness.persist('fs'); 


HealthAndBeautyBusiness.property('additionalType', {
  "name" : "additionalType", 
...
HealthAndBeautyBusiness.property('description', {
  "name" : "description", 
...
HealthAndBeautyBusiness.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
HealthAndBeautyBusiness.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
HealthAndBeautyBusiness.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
HealthAndBeautyBusiness.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
HealthAndBeautyBusiness.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
HealthAndBeautyBusiness.property('aggregateRating', {
...
HealthAndBeautyBusiness.property('containedIn', {
  "name" : "containedIn", 
...
HealthAndBeautyBusiness.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
HealthAndBeautyBusiness.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
HealthAndBeautyBusiness.property('faxNumber', {
  "name" : "faxNumber", 
...
HealthAndBeautyBusiness.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
HealthAndBeautyBusiness.property('globalLocationNumber', {
...
HealthAndBeautyBusiness.property('interactionCount', {
...
HealthAndBeautyBusiness.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
HealthAndBeautyBusiness.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
HealthAndBeautyBusiness.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
HealthAndBeautyBusiness.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
HealthAndBeautyBusiness.property('openingHoursSpecification', {
...
HealthAndBeautyBusiness.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
HealthAndBeautyBusiness.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
HealthAndBeautyBusiness.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
HealthAndBeautyBusiness.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
HealthAndBeautyBusiness.property('telephone', {
  "name" : "telephone", 
...
HealthAndBeautyBusiness.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
HealthAndBeautyBusiness.property('contactPoint', {
  "name" : "contactPoint", 
...
HealthAndBeautyBusiness.property('contactPoints', {
  "name" : "contactPoints", 
...
HealthAndBeautyBusiness.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
HealthAndBeautyBusiness.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
HealthAndBeautyBusiness.property('employee', {
  "name" : "employee", 
...
HealthAndBeautyBusiness.property('employees', {
  "name" : "employees", 
...
HealthAndBeautyBusiness.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
HealthAndBeautyBusiness.property('founders', {
  "name" : "founders", 
...
HealthAndBeautyBusiness.property('foundingDate', {
  "name" : "foundingDate", 
...
HealthAndBeautyBusiness.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
HealthAndBeautyBusiness.property('legalName', {
  "name" : "legalName", 
...
HealthAndBeautyBusiness.property('location', {
  "name" : "location", 
...
HealthAndBeautyBusiness.property('makesOffer', {
  "name" : "makesOffer", 
...
HealthAndBeautyBusiness.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
HealthAndBeautyBusiness.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
HealthAndBeautyBusiness.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
HealthAndBeautyBusiness.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
HealthAndBeautyBusiness.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
HealthAndBeautyBusiness.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
HealthAndBeautyBusiness.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
HealthAndBeautyBusiness.property('branchOf', {
  "name" : "branchOf", 
...
HealthAndBeautyBusiness.property('currenciesAccepted', {
...
HealthAndBeautyBusiness.property('openingHours', {
  "name" : "openingHours", 
...
HealthAndBeautyBusiness.property('paymentAccepted', {
...
HealthAndBeautyBusiness.property('priceRange', {
  "name" : "priceRange", 
