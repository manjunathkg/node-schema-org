...
var Pharmacy = resource.define('Pharmacy'); 

Pharmacy.schema.description = "A pharmacy or drugstore."; 
Pharmacy.persist('fs'); 


Pharmacy.property('additionalType', {
  "name" : "additionalType", 
...
Pharmacy.property('aggregateRating', {
...
Pharmacy.property('globalLocationNumber', {
...
Pharmacy.property('interactionCount', {
...
Pharmacy.property('openingHoursSpecification', {
...
Pharmacy.property('contactPoint', {
  "name" : "contactPoint", 
...
Pharmacy.property('contactPoints', {
  "name" : "contactPoints", 
...
Pharmacy.property('foundingDate', {
  "name" : "foundingDate", 
...
Pharmacy.property('currenciesAccepted', {
...
Pharmacy.property('openingHours', {
  "name" : "openingHours", 
...
Pharmacy.property('paymentAccepted', {
