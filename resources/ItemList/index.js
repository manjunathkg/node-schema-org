...
var ItemList = resource.define('ItemList'); 

ItemList.schema.description = "A list of items of any sort—for example, Top 10 Movies About Weathermen, or Top 100 Party Songs. Not to be confused with HTML lists, which are often used only for formatting."; 
ItemList.persist('fs'); 


ItemList.property('additionalType', {
  "name" : "additionalType", 
...
ItemList.property('accountablePerson', {
...
ItemList.property('aggregateRating', {
...
ItemList.property('alternativeHeadline', {
...
ItemList.property('associatedMedia', {
...
ItemList.property('contentLocation', {
...
ItemList.property('contentRating', {
  "name" : "contentRating", 
...
ItemList.property('copyrightHolder', {
...
ItemList.property('copyrightYear', {
  "name" : "copyrightYear", 
...
ItemList.property('dateModified', {
  "name" : "dateModified", 
...
ItemList.property('datePublished', {
  "name" : "datePublished", 
...
ItemList.property('discussionUrl', {
  "name" : "discussionUrl", 
...
ItemList.property('educationalAlignment', {
...
ItemList.property('educationalUse', {
  "name" : "educationalUse", 
...
ItemList.property('interactionCount', {
...
ItemList.property('interactivityType', {
...
ItemList.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
ItemList.property('isFamilyFriendly', {
...
ItemList.property('learningResourceType', {
...
ItemList.property('publishingPrinciples', {
...
ItemList.property('sourceOrganization', {
...
ItemList.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
ItemList.property('timeRequired', {
  "name" : "timeRequired", 
...
ItemList.property('typicalAgeRange', {
...
ItemList.property('itemListElement', {
  "name" : "itemListElement", 
  "displayName" : "Item Listelement", 
  "description" : "A single list item.", 
"type":  "string" 
}); 


ItemList.property('itemListOrder', {
  "name" : "itemListOrder", 
  "displayName" : "Item Listorder", 
