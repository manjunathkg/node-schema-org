...
var SkiResort = resource.define('SkiResort'); 

SkiResort.schema.description = "A ski resort."; 
SkiResort.persist('fs'); 


SkiResort.property('additionalType', {
  "name" : "additionalType", 
...
SkiResort.property('description', {
  "name" : "description", 
...
SkiResort.property('aggregateRating', {
...
SkiResort.property('containedIn', {
  "name" : "containedIn", 
...
SkiResort.property('globalLocationNumber', {
...
SkiResort.property('interactionCount', {
...
SkiResort.property('openingHoursSpecification', {
...
SkiResort.property('contactPoint', {
  "name" : "contactPoint", 
...
SkiResort.property('contactPoints', {
  "name" : "contactPoints", 
...
SkiResort.property('foundingDate', {
  "name" : "foundingDate", 
...
SkiResort.property('currenciesAccepted', {
...
SkiResort.property('openingHours', {
  "name" : "openingHours", 
...
SkiResort.property('paymentAccepted', {
