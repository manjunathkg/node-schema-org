...
var LodgingBusiness = resource.define('LodgingBusiness'); 

LodgingBusiness.schema.description = "A lodging business, such as a motel, hotel, or inn."; 
LodgingBusiness.persist('fs'); 


LodgingBusiness.property('additionalType', {
  "name" : "additionalType", 
...
LodgingBusiness.property('description', {
  "name" : "description", 
...
LodgingBusiness.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
LodgingBusiness.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
LodgingBusiness.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
LodgingBusiness.property('aggregateRating', {
...
LodgingBusiness.property('containedIn', {
  "name" : "containedIn", 
...
LodgingBusiness.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
LodgingBusiness.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
LodgingBusiness.property('faxNumber', {
  "name" : "faxNumber", 
...
LodgingBusiness.property('globalLocationNumber', {
...
LodgingBusiness.property('interactionCount', {
...
LodgingBusiness.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
LodgingBusiness.property('openingHoursSpecification', {
...
LodgingBusiness.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
LodgingBusiness.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
LodgingBusiness.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
LodgingBusiness.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
LodgingBusiness.property('telephone', {
  "name" : "telephone", 
...
LodgingBusiness.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
LodgingBusiness.property('contactPoint', {
  "name" : "contactPoint", 
...
LodgingBusiness.property('contactPoints', {
  "name" : "contactPoints", 
...
LodgingBusiness.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
LodgingBusiness.property('employee', {
  "name" : "employee", 
...
LodgingBusiness.property('employees', {
  "name" : "employees", 
...
LodgingBusiness.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
LodgingBusiness.property('founders', {
  "name" : "founders", 
...
LodgingBusiness.property('foundingDate', {
  "name" : "foundingDate", 
...
LodgingBusiness.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
LodgingBusiness.property('legalName', {
  "name" : "legalName", 
...
LodgingBusiness.property('location', {
  "name" : "location", 
...
LodgingBusiness.property('makesOffer', {
  "name" : "makesOffer", 
...
LodgingBusiness.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
LodgingBusiness.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
LodgingBusiness.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
LodgingBusiness.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
LodgingBusiness.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
LodgingBusiness.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
LodgingBusiness.property('branchOf', {
  "name" : "branchOf", 
...
LodgingBusiness.property('currenciesAccepted', {
...
LodgingBusiness.property('openingHours', {
  "name" : "openingHours", 
...
LodgingBusiness.property('paymentAccepted', {
...
LodgingBusiness.property('priceRange', {
  "name" : "priceRange", 
