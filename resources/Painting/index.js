...
var Painting = resource.define('Painting'); 

Painting.schema.description = "A painting."; 
Painting.persist('fs'); 


Painting.property('additionalType', {
  "name" : "additionalType", 
...
Painting.property('accountablePerson', {
...
Painting.property('aggregateRating', {
...
Painting.property('alternativeHeadline', {
...
Painting.property('associatedMedia', {
...
Painting.property('contentLocation', {
...
Painting.property('contentRating', {
  "name" : "contentRating", 
...
Painting.property('copyrightHolder', {
...
Painting.property('copyrightYear', {
  "name" : "copyrightYear", 
...
Painting.property('dateModified', {
  "name" : "dateModified", 
...
Painting.property('datePublished', {
  "name" : "datePublished", 
...
Painting.property('discussionUrl', {
  "name" : "discussionUrl", 
...
Painting.property('educationalAlignment', {
...
Painting.property('educationalUse', {
  "name" : "educationalUse", 
...
Painting.property('interactionCount', {
...
Painting.property('interactivityType', {
...
Painting.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
Painting.property('isFamilyFriendly', {
...
Painting.property('learningResourceType', {
...
Painting.property('publishingPrinciples', {
...
Painting.property('sourceOrganization', {
...
Painting.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
Painting.property('timeRequired', {
  "name" : "timeRequired", 
...
Painting.property('typicalAgeRange', {
