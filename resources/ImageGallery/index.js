...
var ImageGallery = resource.define('ImageGallery'); 

ImageGallery.schema.description = "Web page type: Image gallery page."; 
ImageGallery.persist('fs'); 


ImageGallery.property('additionalType', {
  "name" : "additionalType", 
...
ImageGallery.property('description', {
  "name" : "description", 
...
ImageGallery.property('accountablePerson', {
...
ImageGallery.property('aggregateRating', {
...
ImageGallery.property('alternativeHeadline', {
...
ImageGallery.property('associatedMedia', {
...
ImageGallery.property('audience', {
  "name" : "audience", 
...
ImageGallery.property('citation', {
  "name" : "citation", 
...
ImageGallery.property('contentLocation', {
...
ImageGallery.property('contentRating', {
  "name" : "contentRating", 
...
ImageGallery.property('contributor', {
  "name" : "contributor", 
...
ImageGallery.property('copyrightHolder', {
...
ImageGallery.property('copyrightYear', {
  "name" : "copyrightYear", 
...
ImageGallery.property('dateCreated', {
  "name" : "dateCreated", 
...
ImageGallery.property('dateModified', {
  "name" : "dateModified", 
...
ImageGallery.property('datePublished', {
  "name" : "datePublished", 
...
ImageGallery.property('discussionUrl', {
  "name" : "discussionUrl", 
...
ImageGallery.property('educationalAlignment', {
...
ImageGallery.property('educationalUse', {
  "name" : "educationalUse", 
...
ImageGallery.property('encoding', {
  "name" : "encoding", 
...
ImageGallery.property('encodings', {
  "name" : "encodings", 
...
ImageGallery.property('headline', {
  "name" : "headline", 
...
ImageGallery.property('inLanguage', {
  "name" : "inLanguage", 
...
ImageGallery.property('interactionCount', {
...
ImageGallery.property('interactivityType', {
...
ImageGallery.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
ImageGallery.property('isFamilyFriendly', {
...
ImageGallery.property('keywords', {
  "name" : "keywords", 
...
ImageGallery.property('learningResourceType', {
...
ImageGallery.property('mentions', {
  "name" : "mentions", 
...
ImageGallery.property('provider', {
  "name" : "provider", 
...
ImageGallery.property('publisher', {
  "name" : "publisher", 
...
ImageGallery.property('publishingPrinciples', {
...
ImageGallery.property('sourceOrganization', {
...
ImageGallery.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
ImageGallery.property('timeRequired', {
  "name" : "timeRequired", 
...
ImageGallery.property('typicalAgeRange', {
...
ImageGallery.property('breadcrumb', {
  "name" : "breadcrumb", 
...
ImageGallery.property('isPartOf', {
  "name" : "isPartOf", 
...
ImageGallery.property('lastReviewed', {
  "name" : "lastReviewed", 
...
ImageGallery.property('mainContentOfPage', {
...
ImageGallery.property('primaryImageOfPage', {
...
ImageGallery.property('relatedLink', {
  "name" : "relatedLink", 
...
ImageGallery.property('reviewedBy', {
  "name" : "reviewedBy", 
...
ImageGallery.property('significantLink', {
...
ImageGallery.property('significantLinks', {
...
ImageGallery.property('specialty', {
  "name" : "specialty", 
