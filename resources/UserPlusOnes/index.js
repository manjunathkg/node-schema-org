...
var UserPlusOnes = resource.define('UserPlusOnes'); 

UserPlusOnes.schema.description = "User interaction: +1."; 
UserPlusOnes.persist('fs'); 


UserPlusOnes.property('additionalType', {
  "name" : "additionalType", 
...
UserPlusOnes.property('description', {
  "name" : "description", 
...
UserPlusOnes.property('attendee', {
  "name" : "attendee", 
...
UserPlusOnes.property('attendees', {
  "name" : "attendees", 
...
UserPlusOnes.property('duration', {
  "name" : "duration", 
...
UserPlusOnes.property('location', {
  "name" : "location", 
...
UserPlusOnes.property('performer', {
  "name" : "performer", 
...
UserPlusOnes.property('performers', {
  "name" : "performers", 
...
UserPlusOnes.property('startDate', {
  "name" : "startDate", 
...
UserPlusOnes.property('subEvent', {
  "name" : "subEvent", 
...
UserPlusOnes.property('subEvents', {
  "name" : "subEvents", 
...
UserPlusOnes.property('superEvent', {
  "name" : "superEvent", 
