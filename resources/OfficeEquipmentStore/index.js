...
var OfficeEquipmentStore = resource.define('OfficeEquipmentStore'); 

OfficeEquipmentStore.schema.description = "An office equipment store."; 
OfficeEquipmentStore.persist('fs'); 


OfficeEquipmentStore.property('additionalType', {
  "name" : "additionalType", 
...
OfficeEquipmentStore.property('description', {
  "name" : "description", 
...
OfficeEquipmentStore.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
OfficeEquipmentStore.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
OfficeEquipmentStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
OfficeEquipmentStore.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
OfficeEquipmentStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
OfficeEquipmentStore.property('aggregateRating', {
...
OfficeEquipmentStore.property('containedIn', {
  "name" : "containedIn", 
...
OfficeEquipmentStore.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
OfficeEquipmentStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
OfficeEquipmentStore.property('faxNumber', {
  "name" : "faxNumber", 
...
OfficeEquipmentStore.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
OfficeEquipmentStore.property('globalLocationNumber', {
...
OfficeEquipmentStore.property('interactionCount', {
...
OfficeEquipmentStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
OfficeEquipmentStore.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
OfficeEquipmentStore.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
OfficeEquipmentStore.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
OfficeEquipmentStore.property('openingHoursSpecification', {
...
OfficeEquipmentStore.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
OfficeEquipmentStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
OfficeEquipmentStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
OfficeEquipmentStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
OfficeEquipmentStore.property('telephone', {
  "name" : "telephone", 
...
OfficeEquipmentStore.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
OfficeEquipmentStore.property('contactPoint', {
  "name" : "contactPoint", 
...
OfficeEquipmentStore.property('contactPoints', {
  "name" : "contactPoints", 
...
OfficeEquipmentStore.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
OfficeEquipmentStore.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
OfficeEquipmentStore.property('employee', {
  "name" : "employee", 
...
OfficeEquipmentStore.property('employees', {
  "name" : "employees", 
...
OfficeEquipmentStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
OfficeEquipmentStore.property('founders', {
  "name" : "founders", 
...
OfficeEquipmentStore.property('foundingDate', {
  "name" : "foundingDate", 
...
OfficeEquipmentStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
OfficeEquipmentStore.property('legalName', {
  "name" : "legalName", 
...
OfficeEquipmentStore.property('location', {
  "name" : "location", 
...
OfficeEquipmentStore.property('makesOffer', {
  "name" : "makesOffer", 
...
OfficeEquipmentStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
OfficeEquipmentStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
OfficeEquipmentStore.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
OfficeEquipmentStore.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
OfficeEquipmentStore.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
OfficeEquipmentStore.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
OfficeEquipmentStore.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
OfficeEquipmentStore.property('branchOf', {
  "name" : "branchOf", 
...
OfficeEquipmentStore.property('currenciesAccepted', {
...
OfficeEquipmentStore.property('openingHours', {
  "name" : "openingHours", 
...
OfficeEquipmentStore.property('paymentAccepted', {
...
OfficeEquipmentStore.property('priceRange', {
  "name" : "priceRange", 
