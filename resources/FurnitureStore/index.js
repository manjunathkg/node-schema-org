...
var FurnitureStore = resource.define('FurnitureStore'); 

FurnitureStore.schema.description = "A furniture store."; 
FurnitureStore.persist('fs'); 


FurnitureStore.property('additionalType', {
  "name" : "additionalType", 
...
FurnitureStore.property('description', {
  "name" : "description", 
...
FurnitureStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
FurnitureStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
FurnitureStore.property('aggregateRating', {
...
FurnitureStore.property('containedIn', {
  "name" : "containedIn", 
...
FurnitureStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
FurnitureStore.property('faxNumber', {
  "name" : "faxNumber", 
...
FurnitureStore.property('globalLocationNumber', {
...
FurnitureStore.property('interactionCount', {
...
FurnitureStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
FurnitureStore.property('openingHoursSpecification', {
...
FurnitureStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
FurnitureStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
FurnitureStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
FurnitureStore.property('telephone', {
  "name" : "telephone", 
...
FurnitureStore.property('contactPoint', {
  "name" : "contactPoint", 
...
FurnitureStore.property('contactPoints', {
  "name" : "contactPoints", 
...
FurnitureStore.property('employee', {
  "name" : "employee", 
...
FurnitureStore.property('employees', {
  "name" : "employees", 
...
FurnitureStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
FurnitureStore.property('founders', {
  "name" : "founders", 
...
FurnitureStore.property('foundingDate', {
  "name" : "foundingDate", 
...
FurnitureStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
FurnitureStore.property('legalName', {
  "name" : "legalName", 
...
FurnitureStore.property('location', {
  "name" : "location", 
...
FurnitureStore.property('makesOffer', {
  "name" : "makesOffer", 
...
FurnitureStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
FurnitureStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
FurnitureStore.property('branchOf', {
  "name" : "branchOf", 
...
FurnitureStore.property('currenciesAccepted', {
...
FurnitureStore.property('openingHours', {
  "name" : "openingHours", 
...
FurnitureStore.property('paymentAccepted', {
...
FurnitureStore.property('priceRange', {
  "name" : "priceRange", 
