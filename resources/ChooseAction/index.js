...
var ChooseAction = resource.define('ChooseAction'); 

ChooseAction.schema.description = "The act of expressing a preference from a set of options or a large or unbounded set of choices/options."; 
ChooseAction.persist('fs'); 


ChooseAction.property('additionalType', {
  "name" : "additionalType", 
...
ChooseAction.property('description', {
  "name" : "description", 
...
ChooseAction.property('instrument', {
  "name" : "instrument", 
...
ChooseAction.property('location', {
  "name" : "location", 
...
ChooseAction.property('participant', {
  "name" : "participant", 
...
ChooseAction.property('startTime', {
  "name" : "startTime", 
