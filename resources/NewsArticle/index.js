...
var NewsArticle = resource.define('NewsArticle'); 

NewsArticle.schema.description = "A news article"; 
NewsArticle.persist('fs'); 


NewsArticle.property('additionalType', {
  "name" : "additionalType", 
...
NewsArticle.property('description', {
  "name" : "description", 
...
NewsArticle.property('accountablePerson', {
...
NewsArticle.property('aggregateRating', {
...
NewsArticle.property('alternativeHeadline', {
...
NewsArticle.property('associatedMedia', {
...
NewsArticle.property('contentLocation', {
...
NewsArticle.property('contentRating', {
  "name" : "contentRating", 
...
NewsArticle.property('contributor', {
  "name" : "contributor", 
...
NewsArticle.property('copyrightHolder', {
...
NewsArticle.property('copyrightYear', {
  "name" : "copyrightYear", 
...
NewsArticle.property('dateCreated', {
  "name" : "dateCreated", 
...
NewsArticle.property('dateModified', {
  "name" : "dateModified", 
...
NewsArticle.property('datePublished', {
  "name" : "datePublished", 
...
NewsArticle.property('discussionUrl', {
  "name" : "discussionUrl", 
...
NewsArticle.property('educationalAlignment', {
...
NewsArticle.property('educationalUse', {
  "name" : "educationalUse", 
...
NewsArticle.property('encodings', {
  "name" : "encodings", 
...
NewsArticle.property('inLanguage', {
  "name" : "inLanguage", 
...
NewsArticle.property('interactionCount', {
...
NewsArticle.property('interactivityType', {
...
NewsArticle.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
NewsArticle.property('isFamilyFriendly', {
...
NewsArticle.property('learningResourceType', {
...
NewsArticle.property('publisher', {
  "name" : "publisher", 
...
NewsArticle.property('publishingPrinciples', {
...
NewsArticle.property('sourceOrganization', {
...
NewsArticle.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
NewsArticle.property('timeRequired', {
  "name" : "timeRequired", 
...
NewsArticle.property('typicalAgeRange', {
...
NewsArticle.property('articleBody', {
  "name" : "articleBody", 
...
NewsArticle.property('articleSection', {
  "name" : "articleSection", 
...
NewsArticle.property('wordCount', {
  "name" : "wordCount", 
...
NewsArticle.property('printSection', {
  "name" : "printSection", 
  "displayName" : "Print Section", 
