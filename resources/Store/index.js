...
var Store = resource.define('Store'); 

Store.schema.description = "A retail good store."; 
Store.persist('fs'); 


Store.property('additionalType', {
  "name" : "additionalType", 
...
Store.property('aggregateRating', {
...
Store.property('globalLocationNumber', {
...
Store.property('interactionCount', {
...
Store.property('openingHoursSpecification', {
...
Store.property('currenciesAccepted', {
...
Store.property('paymentAccepted', {
