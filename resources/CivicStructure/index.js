...
var CivicStructure = resource.define('CivicStructure'); 

CivicStructure.schema.description = "A public structure, such as a town hall or concert hall."; 
CivicStructure.persist('fs'); 


CivicStructure.property('additionalType', {
  "name" : "additionalType", 
...
CivicStructure.property('description', {
  "name" : "description", 
...
CivicStructure.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
CivicStructure.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
CivicStructure.property('aggregateRating', {
...
CivicStructure.property('containedIn', {
  "name" : "containedIn", 
...
CivicStructure.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
CivicStructure.property('faxNumber', {
  "name" : "faxNumber", 
...
CivicStructure.property('globalLocationNumber', {
...
CivicStructure.property('interactionCount', {
...
CivicStructure.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
CivicStructure.property('openingHoursSpecification', {
...
CivicStructure.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
CivicStructure.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
CivicStructure.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
CivicStructure.property('telephone', {
  "name" : "telephone", 
...
CivicStructure.property('openingHours', {
  "name" : "openingHours", 
