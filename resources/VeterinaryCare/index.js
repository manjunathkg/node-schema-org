...
var VeterinaryCare = resource.define('VeterinaryCare'); 

VeterinaryCare.schema.description = "A vet&#x27;s office."; 
VeterinaryCare.persist('fs'); 


VeterinaryCare.property('additionalType', {
  "name" : "additionalType", 
...
VeterinaryCare.property('description', {
  "name" : "description", 
...
VeterinaryCare.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
VeterinaryCare.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
VeterinaryCare.property('aggregateRating', {
...
VeterinaryCare.property('containedIn', {
  "name" : "containedIn", 
...
VeterinaryCare.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
VeterinaryCare.property('faxNumber', {
  "name" : "faxNumber", 
...
VeterinaryCare.property('globalLocationNumber', {
...
VeterinaryCare.property('interactionCount', {
...
VeterinaryCare.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
VeterinaryCare.property('openingHoursSpecification', {
...
VeterinaryCare.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
VeterinaryCare.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
VeterinaryCare.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
VeterinaryCare.property('telephone', {
  "name" : "telephone", 
...
VeterinaryCare.property('contactPoint', {
  "name" : "contactPoint", 
...
VeterinaryCare.property('contactPoints', {
  "name" : "contactPoints", 
...
VeterinaryCare.property('employee', {
  "name" : "employee", 
...
VeterinaryCare.property('employees', {
  "name" : "employees", 
...
VeterinaryCare.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
VeterinaryCare.property('founders', {
  "name" : "founders", 
...
VeterinaryCare.property('foundingDate', {
  "name" : "foundingDate", 
...
VeterinaryCare.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
VeterinaryCare.property('legalName', {
  "name" : "legalName", 
...
VeterinaryCare.property('location', {
  "name" : "location", 
...
VeterinaryCare.property('makesOffer', {
  "name" : "makesOffer", 
...
VeterinaryCare.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
VeterinaryCare.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
VeterinaryCare.property('branchOf', {
  "name" : "branchOf", 
...
VeterinaryCare.property('currenciesAccepted', {
...
VeterinaryCare.property('openingHours', {
  "name" : "openingHours", 
...
VeterinaryCare.property('paymentAccepted', {
...
VeterinaryCare.property('priceRange', {
  "name" : "priceRange", 
