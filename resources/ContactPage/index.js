...
var ContactPage = resource.define('ContactPage'); 

ContactPage.schema.description = "Web page type: Contact page."; 
ContactPage.persist('fs'); 


ContactPage.property('additionalType', {
  "name" : "additionalType", 
...
ContactPage.property('description', {
  "name" : "description", 
...
ContactPage.property('accountablePerson', {
...
ContactPage.property('aggregateRating', {
...
ContactPage.property('alternativeHeadline', {
...
ContactPage.property('associatedMedia', {
...
ContactPage.property('contentLocation', {
...
ContactPage.property('contentRating', {
  "name" : "contentRating", 
...
ContactPage.property('contributor', {
  "name" : "contributor", 
...
ContactPage.property('copyrightHolder', {
...
ContactPage.property('copyrightYear', {
  "name" : "copyrightYear", 
...
ContactPage.property('dateCreated', {
  "name" : "dateCreated", 
...
ContactPage.property('dateModified', {
  "name" : "dateModified", 
...
ContactPage.property('datePublished', {
  "name" : "datePublished", 
...
ContactPage.property('discussionUrl', {
  "name" : "discussionUrl", 
...
ContactPage.property('educationalAlignment', {
...
ContactPage.property('educationalUse', {
  "name" : "educationalUse", 
...
ContactPage.property('encodings', {
  "name" : "encodings", 
...
ContactPage.property('inLanguage', {
  "name" : "inLanguage", 
...
ContactPage.property('interactionCount', {
...
ContactPage.property('interactivityType', {
...
ContactPage.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
ContactPage.property('isFamilyFriendly', {
...
ContactPage.property('learningResourceType', {
...
ContactPage.property('publisher', {
  "name" : "publisher", 
...
ContactPage.property('publishingPrinciples', {
...
ContactPage.property('sourceOrganization', {
...
ContactPage.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
ContactPage.property('timeRequired', {
  "name" : "timeRequired", 
...
ContactPage.property('typicalAgeRange', {
...
ContactPage.property('breadcrumb', {
  "name" : "breadcrumb", 
...
ContactPage.property('lastReviewed', {
  "name" : "lastReviewed", 
...
ContactPage.property('mainContentOfPage', {
...
ContactPage.property('primaryImageOfPage', {
...
ContactPage.property('relatedLink', {
  "name" : "relatedLink", 
...
ContactPage.property('reviewedBy', {
  "name" : "reviewedBy", 
...
ContactPage.property('significantLink', {
...
ContactPage.property('significantLinks', {
...
ContactPage.property('specialty', {
  "name" : "specialty", 
