...
var StadiumOrArena = resource.define('StadiumOrArena'); 

StadiumOrArena.schema.description = "A stadium."; 
StadiumOrArena.persist('fs'); 


StadiumOrArena.property('additionalType', {
  "name" : "additionalType", 
...
StadiumOrArena.property('description', {
  "name" : "description", 
...
StadiumOrArena.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
StadiumOrArena.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
StadiumOrArena.property('aggregateRating', {
...
StadiumOrArena.property('containedIn', {
  "name" : "containedIn", 
...
StadiumOrArena.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
StadiumOrArena.property('faxNumber', {
  "name" : "faxNumber", 
...
StadiumOrArena.property('globalLocationNumber', {
...
StadiumOrArena.property('interactionCount', {
...
StadiumOrArena.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
StadiumOrArena.property('openingHoursSpecification', {
...
StadiumOrArena.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
StadiumOrArena.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
StadiumOrArena.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
StadiumOrArena.property('telephone', {
  "name" : "telephone", 
...
StadiumOrArena.property('contactPoint', {
  "name" : "contactPoint", 
...
StadiumOrArena.property('contactPoints', {
  "name" : "contactPoints", 
...
StadiumOrArena.property('employee', {
  "name" : "employee", 
...
StadiumOrArena.property('employees', {
  "name" : "employees", 
...
StadiumOrArena.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
StadiumOrArena.property('founders', {
  "name" : "founders", 
...
StadiumOrArena.property('foundingDate', {
  "name" : "foundingDate", 
...
StadiumOrArena.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
StadiumOrArena.property('legalName', {
  "name" : "legalName", 
...
StadiumOrArena.property('location', {
  "name" : "location", 
...
StadiumOrArena.property('makesOffer', {
  "name" : "makesOffer", 
...
StadiumOrArena.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
StadiumOrArena.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
StadiumOrArena.property('branchOf', {
  "name" : "branchOf", 
...
StadiumOrArena.property('currenciesAccepted', {
...
StadiumOrArena.property('openingHours', {
  "name" : "openingHours", 
...
StadiumOrArena.property('paymentAccepted', {
...
StadiumOrArena.property('priceRange', {
  "name" : "priceRange", 
