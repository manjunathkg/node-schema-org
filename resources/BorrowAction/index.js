...
var BorrowAction = resource.define('BorrowAction'); 

BorrowAction.schema.description = "The act of obtaining an object under an agreement to return it at a later date. Reciprocal of LendAction.Related actions:LendAction: Reciprocal of BorrowAction."; 
BorrowAction.persist('fs'); 


BorrowAction.property('additionalType', {
  "name" : "additionalType", 
...
BorrowAction.property('description', {
  "name" : "description", 
...
BorrowAction.property('instrument', {
  "name" : "instrument", 
...
BorrowAction.property('location', {
  "name" : "location", 
...
BorrowAction.property('participant', {
  "name" : "participant", 
...
BorrowAction.property('startTime', {
  "name" : "startTime", 
...
BorrowAction.property('fromLocation', {
  "name" : "fromLocation", 
...
BorrowAction.property('toLocation', {
  "name" : "toLocation", 
