...
var GovernmentBuilding = resource.define('GovernmentBuilding'); 

GovernmentBuilding.schema.description = "A government building."; 
GovernmentBuilding.persist('fs'); 


GovernmentBuilding.property('additionalType', {
  "name" : "additionalType", 
...
GovernmentBuilding.property('description', {
  "name" : "description", 
...
GovernmentBuilding.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
GovernmentBuilding.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
GovernmentBuilding.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
GovernmentBuilding.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
GovernmentBuilding.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
GovernmentBuilding.property('aggregateRating', {
...
GovernmentBuilding.property('containedIn', {
  "name" : "containedIn", 
...
GovernmentBuilding.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
GovernmentBuilding.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
GovernmentBuilding.property('faxNumber', {
  "name" : "faxNumber", 
...
GovernmentBuilding.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
GovernmentBuilding.property('globalLocationNumber', {
...
GovernmentBuilding.property('interactionCount', {
...
GovernmentBuilding.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
GovernmentBuilding.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
GovernmentBuilding.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
GovernmentBuilding.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
GovernmentBuilding.property('openingHoursSpecification', {
...
GovernmentBuilding.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
GovernmentBuilding.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
GovernmentBuilding.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
GovernmentBuilding.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
GovernmentBuilding.property('telephone', {
  "name" : "telephone", 
...
GovernmentBuilding.property('openingHours', {
  "name" : "openingHours", 
