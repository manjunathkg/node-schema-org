...
var TravelAction = resource.define('TravelAction'); 

TravelAction.schema.description = "The act of traveling from an fromLocation to a destination by a specified mode of transport, optionally with participants."; 
TravelAction.persist('fs'); 


TravelAction.property('additionalType', {
  "name" : "additionalType", 
...
TravelAction.property('description', {
  "name" : "description", 
...
TravelAction.property('instrument', {
  "name" : "instrument", 
...
TravelAction.property('location', {
  "name" : "location", 
...
TravelAction.property('participant', {
  "name" : "participant", 
...
TravelAction.property('startTime', {
  "name" : "startTime", 
...
TravelAction.property('fromLocation', {
  "name" : "fromLocation", 
...
TravelAction.property('toLocation', {
  "name" : "toLocation", 
...
TravelAction.property('distance', {
  "name" : "distance", 
