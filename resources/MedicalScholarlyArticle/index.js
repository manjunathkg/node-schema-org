...
var MedicalScholarlyArticle = resource.define('MedicalScholarlyArticle'); 

MedicalScholarlyArticle.schema.description = "A scholarly article in the medical domain."; 
MedicalScholarlyArticle.persist('fs'); 


MedicalScholarlyArticle.property('additionalType', {
  "name" : "additionalType", 
...
MedicalScholarlyArticle.property('description', {
  "name" : "description", 
...
MedicalScholarlyArticle.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MedicalScholarlyArticle.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MedicalScholarlyArticle.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MedicalScholarlyArticle.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
MedicalScholarlyArticle.property('about', {
  "name" : "about", 
  "displayName" : "About", 
...
MedicalScholarlyArticle.property('accountablePerson', {
...
MedicalScholarlyArticle.property('aggregateRating', {
...
MedicalScholarlyArticle.property('alternativeHeadline', {
...
MedicalScholarlyArticle.property('associatedMedia', {
...
MedicalScholarlyArticle.property('audience', {
  "name" : "audience", 
...
MedicalScholarlyArticle.property('audio', {
  "name" : "audio", 
  "displayName" : "Audio", 
...
MedicalScholarlyArticle.property('author', {
  "name" : "author", 
  "displayName" : "Author", 
...
MedicalScholarlyArticle.property('award', {
  "name" : "award", 
  "displayName" : "Award", 
...
MedicalScholarlyArticle.property('awards', {
  "name" : "awards", 
  "displayName" : "Awards", 
...
MedicalScholarlyArticle.property('citation', {
  "name" : "citation", 
...
MedicalScholarlyArticle.property('comment', {
  "name" : "comment", 
  "displayName" : "Comment", 
...
MedicalScholarlyArticle.property('contentLocation', {
...
MedicalScholarlyArticle.property('contentRating', {
  "name" : "contentRating", 
...
MedicalScholarlyArticle.property('contributor', {
  "name" : "contributor", 
...
MedicalScholarlyArticle.property('copyrightHolder', {
...
MedicalScholarlyArticle.property('copyrightYear', {
  "name" : "copyrightYear", 
...
MedicalScholarlyArticle.property('creator', {
  "name" : "creator", 
  "displayName" : "Creator", 
...
MedicalScholarlyArticle.property('dateCreated', {
  "name" : "dateCreated", 
...
MedicalScholarlyArticle.property('dateModified', {
  "name" : "dateModified", 
...
MedicalScholarlyArticle.property('datePublished', {
  "name" : "datePublished", 
...
MedicalScholarlyArticle.property('discussionUrl', {
  "name" : "discussionUrl", 
...
MedicalScholarlyArticle.property('editor', {
  "name" : "editor", 
  "displayName" : "Editor", 
...
MedicalScholarlyArticle.property('educationalAlignment', {
...
MedicalScholarlyArticle.property('educationalUse', {
  "name" : "educationalUse", 
...
MedicalScholarlyArticle.property('encoding', {
  "name" : "encoding", 
...
MedicalScholarlyArticle.property('encodings', {
  "name" : "encodings", 
...
MedicalScholarlyArticle.property('genre', {
  "name" : "genre", 
  "displayName" : "Genre", 
...
MedicalScholarlyArticle.property('headline', {
  "name" : "headline", 
...
MedicalScholarlyArticle.property('inLanguage', {
  "name" : "inLanguage", 
...
MedicalScholarlyArticle.property('interactionCount', {
...
MedicalScholarlyArticle.property('interactivityType', {
...
MedicalScholarlyArticle.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
MedicalScholarlyArticle.property('isFamilyFriendly', {
...
MedicalScholarlyArticle.property('keywords', {
  "name" : "keywords", 
...
MedicalScholarlyArticle.property('learningResourceType', {
...
MedicalScholarlyArticle.property('mentions', {
  "name" : "mentions", 
...
MedicalScholarlyArticle.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
MedicalScholarlyArticle.property('provider', {
  "name" : "provider", 
...
MedicalScholarlyArticle.property('publisher', {
  "name" : "publisher", 
...
MedicalScholarlyArticle.property('publishingPrinciples', {
...
MedicalScholarlyArticle.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MedicalScholarlyArticle.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MedicalScholarlyArticle.property('sourceOrganization', {
...
MedicalScholarlyArticle.property('text', {
  "name" : "text", 
  "displayName" : "Text", 
...
MedicalScholarlyArticle.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
MedicalScholarlyArticle.property('timeRequired', {
  "name" : "timeRequired", 
...
MedicalScholarlyArticle.property('typicalAgeRange', {
...
MedicalScholarlyArticle.property('version', {
  "name" : "version", 
  "displayName" : "Version", 
...
MedicalScholarlyArticle.property('video', {
  "name" : "video", 
  "displayName" : "Video", 
...
MedicalScholarlyArticle.property('articleBody', {
  "name" : "articleBody", 
...
MedicalScholarlyArticle.property('articleSection', {
  "name" : "articleSection", 
...
MedicalScholarlyArticle.property('wordCount', {
  "name" : "wordCount", 
...
MedicalScholarlyArticle.property('publicationType', {
