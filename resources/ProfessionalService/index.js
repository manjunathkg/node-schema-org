...
var ProfessionalService = resource.define('ProfessionalService'); 

ProfessionalService.schema.description = "Provider of professional services."; 
ProfessionalService.persist('fs'); 


ProfessionalService.property('additionalType', {
  "name" : "additionalType", 
...
ProfessionalService.property('description', {
  "name" : "description", 
...
ProfessionalService.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
ProfessionalService.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
ProfessionalService.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ProfessionalService.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
ProfessionalService.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
ProfessionalService.property('aggregateRating', {
...
ProfessionalService.property('containedIn', {
  "name" : "containedIn", 
...
ProfessionalService.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
ProfessionalService.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
ProfessionalService.property('faxNumber', {
  "name" : "faxNumber", 
...
ProfessionalService.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
ProfessionalService.property('globalLocationNumber', {
...
ProfessionalService.property('interactionCount', {
...
ProfessionalService.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
ProfessionalService.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
ProfessionalService.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
ProfessionalService.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
ProfessionalService.property('openingHoursSpecification', {
...
ProfessionalService.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
ProfessionalService.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
ProfessionalService.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
ProfessionalService.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
ProfessionalService.property('telephone', {
  "name" : "telephone", 
...
ProfessionalService.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
ProfessionalService.property('contactPoint', {
  "name" : "contactPoint", 
...
ProfessionalService.property('contactPoints', {
  "name" : "contactPoints", 
...
ProfessionalService.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
ProfessionalService.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
ProfessionalService.property('employee', {
  "name" : "employee", 
...
ProfessionalService.property('employees', {
  "name" : "employees", 
...
ProfessionalService.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
ProfessionalService.property('founders', {
  "name" : "founders", 
...
ProfessionalService.property('foundingDate', {
  "name" : "foundingDate", 
...
ProfessionalService.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
ProfessionalService.property('legalName', {
  "name" : "legalName", 
...
ProfessionalService.property('location', {
  "name" : "location", 
...
ProfessionalService.property('makesOffer', {
  "name" : "makesOffer", 
...
ProfessionalService.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
ProfessionalService.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
ProfessionalService.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
ProfessionalService.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
ProfessionalService.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
ProfessionalService.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
ProfessionalService.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
ProfessionalService.property('branchOf', {
  "name" : "branchOf", 
...
ProfessionalService.property('currenciesAccepted', {
...
ProfessionalService.property('openingHours', {
  "name" : "openingHours", 
...
ProfessionalService.property('paymentAccepted', {
...
ProfessionalService.property('priceRange', {
  "name" : "priceRange", 
