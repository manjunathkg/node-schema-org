...
var InsuranceAgency = resource.define('InsuranceAgency'); 

InsuranceAgency.schema.description = "Insurance agency."; 
InsuranceAgency.persist('fs'); 


InsuranceAgency.property('additionalType', {
  "name" : "additionalType", 
...
InsuranceAgency.property('description', {
  "name" : "description", 
...
InsuranceAgency.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
InsuranceAgency.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
InsuranceAgency.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
InsuranceAgency.property('aggregateRating', {
...
InsuranceAgency.property('containedIn', {
  "name" : "containedIn", 
...
InsuranceAgency.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
InsuranceAgency.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
InsuranceAgency.property('faxNumber', {
  "name" : "faxNumber", 
...
InsuranceAgency.property('globalLocationNumber', {
...
InsuranceAgency.property('interactionCount', {
...
InsuranceAgency.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
InsuranceAgency.property('openingHoursSpecification', {
...
InsuranceAgency.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
InsuranceAgency.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
InsuranceAgency.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
InsuranceAgency.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
InsuranceAgency.property('telephone', {
  "name" : "telephone", 
...
InsuranceAgency.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
InsuranceAgency.property('contactPoint', {
  "name" : "contactPoint", 
...
InsuranceAgency.property('contactPoints', {
  "name" : "contactPoints", 
...
InsuranceAgency.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
InsuranceAgency.property('employee', {
  "name" : "employee", 
...
InsuranceAgency.property('employees', {
  "name" : "employees", 
...
InsuranceAgency.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
InsuranceAgency.property('founders', {
  "name" : "founders", 
...
InsuranceAgency.property('foundingDate', {
  "name" : "foundingDate", 
...
InsuranceAgency.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
InsuranceAgency.property('legalName', {
  "name" : "legalName", 
...
InsuranceAgency.property('location', {
  "name" : "location", 
...
InsuranceAgency.property('makesOffer', {
  "name" : "makesOffer", 
...
InsuranceAgency.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
InsuranceAgency.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
InsuranceAgency.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
InsuranceAgency.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
InsuranceAgency.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
InsuranceAgency.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
InsuranceAgency.property('branchOf', {
  "name" : "branchOf", 
...
InsuranceAgency.property('currenciesAccepted', {
...
InsuranceAgency.property('openingHours', {
  "name" : "openingHours", 
...
InsuranceAgency.property('paymentAccepted', {
...
InsuranceAgency.property('priceRange', {
  "name" : "priceRange", 
