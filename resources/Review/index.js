...
var Review = resource.define('Review'); 

Review.schema.description = "A review of an item - for example, a restaurant, movie, or store."; 
Review.persist('fs'); 


Review.property('additionalType', {
  "name" : "additionalType", 
...
Review.property('accountablePerson', {
...
Review.property('aggregateRating', {
...
Review.property('alternativeHeadline', {
...
Review.property('associatedMedia', {
...
Review.property('contentLocation', {
...
Review.property('copyrightHolder', {
...
Review.property('educationalAlignment', {
...
Review.property('educationalUse', {
  "name" : "educationalUse", 
...
Review.property('interactionCount', {
...
Review.property('interactivityType', {
...
Review.property('isFamilyFriendly', {
...
Review.property('learningResourceType', {
...
Review.property('publishingPrinciples', {
...
Review.property('sourceOrganization', {
...
Review.property('typicalAgeRange', {
...
"type":"object","properties" : {"Rating" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 
