...
var Cemetery = resource.define('Cemetery'); 

Cemetery.schema.description = "A graveyard."; 
Cemetery.persist('fs'); 


Cemetery.property('additionalType', {
  "name" : "additionalType", 
...
Cemetery.property('aggregateRating', {
...
Cemetery.property('globalLocationNumber', {
...
Cemetery.property('interactionCount', {
...
Cemetery.property('openingHoursSpecification', {
...
Cemetery.property('openingHours', {
  "name" : "openingHours", 
