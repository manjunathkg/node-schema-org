...
var State = resource.define('State'); 

State.schema.description = "A state or province."; 
State.persist('fs'); 


State.property('additionalType', {
  "name" : "additionalType", 
...
State.property('aggregateRating', {
...
State.property('globalLocationNumber', {
...
State.property('interactionCount', {
...
State.property('openingHoursSpecification', {
