...
var Crematorium = resource.define('Crematorium'); 

Crematorium.schema.description = "A crematorium."; 
Crematorium.persist('fs'); 


Crematorium.property('additionalType', {
  "name" : "additionalType", 
...
Crematorium.property('description', {
  "name" : "description", 
...
Crematorium.property('aggregateRating', {
...
Crematorium.property('containedIn', {
  "name" : "containedIn", 
...
Crematorium.property('faxNumber', {
  "name" : "faxNumber", 
...
Crematorium.property('globalLocationNumber', {
...
Crematorium.property('interactionCount', {
...
Crematorium.property('openingHoursSpecification', {
...
Crematorium.property('telephone', {
  "name" : "telephone", 
...
Crematorium.property('openingHours', {
  "name" : "openingHours", 
