...
var Vessel = resource.define('Vessel'); 

Vessel.schema.description = "A component of the human body circulatory system comprised of an intricate network of hollow tubes that transport blood throughout the entire body."; 
Vessel.persist('fs'); 


Vessel.property('additionalType', {
  "name" : "additionalType", 
...
Vessel.property('medicineSystem', {
  "name" : "medicineSystem", 
...
Vessel.property('recognizingAuthority', {
...
Vessel.property('relevantSpecialty', {
...
Vessel.property('associatedPathophysiology', {
...
Vessel.property('relatedCondition', {
...
Vessel.property('relatedTherapy', {
  "name" : "relatedTherapy", 
