...
var Country = resource.define('Country'); 

Country.schema.description = "A country."; 
Country.persist('fs'); 


Country.property('additionalType', {
  "name" : "additionalType", 
...
Country.property('aggregateRating', {
...
Country.property('globalLocationNumber', {
...
Country.property('interactionCount', {
...
Country.property('openingHoursSpecification', {
