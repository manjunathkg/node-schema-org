...
var OutletStore = resource.define('OutletStore'); 

OutletStore.schema.description = "An outlet store."; 
OutletStore.persist('fs'); 


OutletStore.property('additionalType', {
  "name" : "additionalType", 
...
OutletStore.property('description', {
  "name" : "description", 
...
OutletStore.property('aggregateRating', {
...
OutletStore.property('containedIn', {
  "name" : "containedIn", 
...
OutletStore.property('faxNumber', {
  "name" : "faxNumber", 
...
OutletStore.property('globalLocationNumber', {
...
OutletStore.property('interactionCount', {
...
OutletStore.property('openingHoursSpecification', {
...
OutletStore.property('telephone', {
  "name" : "telephone", 
...
OutletStore.property('contactPoint', {
  "name" : "contactPoint", 
...
OutletStore.property('contactPoints', {
  "name" : "contactPoints", 
...
OutletStore.property('employees', {
  "name" : "employees", 
...
OutletStore.property('foundingDate', {
  "name" : "foundingDate", 
...
OutletStore.property('legalName', {
  "name" : "legalName", 
...
OutletStore.property('makesOffer', {
  "name" : "makesOffer", 
...
OutletStore.property('currenciesAccepted', {
...
OutletStore.property('openingHours', {
  "name" : "openingHours", 
...
OutletStore.property('paymentAccepted', {
...
OutletStore.property('priceRange', {
  "name" : "priceRange", 
