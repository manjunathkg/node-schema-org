...
var MusicVenue = resource.define('MusicVenue'); 

MusicVenue.schema.description = "A music venue."; 
MusicVenue.persist('fs'); 


MusicVenue.property('additionalType', {
  "name" : "additionalType", 
...
MusicVenue.property('description', {
  "name" : "description", 
...
MusicVenue.property('aggregateRating', {
...
MusicVenue.property('containedIn', {
  "name" : "containedIn", 
...
MusicVenue.property('globalLocationNumber', {
...
MusicVenue.property('interactionCount', {
...
MusicVenue.property('openingHoursSpecification', {
...
MusicVenue.property('openingHours', {
  "name" : "openingHours", 
