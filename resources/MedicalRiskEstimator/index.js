...
MedicalRiskEstimator.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MedicalRiskEstimator.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MedicalRiskEstimator.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
MedicalRiskEstimator.property('alternateName', {
  "name" : "alternateName", 
...
MedicalRiskEstimator.property('code', {
  "name" : "code", 
  "displayName" : "Code", 
...
MedicalRiskEstimator.property('guideline', {
  "name" : "guideline", 
...
MedicalRiskEstimator.property('medicineSystem', {
  "name" : "medicineSystem", 
...
MedicalRiskEstimator.property('recognizingAuthority', {
...
MedicalRiskEstimator.property('relevantSpecialty', {
...
MedicalRiskEstimator.property('study', {
  "name" : "study", 
  "displayName" : "Study", 
...
MedicalRiskEstimator.property('estimatesRiskOf', {
...
MedicalRiskEstimator.property('includedRiskFactor', {
