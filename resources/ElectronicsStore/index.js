...
var ElectronicsStore = resource.define('ElectronicsStore'); 

ElectronicsStore.schema.description = "An electronics store."; 
ElectronicsStore.persist('fs'); 


ElectronicsStore.property('additionalType', {
  "name" : "additionalType", 
...
ElectronicsStore.property('description', {
  "name" : "description", 
...
ElectronicsStore.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
ElectronicsStore.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
ElectronicsStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ElectronicsStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
ElectronicsStore.property('aggregateRating', {
...
ElectronicsStore.property('containedIn', {
  "name" : "containedIn", 
...
ElectronicsStore.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
ElectronicsStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
ElectronicsStore.property('faxNumber', {
  "name" : "faxNumber", 
...
ElectronicsStore.property('globalLocationNumber', {
...
ElectronicsStore.property('interactionCount', {
...
ElectronicsStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
ElectronicsStore.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
ElectronicsStore.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
ElectronicsStore.property('openingHoursSpecification', {
...
ElectronicsStore.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
ElectronicsStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
ElectronicsStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
ElectronicsStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
ElectronicsStore.property('telephone', {
  "name" : "telephone", 
...
ElectronicsStore.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
ElectronicsStore.property('contactPoint', {
  "name" : "contactPoint", 
...
ElectronicsStore.property('contactPoints', {
  "name" : "contactPoints", 
...
ElectronicsStore.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
ElectronicsStore.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
ElectronicsStore.property('employee', {
  "name" : "employee", 
...
ElectronicsStore.property('employees', {
  "name" : "employees", 
...
ElectronicsStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
ElectronicsStore.property('founders', {
  "name" : "founders", 
...
ElectronicsStore.property('foundingDate', {
  "name" : "foundingDate", 
...
ElectronicsStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
ElectronicsStore.property('legalName', {
  "name" : "legalName", 
...
ElectronicsStore.property('location', {
  "name" : "location", 
...
ElectronicsStore.property('makesOffer', {
  "name" : "makesOffer", 
...
ElectronicsStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
ElectronicsStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
ElectronicsStore.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
ElectronicsStore.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
ElectronicsStore.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
ElectronicsStore.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
ElectronicsStore.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
ElectronicsStore.property('branchOf', {
  "name" : "branchOf", 
...
ElectronicsStore.property('currenciesAccepted', {
...
ElectronicsStore.property('openingHours', {
  "name" : "openingHours", 
...
ElectronicsStore.property('paymentAccepted', {
...
ElectronicsStore.property('priceRange', {
  "name" : "priceRange", 
