...
var School = resource.define('School'); 

School.schema.description = "A school."; 
School.persist('fs'); 


School.property('additionalType', {
  "name" : "additionalType", 
...
School.property('aggregateRating', {
...
School.property('globalLocationNumber', {
...
School.property('interactionCount', {
