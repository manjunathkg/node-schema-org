...
var DaySpa = resource.define('DaySpa'); 

DaySpa.schema.description = "A day spa."; 
DaySpa.persist('fs'); 


DaySpa.property('additionalType', {
  "name" : "additionalType", 
...
DaySpa.property('aggregateRating', {
...
DaySpa.property('globalLocationNumber', {
...
DaySpa.property('interactionCount', {
...
DaySpa.property('openingHoursSpecification', {
...
DaySpa.property('currenciesAccepted', {
...
DaySpa.property('paymentAccepted', {
