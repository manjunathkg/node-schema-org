...
var ExercisePlan = resource.define('ExercisePlan'); 

ExercisePlan.schema.description = "Fitness-related activity designed for a specific health-related purpose, including defined exercise routines as well as activity prescribed by a clinician."; 
ExercisePlan.persist('fs'); 


ExercisePlan.property('additionalType', {
  "name" : "additionalType", 
...
ExercisePlan.property('description', {
  "name" : "description", 
...
ExercisePlan.property('alternateName', {
  "name" : "alternateName", 
...
ExercisePlan.property('guideline', {
  "name" : "guideline", 
...
ExercisePlan.property('medicineSystem', {
  "name" : "medicineSystem", 
...
ExercisePlan.property('recognizingAuthority', {
...
ExercisePlan.property('relevantSpecialty', {
...
ExercisePlan.property('adverseOutcome', {
  "name" : "adverseOutcome", 
...
ExercisePlan.property('contraindication', {
...
ExercisePlan.property('duplicateTherapy', {
...
ExercisePlan.property('indication', {
  "name" : "indication", 
...
ExercisePlan.property('seriousAdverseOutcome', {
...
ExercisePlan.property('associatedAnatomy', {
...
ExercisePlan.property('category', {
  "name" : "category", 
...
ExercisePlan.property('epidemiology', {
  "name" : "epidemiology", 
...
ExercisePlan.property('pathophysiology', {
...
ExercisePlan.property('accountablePerson', {
...
ExercisePlan.property('aggregateRating', {
...
ExercisePlan.property('alternativeHeadline', {
...
ExercisePlan.property('associatedMedia', {
...
ExercisePlan.property('audience', {
  "name" : "audience", 
...
ExercisePlan.property('citation', {
  "name" : "citation", 
...
ExercisePlan.property('contentLocation', {
...
ExercisePlan.property('contentRating', {
  "name" : "contentRating", 
...
ExercisePlan.property('contributor', {
  "name" : "contributor", 
...
ExercisePlan.property('copyrightHolder', {
...
ExercisePlan.property('copyrightYear', {
  "name" : "copyrightYear", 
...
ExercisePlan.property('dateCreated', {
  "name" : "dateCreated", 
...
ExercisePlan.property('dateModified', {
  "name" : "dateModified", 
...
ExercisePlan.property('datePublished', {
  "name" : "datePublished", 
...
ExercisePlan.property('discussionUrl', {
  "name" : "discussionUrl", 
...
ExercisePlan.property('educationalAlignment', {
...
ExercisePlan.property('educationalUse', {
  "name" : "educationalUse", 
...
ExercisePlan.property('encoding', {
  "name" : "encoding", 
...
ExercisePlan.property('encodings', {
  "name" : "encodings", 
...
ExercisePlan.property('headline', {
  "name" : "headline", 
...
ExercisePlan.property('inLanguage', {
  "name" : "inLanguage", 
...
ExercisePlan.property('interactionCount', {
...
ExercisePlan.property('interactivityType', {
...
ExercisePlan.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
ExercisePlan.property('isFamilyFriendly', {
...
ExercisePlan.property('keywords', {
  "name" : "keywords", 
...
ExercisePlan.property('learningResourceType', {
...
ExercisePlan.property('mentions', {
  "name" : "mentions", 
...
ExercisePlan.property('provider', {
  "name" : "provider", 
...
ExercisePlan.property('publisher', {
  "name" : "publisher", 
...
ExercisePlan.property('publishingPrinciples', {
...
ExercisePlan.property('sourceOrganization', {
...
ExercisePlan.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
ExercisePlan.property('timeRequired', {
  "name" : "timeRequired", 
...
ExercisePlan.property('typicalAgeRange', {
...
ExercisePlan.property('activityDuration', {
...
ExercisePlan.property('activityFrequency', {
  "name" : "activityFrequency", 
  "displayName" : "Activity Frequency", 
  "description" : "How often one should engage in the activity.", 
"type":  "string" 
}); 


ExercisePlan.property('additionalVariable', {
  "name" : "additionalVariable", 
  "displayName" : "Additional Variable", 
...
ExercisePlan.property('exerciseType', {
  "name" : "exerciseType", 
...
ExercisePlan.property('intensity', {
  "name" : "intensity", 
...
ExercisePlan.property('repetitions', {
  "name" : "repetitions", 
...
ExercisePlan.property('restPeriods', {
  "name" : "restPeriods", 
...
ExercisePlan.property('workload', {
  "name" : "workload", 
