...
var Volcano = resource.define('Volcano'); 

Volcano.schema.description = "A volcano, like Fuji san"; 
Volcano.persist('fs'); 


Volcano.property('additionalType', {
  "name" : "additionalType", 
...
Volcano.property('aggregateRating', {
...
Volcano.property('globalLocationNumber', {
...
Volcano.property('interactionCount', {
...
Volcano.property('openingHoursSpecification', {
