...
var Church = resource.define('Church'); 

Church.schema.description = "A church."; 
Church.persist('fs'); 


Church.property('additionalType', {
  "name" : "additionalType", 
...
Church.property('aggregateRating', {
...
Church.property('globalLocationNumber', {
...
Church.property('interactionCount', {
...
Church.property('openingHoursSpecification', {
