...
var Comment = resource.define('Comment'); 

Comment.schema.description = "A comment on an item - for example, a comment on a blog post. The comment&#x27;s content is expressed via the &quot;text&quot; property, and its topic via &quot;about&quot;, properties shared with all CreativeWorks."; 
Comment.persist('fs'); 


Comment.property('additionalType', {
  "name" : "additionalType", 
...
Comment.property('accountablePerson', {
...
Comment.property('aggregateRating', {
...
Comment.property('alternativeHeadline', {
...
Comment.property('associatedMedia', {
...
Comment.property('contentLocation', {
...
Comment.property('contentRating', {
  "name" : "contentRating", 
...
Comment.property('copyrightHolder', {
...
Comment.property('copyrightYear', {
  "name" : "copyrightYear", 
...
Comment.property('datePublished', {
  "name" : "datePublished", 
...
Comment.property('discussionUrl', {
  "name" : "discussionUrl", 
...
Comment.property('educationalAlignment', {
...
Comment.property('educationalUse', {
  "name" : "educationalUse", 
...
Comment.property('interactionCount', {
...
Comment.property('interactivityType', {
...
Comment.property('isFamilyFriendly', {
...
Comment.property('learningResourceType', {
...
Comment.property('publishingPrinciples', {
...
Comment.property('sourceOrganization', {
...
Comment.property('typicalAgeRange', {
