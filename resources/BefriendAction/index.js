...
var BefriendAction = resource.define('BefriendAction'); 

BefriendAction.schema.description = "The act of forming a personal connection with someone (object) mutually/bidirectionally/symmetrically.Related actions:FollowAction: Unlike FollowAction, BefriendAction implies that the connection is reciprocal."; 
BefriendAction.persist('fs'); 


BefriendAction.property('additionalType', {
  "name" : "additionalType", 
...
BefriendAction.property('description', {
  "name" : "description", 
...
BefriendAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
BefriendAction.property('endTime', {
  "name" : "endTime", 
...
BefriendAction.property('instrument', {
  "name" : "instrument", 
...
BefriendAction.property('location', {
  "name" : "location", 
...
BefriendAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
BefriendAction.property('participant', {
  "name" : "participant", 
...
BefriendAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
BefriendAction.property('startTime', {
  "name" : "startTime", 
