...
var HomeGoodsStore = resource.define('HomeGoodsStore'); 

HomeGoodsStore.schema.description = "A home goods store."; 
HomeGoodsStore.persist('fs'); 


HomeGoodsStore.property('additionalType', {
  "name" : "additionalType", 
...
HomeGoodsStore.property('description', {
  "name" : "description", 
...
HomeGoodsStore.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
HomeGoodsStore.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
HomeGoodsStore.property('aggregateRating', {
...
HomeGoodsStore.property('containedIn', {
  "name" : "containedIn", 
...
HomeGoodsStore.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
HomeGoodsStore.property('faxNumber', {
  "name" : "faxNumber", 
...
HomeGoodsStore.property('globalLocationNumber', {
...
HomeGoodsStore.property('interactionCount', {
...
HomeGoodsStore.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
HomeGoodsStore.property('openingHoursSpecification', {
...
HomeGoodsStore.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
HomeGoodsStore.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
HomeGoodsStore.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
HomeGoodsStore.property('telephone', {
  "name" : "telephone", 
...
HomeGoodsStore.property('contactPoint', {
  "name" : "contactPoint", 
...
HomeGoodsStore.property('contactPoints', {
  "name" : "contactPoints", 
...
HomeGoodsStore.property('employee', {
  "name" : "employee", 
...
HomeGoodsStore.property('employees', {
  "name" : "employees", 
...
HomeGoodsStore.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
HomeGoodsStore.property('founders', {
  "name" : "founders", 
...
HomeGoodsStore.property('foundingDate', {
  "name" : "foundingDate", 
...
HomeGoodsStore.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
HomeGoodsStore.property('legalName', {
  "name" : "legalName", 
...
HomeGoodsStore.property('location', {
  "name" : "location", 
...
HomeGoodsStore.property('makesOffer', {
  "name" : "makesOffer", 
...
HomeGoodsStore.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
HomeGoodsStore.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
HomeGoodsStore.property('branchOf', {
  "name" : "branchOf", 
...
HomeGoodsStore.property('currenciesAccepted', {
...
HomeGoodsStore.property('openingHours', {
  "name" : "openingHours", 
...
HomeGoodsStore.property('paymentAccepted', {
...
HomeGoodsStore.property('priceRange', {
  "name" : "priceRange", 
