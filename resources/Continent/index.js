...
var Continent = resource.define('Continent'); 

Continent.schema.description = "One of the continents (for example, Europe or Africa)."; 
Continent.persist('fs'); 


Continent.property('additionalType', {
  "name" : "additionalType", 
...
Continent.property('description', {
  "name" : "description", 
...
Continent.property('aggregateRating', {
...
Continent.property('containedIn', {
  "name" : "containedIn", 
...
Continent.property('globalLocationNumber', {
...
Continent.property('interactionCount', {
...
Continent.property('openingHoursSpecification', {
