...
var DrugClass = resource.define('DrugClass'); 

DrugClass.schema.description = "A class of medical drugs, e.g., statins. Classes can represent general pharmacological class, common mechanisms of action, common physiological effects, etc."; 
DrugClass.persist('fs'); 


DrugClass.property('additionalType', {
  "name" : "additionalType", 
...
DrugClass.property('description', {
  "name" : "description", 
...
DrugClass.property('alternateName', {
  "name" : "alternateName", 
...
DrugClass.property('medicineSystem', {
  "name" : "medicineSystem", 
...
DrugClass.property('recognizingAuthority', {
...
DrugClass.property('relevantSpecialty', {
...
DrugClass.property('adverseOutcome', {
  "name" : "adverseOutcome", 
...
DrugClass.property('contraindication', {
...
DrugClass.property('duplicateTherapy', {
...
DrugClass.property('seriousAdverseOutcome', {
