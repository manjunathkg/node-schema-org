...
var AutoDealer = resource.define('AutoDealer'); 

AutoDealer.schema.description = "An car dealership."; 
AutoDealer.persist('fs'); 


AutoDealer.property('additionalType', {
  "name" : "additionalType", 
...
AutoDealer.property('description', {
  "name" : "description", 
...
AutoDealer.property('aggregateRating', {
...
AutoDealer.property('containedIn', {
  "name" : "containedIn", 
...
AutoDealer.property('globalLocationNumber', {
...
AutoDealer.property('interactionCount', {
...
AutoDealer.property('openingHoursSpecification', {
...
AutoDealer.property('contactPoint', {
  "name" : "contactPoint", 
...
AutoDealer.property('contactPoints', {
  "name" : "contactPoints", 
...
AutoDealer.property('foundingDate', {
  "name" : "foundingDate", 
...
AutoDealer.property('makesOffer', {
  "name" : "makesOffer", 
...
AutoDealer.property('currenciesAccepted', {
...
AutoDealer.property('openingHours', {
  "name" : "openingHours", 
...
AutoDealer.property('paymentAccepted', {
...
AutoDealer.property('priceRange', {
  "name" : "priceRange", 
