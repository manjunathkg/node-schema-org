...
var ChildCare = resource.define('ChildCare'); 

ChildCare.schema.description = "A Childcare center."; 
ChildCare.persist('fs'); 


ChildCare.property('additionalType', {
  "name" : "additionalType", 
...
ChildCare.property('description', {
  "name" : "description", 
...
ChildCare.property('aggregateRating', {
...
ChildCare.property('containedIn', {
  "name" : "containedIn", 
...
ChildCare.property('globalLocationNumber', {
...
ChildCare.property('interactionCount', {
...
ChildCare.property('openingHoursSpecification', {
...
ChildCare.property('contactPoint', {
  "name" : "contactPoint", 
...
ChildCare.property('contactPoints', {
  "name" : "contactPoints", 
...
ChildCare.property('foundingDate', {
  "name" : "foundingDate", 
...
ChildCare.property('currenciesAccepted', {
...
ChildCare.property('openingHours', {
  "name" : "openingHours", 
...
ChildCare.property('paymentAccepted', {
