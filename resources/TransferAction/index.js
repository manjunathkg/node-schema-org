...
var TransferAction = resource.define('TransferAction'); 

TransferAction.schema.description = "The act of transferring/moving (abstract or concrete) animate or inanimate objects from one place to another."; 
TransferAction.persist('fs'); 


TransferAction.property('additionalType', {
  "name" : "additionalType", 
...
TransferAction.property('description', {
  "name" : "description", 
...
TransferAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
TransferAction.property('endTime', {
  "name" : "endTime", 
...
TransferAction.property('instrument', {
  "name" : "instrument", 
...
TransferAction.property('location', {
  "name" : "location", 
...
TransferAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
TransferAction.property('participant', {
  "name" : "participant", 
...
TransferAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
TransferAction.property('startTime', {
  "name" : "startTime", 
...
TransferAction.property('fromLocation', {
  "name" : "fromLocation", 
...
TransferAction.property('toLocation', {
  "name" : "toLocation", 
