...
var TieAction = resource.define('TieAction'); 

TieAction.schema.description = "The act of reaching a draw in a competitive activity."; 
TieAction.persist('fs'); 


TieAction.property('additionalType', {
  "name" : "additionalType", 
...
TieAction.property('description', {
  "name" : "description", 
...
TieAction.property('participant', {
  "name" : "participant", 
