...
var CommentAction = resource.define('CommentAction'); 

CommentAction.schema.description = "The act of generating a comment about a subject."; 
CommentAction.persist('fs'); 


CommentAction.property('additionalType', {
  "name" : "additionalType", 
...
CommentAction.property('description', {
  "name" : "description", 
...
CommentAction.property('endTime', {
  "name" : "endTime", 
...
CommentAction.property('instrument', {
  "name" : "instrument", 
...
CommentAction.property('location', {
  "name" : "location", 
...
CommentAction.property('participant', {
  "name" : "participant", 
...
CommentAction.property('startTime', {
  "name" : "startTime", 
...
CommentAction.property('language', {
  "name" : "language", 
...
CommentAction.property('recipient', {
  "name" : "recipient", 
