...
var Playground = resource.define('Playground'); 

Playground.schema.description = "A playground."; 
Playground.persist('fs'); 


Playground.property('additionalType', {
  "name" : "additionalType", 
...
Playground.property('description', {
  "name" : "description", 
...
Playground.property('aggregateRating', {
...
Playground.property('containedIn', {
  "name" : "containedIn", 
...
Playground.property('globalLocationNumber', {
...
Playground.property('interactionCount', {
...
Playground.property('openingHoursSpecification', {
...
Playground.property('openingHours', {
  "name" : "openingHours", 
