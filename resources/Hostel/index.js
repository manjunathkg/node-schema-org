...
var Hostel = resource.define('Hostel'); 

Hostel.schema.description = "A hostel."; 
Hostel.persist('fs'); 


Hostel.property('additionalType', {
  "name" : "additionalType", 
...
Hostel.property('aggregateRating', {
...
Hostel.property('globalLocationNumber', {
...
Hostel.property('interactionCount', {
...
Hostel.property('openingHoursSpecification', {
...
Hostel.property('currenciesAccepted', {
...
Hostel.property('paymentAccepted', {
