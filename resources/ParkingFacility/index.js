...
var ParkingFacility = resource.define('ParkingFacility'); 

ParkingFacility.schema.description = "A parking lot or other parking facility."; 
ParkingFacility.persist('fs'); 


ParkingFacility.property('additionalType', {
  "name" : "additionalType", 
...
ParkingFacility.property('description', {
  "name" : "description", 
...
ParkingFacility.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
ParkingFacility.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ParkingFacility.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
ParkingFacility.property('aggregateRating', {
...
ParkingFacility.property('containedIn', {
  "name" : "containedIn", 
...
ParkingFacility.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
ParkingFacility.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
ParkingFacility.property('faxNumber', {
  "name" : "faxNumber", 
...
ParkingFacility.property('globalLocationNumber', {
...
ParkingFacility.property('interactionCount', {
...
ParkingFacility.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
ParkingFacility.property('openingHoursSpecification', {
...
ParkingFacility.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
ParkingFacility.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
ParkingFacility.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
ParkingFacility.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
ParkingFacility.property('telephone', {
  "name" : "telephone", 
...
ParkingFacility.property('openingHours', {
  "name" : "openingHours", 
