...
var SiteNavigationElement = resource.define('SiteNavigationElement'); 

SiteNavigationElement.schema.description = "A navigation element of the page."; 
SiteNavigationElement.persist('fs'); 


SiteNavigationElement.property('additionalType', {
  "name" : "additionalType", 
...
SiteNavigationElement.property('description', {
  "name" : "description", 
...
SiteNavigationElement.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
SiteNavigationElement.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
SiteNavigationElement.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
SiteNavigationElement.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
SiteNavigationElement.property('about', {
  "name" : "about", 
  "displayName" : "About", 
...
SiteNavigationElement.property('accountablePerson', {
...
SiteNavigationElement.property('aggregateRating', {
...
SiteNavigationElement.property('alternativeHeadline', {
...
SiteNavigationElement.property('associatedMedia', {
...
SiteNavigationElement.property('audience', {
  "name" : "audience", 
...
SiteNavigationElement.property('audio', {
  "name" : "audio", 
  "displayName" : "Audio", 
...
SiteNavigationElement.property('author', {
  "name" : "author", 
  "displayName" : "Author", 
...
SiteNavigationElement.property('award', {
  "name" : "award", 
  "displayName" : "Award", 
...
SiteNavigationElement.property('awards', {
  "name" : "awards", 
  "displayName" : "Awards", 
...
SiteNavigationElement.property('citation', {
  "name" : "citation", 
...
SiteNavigationElement.property('comment', {
  "name" : "comment", 
  "displayName" : "Comment", 
...
SiteNavigationElement.property('contentLocation', {
...
SiteNavigationElement.property('contentRating', {
  "name" : "contentRating", 
...
SiteNavigationElement.property('contributor', {
  "name" : "contributor", 
...
SiteNavigationElement.property('copyrightHolder', {
...
SiteNavigationElement.property('copyrightYear', {
  "name" : "copyrightYear", 
...
SiteNavigationElement.property('creator', {
  "name" : "creator", 
  "displayName" : "Creator", 
...
SiteNavigationElement.property('dateCreated', {
  "name" : "dateCreated", 
...
SiteNavigationElement.property('dateModified', {
  "name" : "dateModified", 
...
SiteNavigationElement.property('datePublished', {
  "name" : "datePublished", 
...
SiteNavigationElement.property('discussionUrl', {
  "name" : "discussionUrl", 
...
SiteNavigationElement.property('editor', {
  "name" : "editor", 
  "displayName" : "Editor", 
...
SiteNavigationElement.property('educationalAlignment', {
...
SiteNavigationElement.property('educationalUse', {
  "name" : "educationalUse", 
...
SiteNavigationElement.property('encoding', {
  "name" : "encoding", 
...
SiteNavigationElement.property('encodings', {
  "name" : "encodings", 
...
SiteNavigationElement.property('genre', {
  "name" : "genre", 
  "displayName" : "Genre", 
...
SiteNavigationElement.property('headline', {
  "name" : "headline", 
...
SiteNavigationElement.property('inLanguage', {
  "name" : "inLanguage", 
...
SiteNavigationElement.property('interactionCount', {
...
SiteNavigationElement.property('interactivityType', {
...
SiteNavigationElement.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
SiteNavigationElement.property('isFamilyFriendly', {
...
SiteNavigationElement.property('keywords', {
  "name" : "keywords", 
...
SiteNavigationElement.property('learningResourceType', {
...
SiteNavigationElement.property('mentions', {
  "name" : "mentions", 
...
SiteNavigationElement.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
SiteNavigationElement.property('provider', {
  "name" : "provider", 
...
SiteNavigationElement.property('publisher', {
  "name" : "publisher", 
...
SiteNavigationElement.property('publishingPrinciples', {
...
SiteNavigationElement.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
SiteNavigationElement.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
SiteNavigationElement.property('sourceOrganization', {
...
SiteNavigationElement.property('text', {
  "name" : "text", 
  "displayName" : "Text", 
...
SiteNavigationElement.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
SiteNavigationElement.property('timeRequired', {
  "name" : "timeRequired", 
...
SiteNavigationElement.property('typicalAgeRange', {
...
SiteNavigationElement.property('version', {
  "name" : "version", 
  "displayName" : "Version", 
...
SiteNavigationElement.property('video', {
  "name" : "video", 
  "displayName" : "Video", 
