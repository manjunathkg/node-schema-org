...
var Place = resource.define('Place'); 

Place.schema.description = "Entities that have a somewhat fixed, physical extension."; 
Place.persist('fs'); 


Place.property('additionalType', {
  "name" : "additionalType", 
...
Place.property('aggregateRating', {
...
Place.property('globalLocationNumber', {
...
Place.property('interactionCount', {
...
Place.property('openingHoursSpecification', {
