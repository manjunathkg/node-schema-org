...
var MedicalOrganization = resource.define('MedicalOrganization'); 

MedicalOrganization.schema.description = "A medical organization, such as a doctor&#x27;s office or clinic."; 
MedicalOrganization.persist('fs'); 


MedicalOrganization.property('additionalType', {
  "name" : "additionalType", 
...
MedicalOrganization.property('description', {
  "name" : "description", 
...
MedicalOrganization.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
MedicalOrganization.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
MedicalOrganization.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MedicalOrganization.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
MedicalOrganization.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
MedicalOrganization.property('aggregateRating', {
...
MedicalOrganization.property('containedIn', {
  "name" : "containedIn", 
...
MedicalOrganization.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
MedicalOrganization.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
MedicalOrganization.property('faxNumber', {
  "name" : "faxNumber", 
...
MedicalOrganization.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
MedicalOrganization.property('globalLocationNumber', {
...
MedicalOrganization.property('interactionCount', {
...
MedicalOrganization.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
MedicalOrganization.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
MedicalOrganization.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
MedicalOrganization.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
MedicalOrganization.property('openingHoursSpecification', {
...
MedicalOrganization.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
MedicalOrganization.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
MedicalOrganization.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
MedicalOrganization.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
MedicalOrganization.property('telephone', {
  "name" : "telephone", 
...
MedicalOrganization.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
MedicalOrganization.property('contactPoint', {
  "name" : "contactPoint", 
...
MedicalOrganization.property('contactPoints', {
  "name" : "contactPoints", 
...
MedicalOrganization.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
MedicalOrganization.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
MedicalOrganization.property('employee', {
  "name" : "employee", 
...
MedicalOrganization.property('employees', {
  "name" : "employees", 
...
MedicalOrganization.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
MedicalOrganization.property('founders', {
  "name" : "founders", 
...
MedicalOrganization.property('foundingDate', {
  "name" : "foundingDate", 
...
MedicalOrganization.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
MedicalOrganization.property('legalName', {
  "name" : "legalName", 
...
MedicalOrganization.property('location', {
  "name" : "location", 
...
MedicalOrganization.property('makesOffer', {
  "name" : "makesOffer", 
...
MedicalOrganization.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
MedicalOrganization.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
MedicalOrganization.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
MedicalOrganization.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
MedicalOrganization.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
MedicalOrganization.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
MedicalOrganization.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
MedicalOrganization.property('branchOf', {
  "name" : "branchOf", 
...
MedicalOrganization.property('currenciesAccepted', {
...
MedicalOrganization.property('openingHours', {
  "name" : "openingHours", 
...
MedicalOrganization.property('paymentAccepted', {
...
MedicalOrganization.property('priceRange', {
  "name" : "priceRange", 
