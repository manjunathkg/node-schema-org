...
var AutomotiveBusiness = resource.define('AutomotiveBusiness'); 

AutomotiveBusiness.schema.description = "Car repair, sales, or parts."; 
AutomotiveBusiness.persist('fs'); 


AutomotiveBusiness.property('additionalType', {
  "name" : "additionalType", 
...
AutomotiveBusiness.property('description', {
  "name" : "description", 
...
AutomotiveBusiness.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
AutomotiveBusiness.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
AutomotiveBusiness.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
AutomotiveBusiness.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
AutomotiveBusiness.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
AutomotiveBusiness.property('aggregateRating', {
...
AutomotiveBusiness.property('containedIn', {
  "name" : "containedIn", 
...
AutomotiveBusiness.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
AutomotiveBusiness.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
AutomotiveBusiness.property('faxNumber', {
  "name" : "faxNumber", 
...
AutomotiveBusiness.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
AutomotiveBusiness.property('globalLocationNumber', {
...
AutomotiveBusiness.property('interactionCount', {
...
AutomotiveBusiness.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
AutomotiveBusiness.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
AutomotiveBusiness.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
AutomotiveBusiness.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
AutomotiveBusiness.property('openingHoursSpecification', {
...
AutomotiveBusiness.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
AutomotiveBusiness.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
AutomotiveBusiness.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
AutomotiveBusiness.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
AutomotiveBusiness.property('telephone', {
  "name" : "telephone", 
...
AutomotiveBusiness.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
AutomotiveBusiness.property('contactPoint', {
  "name" : "contactPoint", 
...
AutomotiveBusiness.property('contactPoints', {
  "name" : "contactPoints", 
...
AutomotiveBusiness.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
AutomotiveBusiness.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
AutomotiveBusiness.property('employee', {
  "name" : "employee", 
...
AutomotiveBusiness.property('employees', {
  "name" : "employees", 
...
AutomotiveBusiness.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
AutomotiveBusiness.property('founders', {
  "name" : "founders", 
...
AutomotiveBusiness.property('foundingDate', {
  "name" : "foundingDate", 
...
AutomotiveBusiness.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
AutomotiveBusiness.property('legalName', {
  "name" : "legalName", 
...
AutomotiveBusiness.property('location', {
  "name" : "location", 
...
AutomotiveBusiness.property('makesOffer', {
  "name" : "makesOffer", 
...
AutomotiveBusiness.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
AutomotiveBusiness.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
AutomotiveBusiness.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
AutomotiveBusiness.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
AutomotiveBusiness.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
AutomotiveBusiness.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
AutomotiveBusiness.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
AutomotiveBusiness.property('branchOf', {
  "name" : "branchOf", 
...
AutomotiveBusiness.property('currenciesAccepted', {
...
AutomotiveBusiness.property('openingHours', {
  "name" : "openingHours", 
...
AutomotiveBusiness.property('paymentAccepted', {
...
AutomotiveBusiness.property('priceRange', {
  "name" : "priceRange", 
