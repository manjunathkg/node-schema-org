...
var PlaceOfWorship = resource.define('PlaceOfWorship'); 

PlaceOfWorship.schema.description = "Place of worship, such as a church, synagogue, or mosque."; 
PlaceOfWorship.persist('fs'); 


PlaceOfWorship.property('additionalType', {
  "name" : "additionalType", 
...
PlaceOfWorship.property('description', {
  "name" : "description", 
...
PlaceOfWorship.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
PlaceOfWorship.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
PlaceOfWorship.property('aggregateRating', {
...
PlaceOfWorship.property('containedIn', {
  "name" : "containedIn", 
...
PlaceOfWorship.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
PlaceOfWorship.property('faxNumber', {
  "name" : "faxNumber", 
...
PlaceOfWorship.property('globalLocationNumber', {
...
PlaceOfWorship.property('interactionCount', {
...
PlaceOfWorship.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
PlaceOfWorship.property('openingHoursSpecification', {
...
PlaceOfWorship.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
PlaceOfWorship.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
PlaceOfWorship.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
PlaceOfWorship.property('telephone', {
  "name" : "telephone", 
...
PlaceOfWorship.property('openingHours', {
  "name" : "openingHours", 
