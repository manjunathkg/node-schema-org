...
var UserPlays = resource.define('UserPlays'); 

UserPlays.schema.description = "User interaction: Play count of an item, for example a video or a song."; 
UserPlays.persist('fs'); 


UserPlays.property('additionalType', {
  "name" : "additionalType", 
...
UserPlays.property('description', {
  "name" : "description", 
