...
var Corporation = resource.define('Corporation'); 

Corporation.schema.description = "Organization: A business corporation."; 
Corporation.persist('fs'); 


Corporation.property('additionalType', {
  "name" : "additionalType", 
...
Corporation.property('aggregateRating', {
...
Corporation.property('contactPoint', {
  "name" : "contactPoint", 
...
Corporation.property('contactPoints', {
  "name" : "contactPoints", 
...
Corporation.property('employees', {
  "name" : "employees", 
...
Corporation.property('faxNumber', {
  "name" : "faxNumber", 
...
Corporation.property('foundingDate', {
  "name" : "foundingDate", 
...
Corporation.property('globalLocationNumber', {
...
Corporation.property('interactionCount', {
...
Corporation.property('legalName', {
  "name" : "legalName", 
...
Corporation.property('makesOffer', {
  "name" : "makesOffer", 
...
Corporation.property('telephone', {
  "name" : "telephone", 
...
Corporation.property('tickerSymbol', {
  "name" : "tickerSymbol", 
