...
var TouristInformationCenter = resource.define('TouristInformationCenter'); 

TouristInformationCenter.schema.description = "A tourist information center."; 
TouristInformationCenter.persist('fs'); 


TouristInformationCenter.property('additionalType', {
  "name" : "additionalType", 
...
TouristInformationCenter.property('description', {
  "name" : "description", 
...
TouristInformationCenter.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
TouristInformationCenter.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
TouristInformationCenter.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
TouristInformationCenter.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
TouristInformationCenter.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
TouristInformationCenter.property('aggregateRating', {
...
TouristInformationCenter.property('containedIn', {
  "name" : "containedIn", 
...
TouristInformationCenter.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
TouristInformationCenter.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
TouristInformationCenter.property('faxNumber', {
  "name" : "faxNumber", 
...
TouristInformationCenter.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
TouristInformationCenter.property('globalLocationNumber', {
...
TouristInformationCenter.property('interactionCount', {
...
TouristInformationCenter.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
TouristInformationCenter.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
TouristInformationCenter.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
TouristInformationCenter.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
TouristInformationCenter.property('openingHoursSpecification', {
...
TouristInformationCenter.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
TouristInformationCenter.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
TouristInformationCenter.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
TouristInformationCenter.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
TouristInformationCenter.property('telephone', {
  "name" : "telephone", 
...
TouristInformationCenter.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
TouristInformationCenter.property('contactPoint', {
  "name" : "contactPoint", 
...
TouristInformationCenter.property('contactPoints', {
  "name" : "contactPoints", 
...
TouristInformationCenter.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
TouristInformationCenter.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
TouristInformationCenter.property('employee', {
  "name" : "employee", 
...
TouristInformationCenter.property('employees', {
  "name" : "employees", 
...
TouristInformationCenter.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
TouristInformationCenter.property('founders', {
  "name" : "founders", 
...
TouristInformationCenter.property('foundingDate', {
  "name" : "foundingDate", 
...
TouristInformationCenter.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
TouristInformationCenter.property('legalName', {
  "name" : "legalName", 
...
TouristInformationCenter.property('location', {
  "name" : "location", 
...
TouristInformationCenter.property('makesOffer', {
  "name" : "makesOffer", 
...
TouristInformationCenter.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
TouristInformationCenter.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
TouristInformationCenter.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
TouristInformationCenter.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
TouristInformationCenter.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
TouristInformationCenter.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
TouristInformationCenter.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
TouristInformationCenter.property('branchOf', {
  "name" : "branchOf", 
...
TouristInformationCenter.property('currenciesAccepted', {
...
TouristInformationCenter.property('openingHours', {
  "name" : "openingHours", 
...
TouristInformationCenter.property('paymentAccepted', {
...
TouristInformationCenter.property('priceRange', {
  "name" : "priceRange", 
