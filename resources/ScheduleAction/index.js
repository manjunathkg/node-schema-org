...
var ScheduleAction = resource.define('ScheduleAction'); 

ScheduleAction.schema.description = "Scheduling future actions, events, or tasks.Related actions:ReserveAction: Unlike ReserveAction, ScheduleAction allocates future actions (e.g. an event, a task, etc) towards a time slot / spatial allocation."; 
ScheduleAction.persist('fs'); 


ScheduleAction.property('additionalType', {
  "name" : "additionalType", 
...
ScheduleAction.property('description', {
  "name" : "description", 
...
ScheduleAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
ScheduleAction.property('endTime', {
  "name" : "endTime", 
...
ScheduleAction.property('instrument', {
  "name" : "instrument", 
...
ScheduleAction.property('location', {
  "name" : "location", 
...
ScheduleAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
ScheduleAction.property('participant', {
  "name" : "participant", 
...
ScheduleAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
ScheduleAction.property('startTime', {
  "name" : "startTime", 
...
ScheduleAction.property('scheduledTime', {
  "name" : "scheduledTime", 
