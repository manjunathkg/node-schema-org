...
var AssessAction = resource.define('AssessAction'); 

AssessAction.schema.description = "The act of forming one&#x27;s opinion, reaction or sentiment."; 
AssessAction.persist('fs'); 


AssessAction.property('additionalType', {
  "name" : "additionalType", 
...
AssessAction.property('description', {
  "name" : "description", 
...
AssessAction.property('instrument', {
  "name" : "instrument", 
...
AssessAction.property('location', {
  "name" : "location", 
...
AssessAction.property('participant', {
  "name" : "participant", 
...
AssessAction.property('startTime', {
  "name" : "startTime", 
