...
var PublicSwimmingPool = resource.define('PublicSwimmingPool'); 

PublicSwimmingPool.schema.description = "A public swimming pool."; 
PublicSwimmingPool.persist('fs'); 


PublicSwimmingPool.property('additionalType', {
  "name" : "additionalType", 
...
PublicSwimmingPool.property('description', {
  "name" : "description", 
...
PublicSwimmingPool.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
PublicSwimmingPool.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
PublicSwimmingPool.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
PublicSwimmingPool.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
PublicSwimmingPool.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
PublicSwimmingPool.property('aggregateRating', {
...
PublicSwimmingPool.property('containedIn', {
  "name" : "containedIn", 
...
PublicSwimmingPool.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
PublicSwimmingPool.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
PublicSwimmingPool.property('faxNumber', {
  "name" : "faxNumber", 
...
PublicSwimmingPool.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
PublicSwimmingPool.property('globalLocationNumber', {
...
PublicSwimmingPool.property('interactionCount', {
...
PublicSwimmingPool.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
PublicSwimmingPool.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
PublicSwimmingPool.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
PublicSwimmingPool.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
PublicSwimmingPool.property('openingHoursSpecification', {
...
PublicSwimmingPool.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
PublicSwimmingPool.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
PublicSwimmingPool.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
PublicSwimmingPool.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
PublicSwimmingPool.property('telephone', {
  "name" : "telephone", 
...
PublicSwimmingPool.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
PublicSwimmingPool.property('contactPoint', {
  "name" : "contactPoint", 
...
PublicSwimmingPool.property('contactPoints', {
  "name" : "contactPoints", 
...
PublicSwimmingPool.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
PublicSwimmingPool.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
PublicSwimmingPool.property('employee', {
  "name" : "employee", 
...
PublicSwimmingPool.property('employees', {
  "name" : "employees", 
...
PublicSwimmingPool.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
PublicSwimmingPool.property('founders', {
  "name" : "founders", 
...
PublicSwimmingPool.property('foundingDate', {
  "name" : "foundingDate", 
...
PublicSwimmingPool.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
PublicSwimmingPool.property('legalName', {
  "name" : "legalName", 
...
PublicSwimmingPool.property('location', {
  "name" : "location", 
...
PublicSwimmingPool.property('makesOffer', {
  "name" : "makesOffer", 
...
PublicSwimmingPool.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
PublicSwimmingPool.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
PublicSwimmingPool.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
PublicSwimmingPool.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
PublicSwimmingPool.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
PublicSwimmingPool.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
PublicSwimmingPool.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
PublicSwimmingPool.property('branchOf', {
  "name" : "branchOf", 
...
PublicSwimmingPool.property('currenciesAccepted', {
...
PublicSwimmingPool.property('openingHours', {
  "name" : "openingHours", 
...
PublicSwimmingPool.property('paymentAccepted', {
...
PublicSwimmingPool.property('priceRange', {
  "name" : "priceRange", 
