...
var ReplaceAction = resource.define('ReplaceAction'); 

ReplaceAction.schema.description = "The act of editing a recipient by replacing an old object with a new object."; 
ReplaceAction.persist('fs'); 


ReplaceAction.property('additionalType', {
  "name" : "additionalType", 
...
ReplaceAction.property('description', {
  "name" : "description", 
...
ReplaceAction.property('endTime', {
  "name" : "endTime", 
...
ReplaceAction.property('instrument', {
  "name" : "instrument", 
...
ReplaceAction.property('location', {
  "name" : "location", 
...
ReplaceAction.property('participant', {
  "name" : "participant", 
...
ReplaceAction.property('startTime', {
  "name" : "startTime", 
...
ReplaceAction.property('collection', {
  "name" : "collection", 
...
ReplaceAction.property('replacee', {
  "name" : "replacee", 
  "displayName" : "Replacee", 
  "description" : "A sub property of object. The object that is being replaced.", 
"type":"object","properties" : {"Thing" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


ReplaceAction.property('replacer', {
  "name" : "replacer", 
