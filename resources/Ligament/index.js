...
var Ligament = resource.define('Ligament'); 

Ligament.schema.description = "A short band of tough, flexible, fibrous connective tissue that functions to connect multiple bones, cartilages, and structurally support joints."; 
Ligament.persist('fs'); 


Ligament.property('additionalType', {
  "name" : "additionalType", 
...
Ligament.property('alternateName', {
  "name" : "alternateName", 
...
Ligament.property('medicineSystem', {
  "name" : "medicineSystem", 
...
Ligament.property('recognizingAuthority', {
...
Ligament.property('relevantSpecialty', {
...
Ligament.property('associatedPathophysiology', {
...
Ligament.property('bodyLocation', {
  "name" : "bodyLocation", 
...
Ligament.property('partOfSystem', {
  "name" : "partOfSystem", 
...
Ligament.property('relatedCondition', {
...
Ligament.property('relatedTherapy', {
  "name" : "relatedTherapy", 
...
Ligament.property('subStructure', {
  "name" : "subStructure", 
