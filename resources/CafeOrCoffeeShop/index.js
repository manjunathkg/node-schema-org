...
CafeOrCoffeeShop.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
CafeOrCoffeeShop.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
CafeOrCoffeeShop.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
CafeOrCoffeeShop.property('aggregateRating', {
...
CafeOrCoffeeShop.property('containedIn', {
  "name" : "containedIn", 
...
CafeOrCoffeeShop.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
CafeOrCoffeeShop.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
CafeOrCoffeeShop.property('faxNumber', {
  "name" : "faxNumber", 
...
CafeOrCoffeeShop.property('globalLocationNumber', {
...
CafeOrCoffeeShop.property('interactionCount', {
...
CafeOrCoffeeShop.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
CafeOrCoffeeShop.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
CafeOrCoffeeShop.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
CafeOrCoffeeShop.property('openingHoursSpecification', {
...
CafeOrCoffeeShop.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
CafeOrCoffeeShop.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
CafeOrCoffeeShop.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
CafeOrCoffeeShop.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
CafeOrCoffeeShop.property('telephone', {
  "name" : "telephone", 
...
CafeOrCoffeeShop.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
CafeOrCoffeeShop.property('contactPoint', {
  "name" : "contactPoint", 
...
CafeOrCoffeeShop.property('contactPoints', {
  "name" : "contactPoints", 
...
CafeOrCoffeeShop.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
CafeOrCoffeeShop.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
CafeOrCoffeeShop.property('employee', {
  "name" : "employee", 
...
CafeOrCoffeeShop.property('employees', {
  "name" : "employees", 
...
CafeOrCoffeeShop.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
CafeOrCoffeeShop.property('founders', {
  "name" : "founders", 
...
CafeOrCoffeeShop.property('foundingDate', {
  "name" : "foundingDate", 
...
CafeOrCoffeeShop.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
CafeOrCoffeeShop.property('legalName', {
  "name" : "legalName", 
...
CafeOrCoffeeShop.property('location', {
  "name" : "location", 
...
CafeOrCoffeeShop.property('makesOffer', {
  "name" : "makesOffer", 
...
CafeOrCoffeeShop.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
CafeOrCoffeeShop.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
CafeOrCoffeeShop.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
CafeOrCoffeeShop.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
CafeOrCoffeeShop.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
CafeOrCoffeeShop.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
CafeOrCoffeeShop.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
CafeOrCoffeeShop.property('branchOf', {
  "name" : "branchOf", 
...
CafeOrCoffeeShop.property('currenciesAccepted', {
...
CafeOrCoffeeShop.property('openingHours', {
  "name" : "openingHours", 
...
CafeOrCoffeeShop.property('paymentAccepted', {
...
CafeOrCoffeeShop.property('priceRange', {
  "name" : "priceRange", 
...
CafeOrCoffeeShop.property('acceptsReservations', {
...
CafeOrCoffeeShop.property('menu', {
  "name" : "menu", 
  "displayName" : "Menu", 
...
CafeOrCoffeeShop.property('servesCuisine', {
  "name" : "servesCuisine", 
