...
var ArriveAction = resource.define('ArriveAction'); 

ArriveAction.schema.description = "The act of arriving at a place. An agent arrives at a destination from an fromLocation, optionally with participants."; 
ArriveAction.persist('fs'); 


ArriveAction.property('additionalType', {
  "name" : "additionalType", 
...
ArriveAction.property('description', {
  "name" : "description", 
...
ArriveAction.property('instrument', {
  "name" : "instrument", 
...
ArriveAction.property('location', {
  "name" : "location", 
...
ArriveAction.property('participant', {
  "name" : "participant", 
...
ArriveAction.property('startTime', {
  "name" : "startTime", 
...
ArriveAction.property('fromLocation', {
  "name" : "fromLocation", 
...
ArriveAction.property('toLocation', {
  "name" : "toLocation", 
