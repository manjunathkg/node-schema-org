...
var Article = resource.define('Article'); 

Article.schema.description = "An article, such as a news article or piece of investigative report. Newspapers and magazines have articles of many different types and this is intended to cover them all."; 
Article.persist('fs'); 


Article.property('additionalType', {
  "name" : "additionalType", 
...
Article.property('accountablePerson', {
...
Article.property('aggregateRating', {
...
Article.property('alternativeHeadline', {
...
Article.property('associatedMedia', {
...
Article.property('contentLocation', {
...
Article.property('contentRating', {
  "name" : "contentRating", 
...
Article.property('copyrightHolder', {
...
Article.property('copyrightYear', {
  "name" : "copyrightYear", 
...
Article.property('discussionUrl', {
  "name" : "discussionUrl", 
...
Article.property('educationalAlignment', {
...
Article.property('educationalUse', {
  "name" : "educationalUse", 
...
Article.property('interactionCount', {
...
Article.property('interactivityType', {
...
Article.property('isFamilyFriendly', {
...
Article.property('learningResourceType', {
...
Article.property('publishingPrinciples', {
...
Article.property('sourceOrganization', {
...
Article.property('typicalAgeRange', {
...
Article.property('articleSection', {
  "name" : "articleSection", 
