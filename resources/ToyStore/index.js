...
var ToyStore = resource.define('ToyStore'); 

ToyStore.schema.description = "A toystore."; 
ToyStore.persist('fs'); 


ToyStore.property('additionalType', {
  "name" : "additionalType", 
...
ToyStore.property('aggregateRating', {
...
ToyStore.property('globalLocationNumber', {
...
ToyStore.property('interactionCount', {
...
ToyStore.property('openingHoursSpecification', {
...
ToyStore.property('contactPoint', {
  "name" : "contactPoint", 
...
ToyStore.property('contactPoints', {
  "name" : "contactPoints", 
...
ToyStore.property('foundingDate', {
  "name" : "foundingDate", 
...
ToyStore.property('currenciesAccepted', {
...
ToyStore.property('openingHours', {
  "name" : "openingHours", 
...
ToyStore.property('paymentAccepted', {
