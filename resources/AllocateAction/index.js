...
var AllocateAction = resource.define('AllocateAction'); 

AllocateAction.schema.description = "The act of organizing tasks/objects/events by associating resources to it."; 
AllocateAction.persist('fs'); 


AllocateAction.property('additionalType', {
  "name" : "additionalType", 
...
AllocateAction.property('description', {
  "name" : "description", 
...
AllocateAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
AllocateAction.property('endTime', {
  "name" : "endTime", 
...
AllocateAction.property('instrument', {
  "name" : "instrument", 
...
AllocateAction.property('location', {
  "name" : "location", 
...
AllocateAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
AllocateAction.property('participant', {
  "name" : "participant", 
...
AllocateAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
AllocateAction.property('startTime', {
  "name" : "startTime", 
...
AllocateAction.property('purpose', {
  "name" : "purpose", 
  "displayName" : "Purpose", 
