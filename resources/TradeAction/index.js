...
var TradeAction = resource.define('TradeAction'); 

TradeAction.schema.description = "The act of participating in an exchange of goods and services for monetary compensation. An agent trades an object, product or service with a participant in exchange for a one time or periodic payment."; 
TradeAction.persist('fs'); 


TradeAction.property('additionalType', {
  "name" : "additionalType", 
...
TradeAction.property('description', {
  "name" : "description", 
...
TradeAction.property('instrument', {
  "name" : "instrument", 
...
TradeAction.property('participant', {
  "name" : "participant", 
...
TradeAction.property('startTime', {
  "name" : "startTime", 
