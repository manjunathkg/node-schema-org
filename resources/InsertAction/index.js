...
var InsertAction = resource.define('InsertAction'); 

InsertAction.schema.description = "The act of adding at a specific location in an ordered collection."; 
InsertAction.persist('fs'); 


InsertAction.property('additionalType', {
  "name" : "additionalType", 
...
InsertAction.property('description', {
  "name" : "description", 
...
InsertAction.property('instrument', {
  "name" : "instrument", 
...
InsertAction.property('location', {
  "name" : "location", 
...
InsertAction.property('participant', {
  "name" : "participant", 
...
InsertAction.property('startTime', {
  "name" : "startTime", 
...
InsertAction.property('collection', {
  "name" : "collection", 
...
InsertAction.property('toLocation', {
  "name" : "toLocation", 
