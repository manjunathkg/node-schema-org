...
var EmploymentAgency = resource.define('EmploymentAgency'); 

EmploymentAgency.schema.description = "An employment agency."; 
EmploymentAgency.persist('fs'); 


EmploymentAgency.property('additionalType', {
  "name" : "additionalType", 
...
EmploymentAgency.property('description', {
  "name" : "description", 
...
EmploymentAgency.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
EmploymentAgency.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
EmploymentAgency.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
EmploymentAgency.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
EmploymentAgency.property('aggregateRating', {
...
EmploymentAgency.property('containedIn', {
  "name" : "containedIn", 
...
EmploymentAgency.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
EmploymentAgency.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
EmploymentAgency.property('faxNumber', {
  "name" : "faxNumber", 
...
EmploymentAgency.property('globalLocationNumber', {
...
EmploymentAgency.property('interactionCount', {
...
EmploymentAgency.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
EmploymentAgency.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
EmploymentAgency.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
EmploymentAgency.property('openingHoursSpecification', {
...
EmploymentAgency.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
EmploymentAgency.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
EmploymentAgency.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
EmploymentAgency.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
EmploymentAgency.property('telephone', {
  "name" : "telephone", 
...
EmploymentAgency.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
EmploymentAgency.property('contactPoint', {
  "name" : "contactPoint", 
...
EmploymentAgency.property('contactPoints', {
  "name" : "contactPoints", 
...
EmploymentAgency.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
EmploymentAgency.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
EmploymentAgency.property('employee', {
  "name" : "employee", 
...
EmploymentAgency.property('employees', {
  "name" : "employees", 
...
EmploymentAgency.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
EmploymentAgency.property('founders', {
  "name" : "founders", 
...
EmploymentAgency.property('foundingDate', {
  "name" : "foundingDate", 
...
EmploymentAgency.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
EmploymentAgency.property('legalName', {
  "name" : "legalName", 
...
EmploymentAgency.property('location', {
  "name" : "location", 
...
EmploymentAgency.property('makesOffer', {
  "name" : "makesOffer", 
...
EmploymentAgency.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
EmploymentAgency.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
EmploymentAgency.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
EmploymentAgency.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
EmploymentAgency.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
EmploymentAgency.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
EmploymentAgency.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
EmploymentAgency.property('branchOf', {
  "name" : "branchOf", 
...
EmploymentAgency.property('currenciesAccepted', {
...
EmploymentAgency.property('openingHours', {
  "name" : "openingHours", 
...
EmploymentAgency.property('paymentAccepted', {
...
EmploymentAgency.property('priceRange', {
  "name" : "priceRange", 
