...
var ApplyAction = resource.define('ApplyAction'); 

ApplyAction.schema.description = "The act of registering to an organization/service without the guarantee to receive it. NOTE(goto): should this be under InteractAction instead?Related actions:RegisterAction: Unlike RegisterAction, ApplyAction has no guarantees that the application will be accepted."; 
ApplyAction.persist('fs'); 


ApplyAction.property('additionalType', {
  "name" : "additionalType", 
...
ApplyAction.property('description', {
  "name" : "description", 
...
ApplyAction.property('instrument', {
  "name" : "instrument", 
...
ApplyAction.property('participant', {
  "name" : "participant", 
...
ApplyAction.property('startTime', {
  "name" : "startTime", 
