...
var AutoWash = resource.define('AutoWash'); 

AutoWash.schema.description = "A car wash business."; 
AutoWash.persist('fs'); 


AutoWash.property('additionalType', {
  "name" : "additionalType", 
...
AutoWash.property('aggregateRating', {
...
AutoWash.property('globalLocationNumber', {
...
AutoWash.property('interactionCount', {
...
AutoWash.property('openingHoursSpecification', {
...
AutoWash.property('contactPoint', {
  "name" : "contactPoint", 
...
AutoWash.property('contactPoints', {
  "name" : "contactPoints", 
...
AutoWash.property('foundingDate', {
  "name" : "foundingDate", 
...
AutoWash.property('currenciesAccepted', {
...
AutoWash.property('openingHours', {
  "name" : "openingHours", 
...
AutoWash.property('paymentAccepted', {
