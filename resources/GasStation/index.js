...
var GasStation = resource.define('GasStation'); 

GasStation.schema.description = "A gas station."; 
GasStation.persist('fs'); 


GasStation.property('additionalType', {
  "name" : "additionalType", 
...
GasStation.property('description', {
  "name" : "description", 
...
GasStation.property('aggregateRating', {
...
GasStation.property('containedIn', {
  "name" : "containedIn", 
...
GasStation.property('globalLocationNumber', {
...
GasStation.property('interactionCount', {
...
GasStation.property('openingHoursSpecification', {
...
GasStation.property('contactPoint', {
  "name" : "contactPoint", 
...
GasStation.property('contactPoints', {
  "name" : "contactPoints", 
...
GasStation.property('foundingDate', {
  "name" : "foundingDate", 
...
GasStation.property('makesOffer', {
  "name" : "makesOffer", 
...
GasStation.property('currenciesAccepted', {
...
GasStation.property('openingHours', {
  "name" : "openingHours", 
...
GasStation.property('paymentAccepted', {
...
GasStation.property('priceRange', {
  "name" : "priceRange", 
