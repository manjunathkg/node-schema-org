...
var UpdateAction = resource.define('UpdateAction'); 

UpdateAction.schema.description = "The act of managing by changing/editing the state of the object."; 
UpdateAction.persist('fs'); 


UpdateAction.property('additionalType', {
  "name" : "additionalType", 
...
UpdateAction.property('description', {
  "name" : "description", 
...
UpdateAction.property('instrument', {
  "name" : "instrument", 
...
UpdateAction.property('location', {
  "name" : "location", 
...
UpdateAction.property('participant', {
  "name" : "participant", 
...
UpdateAction.property('startTime', {
  "name" : "startTime", 
...
UpdateAction.property('collection', {
  "name" : "collection", 
