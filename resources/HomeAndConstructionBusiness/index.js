...
var HomeAndConstructionBusiness = resource.define('HomeAndConstructionBusiness'); 

HomeAndConstructionBusiness.schema.description = "A construction business."; 
HomeAndConstructionBusiness.persist('fs'); 


HomeAndConstructionBusiness.property('additionalType', {
  "name" : "additionalType", 
...
HomeAndConstructionBusiness.property('description', {
  "name" : "description", 
...
HomeAndConstructionBusiness.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
HomeAndConstructionBusiness.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
HomeAndConstructionBusiness.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
HomeAndConstructionBusiness.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
HomeAndConstructionBusiness.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
HomeAndConstructionBusiness.property('aggregateRating', {
...
HomeAndConstructionBusiness.property('containedIn', {
  "name" : "containedIn", 
...
HomeAndConstructionBusiness.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
HomeAndConstructionBusiness.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
HomeAndConstructionBusiness.property('faxNumber', {
  "name" : "faxNumber", 
...
HomeAndConstructionBusiness.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
HomeAndConstructionBusiness.property('globalLocationNumber', {
...
HomeAndConstructionBusiness.property('interactionCount', {
...
HomeAndConstructionBusiness.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
HomeAndConstructionBusiness.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
HomeAndConstructionBusiness.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
HomeAndConstructionBusiness.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
HomeAndConstructionBusiness.property('openingHoursSpecification', {
...
HomeAndConstructionBusiness.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
HomeAndConstructionBusiness.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
HomeAndConstructionBusiness.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
HomeAndConstructionBusiness.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
HomeAndConstructionBusiness.property('telephone', {
  "name" : "telephone", 
...
HomeAndConstructionBusiness.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
HomeAndConstructionBusiness.property('contactPoint', {
  "name" : "contactPoint", 
...
HomeAndConstructionBusiness.property('contactPoints', {
  "name" : "contactPoints", 
...
HomeAndConstructionBusiness.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
HomeAndConstructionBusiness.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
HomeAndConstructionBusiness.property('employee', {
  "name" : "employee", 
...
HomeAndConstructionBusiness.property('employees', {
  "name" : "employees", 
...
HomeAndConstructionBusiness.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
HomeAndConstructionBusiness.property('founders', {
  "name" : "founders", 
...
HomeAndConstructionBusiness.property('foundingDate', {
  "name" : "foundingDate", 
...
HomeAndConstructionBusiness.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
HomeAndConstructionBusiness.property('legalName', {
  "name" : "legalName", 
...
HomeAndConstructionBusiness.property('location', {
  "name" : "location", 
...
HomeAndConstructionBusiness.property('makesOffer', {
  "name" : "makesOffer", 
...
HomeAndConstructionBusiness.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
HomeAndConstructionBusiness.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
HomeAndConstructionBusiness.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
HomeAndConstructionBusiness.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
HomeAndConstructionBusiness.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
HomeAndConstructionBusiness.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
HomeAndConstructionBusiness.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
HomeAndConstructionBusiness.property('branchOf', {
  "name" : "branchOf", 
...
HomeAndConstructionBusiness.property('currenciesAccepted', {
...
HomeAndConstructionBusiness.property('openingHours', {
  "name" : "openingHours", 
...
HomeAndConstructionBusiness.property('paymentAccepted', {
...
HomeAndConstructionBusiness.property('priceRange', {
  "name" : "priceRange", 
