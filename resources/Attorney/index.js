...
var Attorney = resource.define('Attorney'); 

Attorney.schema.description = "Professional service: Attorney."; 
Attorney.persist('fs'); 


Attorney.property('additionalType', {
  "name" : "additionalType", 
...
Attorney.property('aggregateRating', {
...
Attorney.property('globalLocationNumber', {
...
Attorney.property('interactionCount', {
...
Attorney.property('openingHoursSpecification', {
...
Attorney.property('contactPoint', {
  "name" : "contactPoint", 
...
Attorney.property('contactPoints', {
  "name" : "contactPoints", 
...
Attorney.property('foundingDate', {
  "name" : "foundingDate", 
...
Attorney.property('currenciesAccepted', {
...
Attorney.property('openingHours', {
  "name" : "openingHours", 
...
Attorney.property('paymentAccepted', {
