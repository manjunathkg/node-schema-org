...
var AutoRepair = resource.define('AutoRepair'); 

AutoRepair.schema.description = "Car repair business."; 
AutoRepair.persist('fs'); 


AutoRepair.property('additionalType', {
  "name" : "additionalType", 
...
AutoRepair.property('description', {
  "name" : "description", 
...
AutoRepair.property('aggregateRating', {
...
AutoRepair.property('containedIn', {
  "name" : "containedIn", 
...
AutoRepair.property('globalLocationNumber', {
...
AutoRepair.property('interactionCount', {
...
AutoRepair.property('openingHoursSpecification', {
...
AutoRepair.property('contactPoint', {
  "name" : "contactPoint", 
...
AutoRepair.property('contactPoints', {
  "name" : "contactPoints", 
...
AutoRepair.property('foundingDate', {
  "name" : "foundingDate", 
...
AutoRepair.property('makesOffer', {
  "name" : "makesOffer", 
...
AutoRepair.property('currenciesAccepted', {
...
AutoRepair.property('openingHours', {
  "name" : "openingHours", 
...
AutoRepair.property('paymentAccepted', {
...
AutoRepair.property('priceRange', {
  "name" : "priceRange", 
