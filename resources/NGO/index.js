...
var NGO = resource.define('NGO'); 

NGO.schema.description = "Organization: Non-governmental Organization."; 
NGO.persist('fs'); 


NGO.property('additionalType', {
  "name" : "additionalType", 
...
NGO.property('globalLocationNumber', {
