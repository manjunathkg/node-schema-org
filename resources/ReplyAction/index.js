...
var ReplyAction = resource.define('ReplyAction'); 

ReplyAction.schema.description = "The act of responding to a question/message asked/sent by the object. Related to AskAction.Related actions:AskAction: Appears generally as an origin of a ReplyAction."; 
ReplyAction.persist('fs'); 


ReplyAction.property('additionalType', {
  "name" : "additionalType", 
...
ReplyAction.property('description', {
  "name" : "description", 
...
ReplyAction.property('instrument', {
  "name" : "instrument", 
...
ReplyAction.property('participant', {
  "name" : "participant", 
...
ReplyAction.property('startTime', {
  "name" : "startTime", 
...
ReplyAction.property('recipient', {
  "name" : "recipient", 
