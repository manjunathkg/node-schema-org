...
var DiscoverAction = resource.define('DiscoverAction'); 

DiscoverAction.schema.description = "The act of discovering/finding an object."; 
DiscoverAction.persist('fs'); 


DiscoverAction.property('additionalType', {
  "name" : "additionalType", 
...
DiscoverAction.property('description', {
  "name" : "description", 
...
DiscoverAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
DiscoverAction.property('endTime', {
  "name" : "endTime", 
...
DiscoverAction.property('instrument', {
  "name" : "instrument", 
...
DiscoverAction.property('location', {
  "name" : "location", 
...
DiscoverAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
DiscoverAction.property('participant', {
  "name" : "participant", 
...
DiscoverAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
DiscoverAction.property('startTime', {
  "name" : "startTime", 
