...
var Blog = resource.define('Blog'); 

Blog.schema.description = "A blog"; 
Blog.persist('fs'); 


Blog.property('additionalType', {
  "name" : "additionalType", 
...
Blog.property('accountablePerson', {
...
Blog.property('alternativeHeadline', {
...
Blog.property('educationalAlignment', {
...
Blog.property('interactionCount', {
...
Blog.property('interactivityType', {
...
Blog.property('isFamilyFriendly', {
...
Blog.property('learningResourceType', {
...
Blog.property('publishingPrinciples', {
...
Blog.property('sourceOrganization', {
...
Blog.property('blogPost', {
  "name" : "blogPost", 
  "displayName" : "Blog Post", 
  "description" : "A posting that is part of this blog.", 
"type":"object","properties" : {"BlogPosting" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


Blog.property('blogPosts', {
  "name" : "blogPosts", 
