...
var ListenAction = resource.define('ListenAction'); 

ListenAction.schema.description = "The act of consuming audio content."; 
ListenAction.persist('fs'); 


ListenAction.property('additionalType', {
  "name" : "additionalType", 
...
ListenAction.property('description', {
  "name" : "description", 
...
ListenAction.property('instrument', {
  "name" : "instrument", 
...
ListenAction.property('location', {
  "name" : "location", 
...
ListenAction.property('participant', {
  "name" : "participant", 
...
ListenAction.property('startTime', {
  "name" : "startTime", 
