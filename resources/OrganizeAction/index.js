...
var OrganizeAction = resource.define('OrganizeAction'); 

OrganizeAction.schema.description = "The act of manipulating/administering/supervising/controlling one or more objects."; 
OrganizeAction.persist('fs'); 


OrganizeAction.property('additionalType', {
  "name" : "additionalType", 
...
OrganizeAction.property('description', {
  "name" : "description", 
...
OrganizeAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
OrganizeAction.property('endTime', {
  "name" : "endTime", 
...
OrganizeAction.property('instrument', {
  "name" : "instrument", 
...
OrganizeAction.property('location', {
  "name" : "location", 
...
OrganizeAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
OrganizeAction.property('participant', {
  "name" : "participant", 
...
OrganizeAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
OrganizeAction.property('startTime', {
  "name" : "startTime", 
