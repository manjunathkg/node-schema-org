...
EntertainmentBusiness.property('description', {
  "name" : "description", 
...
EntertainmentBusiness.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
EntertainmentBusiness.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
EntertainmentBusiness.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
EntertainmentBusiness.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
EntertainmentBusiness.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
EntertainmentBusiness.property('aggregateRating', {
...
EntertainmentBusiness.property('containedIn', {
  "name" : "containedIn", 
...
EntertainmentBusiness.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
EntertainmentBusiness.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
EntertainmentBusiness.property('faxNumber', {
  "name" : "faxNumber", 
...
EntertainmentBusiness.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
EntertainmentBusiness.property('globalLocationNumber', {
...
EntertainmentBusiness.property('interactionCount', {
...
EntertainmentBusiness.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
EntertainmentBusiness.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
EntertainmentBusiness.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
EntertainmentBusiness.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
EntertainmentBusiness.property('openingHoursSpecification', {
...
EntertainmentBusiness.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
EntertainmentBusiness.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
EntertainmentBusiness.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
EntertainmentBusiness.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
EntertainmentBusiness.property('telephone', {
  "name" : "telephone", 
...
EntertainmentBusiness.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
EntertainmentBusiness.property('contactPoint', {
  "name" : "contactPoint", 
...
EntertainmentBusiness.property('contactPoints', {
  "name" : "contactPoints", 
...
EntertainmentBusiness.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
EntertainmentBusiness.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
EntertainmentBusiness.property('employee', {
  "name" : "employee", 
...
EntertainmentBusiness.property('employees', {
  "name" : "employees", 
...
EntertainmentBusiness.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
EntertainmentBusiness.property('founders', {
  "name" : "founders", 
...
EntertainmentBusiness.property('foundingDate', {
  "name" : "foundingDate", 
...
EntertainmentBusiness.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
EntertainmentBusiness.property('legalName', {
  "name" : "legalName", 
...
EntertainmentBusiness.property('location', {
  "name" : "location", 
...
EntertainmentBusiness.property('makesOffer', {
  "name" : "makesOffer", 
...
EntertainmentBusiness.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
EntertainmentBusiness.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
EntertainmentBusiness.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
EntertainmentBusiness.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
EntertainmentBusiness.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
EntertainmentBusiness.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
EntertainmentBusiness.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
EntertainmentBusiness.property('branchOf', {
  "name" : "branchOf", 
...
EntertainmentBusiness.property('currenciesAccepted', {
...
EntertainmentBusiness.property('openingHours', {
  "name" : "openingHours", 
...
EntertainmentBusiness.property('paymentAccepted', {
...
EntertainmentBusiness.property('priceRange', {
  "name" : "priceRange", 
