...
var Sculpture = resource.define('Sculpture'); 

Sculpture.schema.description = "A piece of sculpture."; 
Sculpture.persist('fs'); 


Sculpture.property('additionalType', {
  "name" : "additionalType", 
...
Sculpture.property('description', {
  "name" : "description", 
...
Sculpture.property('accountablePerson', {
...
Sculpture.property('aggregateRating', {
...
Sculpture.property('alternativeHeadline', {
...
Sculpture.property('associatedMedia', {
...
Sculpture.property('contentLocation', {
...
Sculpture.property('contentRating', {
  "name" : "contentRating", 
...
Sculpture.property('contributor', {
  "name" : "contributor", 
...
Sculpture.property('copyrightHolder', {
...
Sculpture.property('copyrightYear', {
  "name" : "copyrightYear", 
...
Sculpture.property('dateCreated', {
  "name" : "dateCreated", 
...
Sculpture.property('dateModified', {
  "name" : "dateModified", 
...
Sculpture.property('datePublished', {
  "name" : "datePublished", 
...
Sculpture.property('discussionUrl', {
  "name" : "discussionUrl", 
...
Sculpture.property('educationalAlignment', {
...
Sculpture.property('educationalUse', {
  "name" : "educationalUse", 
...
Sculpture.property('interactionCount', {
...
Sculpture.property('interactivityType', {
...
Sculpture.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
Sculpture.property('isFamilyFriendly', {
...
Sculpture.property('learningResourceType', {
...
Sculpture.property('publishingPrinciples', {
...
Sculpture.property('sourceOrganization', {
...
Sculpture.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
Sculpture.property('timeRequired', {
  "name" : "timeRequired", 
...
Sculpture.property('typicalAgeRange', {
