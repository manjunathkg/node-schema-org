...
CheckOutAction.property('description', {
  "name" : "description", 
...
CheckOutAction.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
CheckOutAction.property('endTime', {
  "name" : "endTime", 
...
CheckOutAction.property('instrument', {
  "name" : "instrument", 
...
CheckOutAction.property('location', {
  "name" : "location", 
...
CheckOutAction.property('object', {
  "name" : "object", 
  "displayName" : "Object", 
...
CheckOutAction.property('participant', {
  "name" : "participant", 
...
CheckOutAction.property('result', {
  "name" : "result", 
  "displayName" : "Result", 
...
CheckOutAction.property('startTime', {
  "name" : "startTime", 
...
CheckOutAction.property('language', {
  "name" : "language", 
...
CheckOutAction.property('recipient', {
  "name" : "recipient", 
