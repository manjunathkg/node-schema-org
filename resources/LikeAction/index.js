...
var LikeAction = resource.define('LikeAction'); 

LikeAction.schema.description = "The act of expressing a positive sentiment about the object. An agent likes an object (a proposition, topic or theme) with participants."; 
LikeAction.persist('fs'); 


LikeAction.property('additionalType', {
  "name" : "additionalType", 
...
LikeAction.property('description', {
  "name" : "description", 
...
LikeAction.property('instrument', {
  "name" : "instrument", 
...
LikeAction.property('participant', {
  "name" : "participant", 
