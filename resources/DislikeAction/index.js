...
var DislikeAction = resource.define('DislikeAction'); 

DislikeAction.schema.description = "The act of expressing a negative sentiment about the object. An agent dislikes an object (a proposition, topic or theme) with participants."; 
DislikeAction.persist('fs'); 


DislikeAction.property('additionalType', {
  "name" : "additionalType", 
...
DislikeAction.property('description', {
  "name" : "description", 
...
DislikeAction.property('endTime', {
  "name" : "endTime", 
...
DislikeAction.property('instrument', {
  "name" : "instrument", 
...
DislikeAction.property('location', {
  "name" : "location", 
...
DislikeAction.property('participant', {
  "name" : "participant", 
...
DislikeAction.property('startTime', {
  "name" : "startTime", 
