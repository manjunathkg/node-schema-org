...
var Pond = resource.define('Pond'); 

Pond.schema.description = "A pond"; 
Pond.persist('fs'); 


Pond.property('additionalType', {
  "name" : "additionalType", 
...
Pond.property('globalLocationNumber', {
...
Pond.property('interactionCount', {
...
Pond.property('openingHoursSpecification', {
