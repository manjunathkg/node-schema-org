...
var UserPageVisits = resource.define('UserPageVisits'); 

UserPageVisits.schema.description = "User interaction: Visit to a web page."; 
UserPageVisits.persist('fs'); 


UserPageVisits.property('additionalType', {
  "name" : "additionalType", 
...
UserPageVisits.property('description', {
  "name" : "description", 
...
UserPageVisits.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
UserPageVisits.property('attendee', {
  "name" : "attendee", 
...
UserPageVisits.property('attendees', {
  "name" : "attendees", 
...
UserPageVisits.property('duration', {
  "name" : "duration", 
...
UserPageVisits.property('endDate', {
  "name" : "endDate", 
...
UserPageVisits.property('location', {
  "name" : "location", 
...
UserPageVisits.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
UserPageVisits.property('performer', {
  "name" : "performer", 
...
UserPageVisits.property('performers', {
  "name" : "performers", 
...
UserPageVisits.property('startDate', {
  "name" : "startDate", 
...
UserPageVisits.property('subEvent', {
  "name" : "subEvent", 
...
UserPageVisits.property('subEvents', {
  "name" : "subEvents", 
...
UserPageVisits.property('superEvent', {
  "name" : "superEvent", 
