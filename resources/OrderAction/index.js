...
var OrderAction = resource.define('OrderAction'); 

OrderAction.schema.description = "An agent orders an object/product/service to be delivered/sent."; 
OrderAction.persist('fs'); 


OrderAction.property('additionalType', {
  "name" : "additionalType", 
...
OrderAction.property('description', {
  "name" : "description", 
...
OrderAction.property('instrument', {
  "name" : "instrument", 
...
OrderAction.property('participant', {
  "name" : "participant", 
...
OrderAction.property('startTime', {
  "name" : "startTime", 
