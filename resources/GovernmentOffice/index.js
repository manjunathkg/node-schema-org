...
var GovernmentOffice = resource.define('GovernmentOffice'); 

GovernmentOffice.schema.description = "A government office—for example, an IRS or DMV office."; 
GovernmentOffice.persist('fs'); 


GovernmentOffice.property('additionalType', {
  "name" : "additionalType", 
...
GovernmentOffice.property('description', {
  "name" : "description", 
...
GovernmentOffice.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
GovernmentOffice.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
GovernmentOffice.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
GovernmentOffice.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
GovernmentOffice.property('aggregateRating', {
...
GovernmentOffice.property('containedIn', {
  "name" : "containedIn", 
...
GovernmentOffice.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
GovernmentOffice.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
GovernmentOffice.property('faxNumber', {
  "name" : "faxNumber", 
...
GovernmentOffice.property('globalLocationNumber', {
...
GovernmentOffice.property('interactionCount', {
...
GovernmentOffice.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
GovernmentOffice.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
GovernmentOffice.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
GovernmentOffice.property('openingHoursSpecification', {
...
GovernmentOffice.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
GovernmentOffice.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
GovernmentOffice.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
GovernmentOffice.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
GovernmentOffice.property('telephone', {
  "name" : "telephone", 
...
GovernmentOffice.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
GovernmentOffice.property('contactPoint', {
  "name" : "contactPoint", 
...
GovernmentOffice.property('contactPoints', {
  "name" : "contactPoints", 
...
GovernmentOffice.property('duns', {
  "name" : "duns", 
  "displayName" : "Duns", 
...
GovernmentOffice.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
GovernmentOffice.property('employee', {
  "name" : "employee", 
...
GovernmentOffice.property('employees', {
  "name" : "employees", 
...
GovernmentOffice.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
GovernmentOffice.property('founders', {
  "name" : "founders", 
...
GovernmentOffice.property('foundingDate', {
  "name" : "foundingDate", 
...
GovernmentOffice.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
GovernmentOffice.property('legalName', {
  "name" : "legalName", 
...
GovernmentOffice.property('location', {
  "name" : "location", 
...
GovernmentOffice.property('makesOffer', {
  "name" : "makesOffer", 
...
GovernmentOffice.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
GovernmentOffice.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
GovernmentOffice.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
GovernmentOffice.property('owns', {
  "name" : "owns", 
  "displayName" : "Owns", 
...
GovernmentOffice.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
GovernmentOffice.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
GovernmentOffice.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
GovernmentOffice.property('branchOf', {
  "name" : "branchOf", 
...
GovernmentOffice.property('currenciesAccepted', {
...
GovernmentOffice.property('openingHours', {
  "name" : "openingHours", 
...
GovernmentOffice.property('paymentAccepted', {
...
GovernmentOffice.property('priceRange', {
  "name" : "priceRange", 
