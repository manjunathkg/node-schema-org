...
var DrawAction = resource.define('DrawAction'); 

DrawAction.schema.description = "The act of producing a visual/graphical representation of an object, typically with a pen/pencil and paper as instruments."; 
DrawAction.persist('fs'); 


DrawAction.property('additionalType', {
  "name" : "additionalType", 
...
DrawAction.property('description', {
  "name" : "description", 
...
DrawAction.property('instrument', {
  "name" : "instrument", 
...
DrawAction.property('participant', {
  "name" : "participant", 
