...
var AutomatedTeller = resource.define('AutomatedTeller'); 

AutomatedTeller.schema.description = "ATM/cash machine."; 
AutomatedTeller.persist('fs'); 


AutomatedTeller.property('additionalType', {
  "name" : "additionalType", 
...
AutomatedTeller.property('description', {
  "name" : "description", 
...
AutomatedTeller.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
AutomatedTeller.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
AutomatedTeller.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
AutomatedTeller.property('aggregateRating', {
...
AutomatedTeller.property('containedIn', {
  "name" : "containedIn", 
...
AutomatedTeller.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
AutomatedTeller.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
AutomatedTeller.property('faxNumber', {
  "name" : "faxNumber", 
...
AutomatedTeller.property('globalLocationNumber', {
...
AutomatedTeller.property('interactionCount', {
...
AutomatedTeller.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
AutomatedTeller.property('openingHoursSpecification', {
...
AutomatedTeller.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
AutomatedTeller.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
AutomatedTeller.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
AutomatedTeller.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
AutomatedTeller.property('telephone', {
  "name" : "telephone", 
...
AutomatedTeller.property('brand', {
  "name" : "brand", 
  "displayName" : "Brand", 
...
AutomatedTeller.property('contactPoint', {
  "name" : "contactPoint", 
...
AutomatedTeller.property('contactPoints', {
  "name" : "contactPoints", 
...
AutomatedTeller.property('email', {
  "name" : "email", 
  "displayName" : "Email", 
...
AutomatedTeller.property('employee', {
  "name" : "employee", 
...
AutomatedTeller.property('employees', {
  "name" : "employees", 
...
AutomatedTeller.property('founder', {
  "name" : "founder", 
  "displayName" : "Founder", 
...
AutomatedTeller.property('founders', {
  "name" : "founders", 
...
AutomatedTeller.property('foundingDate', {
  "name" : "foundingDate", 
...
AutomatedTeller.property('hasPOS', {
  "name" : "hasPOS", 
  "displayName" : "Has Pos", 
...
AutomatedTeller.property('legalName', {
  "name" : "legalName", 
...
AutomatedTeller.property('location', {
  "name" : "location", 
...
AutomatedTeller.property('makesOffer', {
  "name" : "makesOffer", 
...
AutomatedTeller.property('member', {
  "name" : "member", 
  "displayName" : "Member", 
...
AutomatedTeller.property('members', {
  "name" : "members", 
  "displayName" : "Members", 
...
AutomatedTeller.property('naics', {
  "name" : "naics", 
  "displayName" : "Naics", 
...
AutomatedTeller.property('seeks', {
  "name" : "seeks", 
  "displayName" : "Seeks", 
...
AutomatedTeller.property('taxID', {
  "name" : "taxID", 
  "displayName" : "Tax id", 
...
AutomatedTeller.property('vatID', {
  "name" : "vatID", 
  "displayName" : "Vat id", 
...
AutomatedTeller.property('branchOf', {
  "name" : "branchOf", 
...
AutomatedTeller.property('currenciesAccepted', {
...
AutomatedTeller.property('openingHours', {
  "name" : "openingHours", 
...
AutomatedTeller.property('paymentAccepted', {
...
AutomatedTeller.property('priceRange', {
  "name" : "priceRange", 
