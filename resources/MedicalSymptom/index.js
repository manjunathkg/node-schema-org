...
var MedicalSymptom = resource.define('MedicalSymptom'); 

MedicalSymptom.schema.description = "Any indication of the existence of a medical condition or disease that is apparent to the patient."; 
MedicalSymptom.persist('fs'); 


MedicalSymptom.property('additionalType', {
  "name" : "additionalType", 
...
MedicalSymptom.property('description', {
  "name" : "description", 
...
MedicalSymptom.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
MedicalSymptom.property('alternateName', {
  "name" : "alternateName", 
...
MedicalSymptom.property('guideline', {
  "name" : "guideline", 
...
MedicalSymptom.property('medicineSystem', {
  "name" : "medicineSystem", 
...
MedicalSymptom.property('recognizingAuthority', {
...
MedicalSymptom.property('relevantSpecialty', {
...
MedicalSymptom.property('possibleTreatment', {
