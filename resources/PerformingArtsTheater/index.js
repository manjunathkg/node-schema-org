...
var PerformingArtsTheater = resource.define('PerformingArtsTheater'); 

PerformingArtsTheater.schema.description = "A theatre or other performing art center."; 
PerformingArtsTheater.persist('fs'); 


PerformingArtsTheater.property('additionalType', {
  "name" : "additionalType", 
...
PerformingArtsTheater.property('description', {
  "name" : "description", 
...
PerformingArtsTheater.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
PerformingArtsTheater.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
PerformingArtsTheater.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
PerformingArtsTheater.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
PerformingArtsTheater.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
PerformingArtsTheater.property('aggregateRating', {
...
PerformingArtsTheater.property('containedIn', {
  "name" : "containedIn", 
...
PerformingArtsTheater.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
PerformingArtsTheater.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
PerformingArtsTheater.property('faxNumber', {
  "name" : "faxNumber", 
...
PerformingArtsTheater.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
PerformingArtsTheater.property('globalLocationNumber', {
...
PerformingArtsTheater.property('interactionCount', {
...
PerformingArtsTheater.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
PerformingArtsTheater.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
PerformingArtsTheater.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
PerformingArtsTheater.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
PerformingArtsTheater.property('openingHoursSpecification', {
...
PerformingArtsTheater.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
PerformingArtsTheater.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
PerformingArtsTheater.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
PerformingArtsTheater.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
PerformingArtsTheater.property('telephone', {
  "name" : "telephone", 
...
PerformingArtsTheater.property('openingHours', {
  "name" : "openingHours", 
