...
var Nerve = resource.define('Nerve'); 

Nerve.schema.description = "A common pathway for the electrochemical nerve impulses that are transmitted along each of the axons."; 
Nerve.persist('fs'); 


Nerve.property('additionalType', {
  "name" : "additionalType", 
...
Nerve.property('recognizingAuthority', {
...
Nerve.property('relevantSpecialty', {
...
Nerve.property('associatedPathophysiology', {
...
Nerve.property('relatedCondition', {
...
Nerve.property('branch', {
  "name" : "branch", 
  "displayName" : "Branch", 
  "description" : "The branches that delineate from the nerve bundle.", 
"type":"object","properties" : {"AnatomicalStructure" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}},"Nerve" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


Nerve.property('nerveMotor', {
  "name" : "nerveMotor", 
  "displayName" : "Nerve Motor", 
  "description" : "The neurological pathway extension that involves muscle control.", 
"type":"object","properties" : {"Muscle" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


Nerve.property('sensoryUnit', {
  "name" : "sensoryUnit", 
  "displayName" : "Sensory Unit", 
  "description" : "The neurological pathway extension that inputs and sends information to the brain or spinal cord.", 
"type":"object","properties" : {"AnatomicalStructure" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}},"SuperficialAnatomy" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 


Nerve.property('sourcedFrom', {
  "name" : "sourcedFrom", 
  "displayName" : "Sourced From", 
  "description" : "The neurological pathway that originates the neurons.", 
"type":"object","properties" : {"BrainStructure" :    {"type" :"object",   "properties" : {                    "id" : { "type" : "array" }}}} 
}); 
