...
var LegislativeBuilding = resource.define('LegislativeBuilding'); 

LegislativeBuilding.schema.description = "A legislative building—for example, the state capitol."; 
LegislativeBuilding.persist('fs'); 


LegislativeBuilding.property('additionalType', {
  "name" : "additionalType", 
...
LegislativeBuilding.property('description', {
  "name" : "description", 
...
LegislativeBuilding.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
LegislativeBuilding.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
LegislativeBuilding.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
LegislativeBuilding.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
LegislativeBuilding.property('address', {
  "name" : "address", 
  "displayName" : "Address", 
...
LegislativeBuilding.property('aggregateRating', {
...
LegislativeBuilding.property('containedIn', {
  "name" : "containedIn", 
...
LegislativeBuilding.property('event', {
  "name" : "event", 
  "displayName" : "Event", 
...
LegislativeBuilding.property('events', {
  "name" : "events", 
  "displayName" : "Events", 
...
LegislativeBuilding.property('faxNumber', {
  "name" : "faxNumber", 
...
LegislativeBuilding.property('geo', {
  "name" : "geo", 
  "displayName" : "Geo", 
...
LegislativeBuilding.property('globalLocationNumber', {
...
LegislativeBuilding.property('interactionCount', {
...
LegislativeBuilding.property('isicV4', {
  "name" : "isicV4", 
  "displayName" : "Isic v4", 
...
LegislativeBuilding.property('logo', {
  "name" : "logo", 
  "displayName" : "Logo", 
...
LegislativeBuilding.property('map', {
  "name" : "map", 
  "displayName" : "Map", 
...
LegislativeBuilding.property('maps', {
  "name" : "maps", 
  "displayName" : "Maps", 
...
LegislativeBuilding.property('openingHoursSpecification', {
...
LegislativeBuilding.property('photo', {
  "name" : "photo", 
  "displayName" : "Photo", 
...
LegislativeBuilding.property('photos', {
  "name" : "photos", 
  "displayName" : "Photos", 
...
LegislativeBuilding.property('review', {
  "name" : "review", 
  "displayName" : "Review", 
...
LegislativeBuilding.property('reviews', {
  "name" : "reviews", 
  "displayName" : "Reviews", 
...
LegislativeBuilding.property('telephone', {
  "name" : "telephone", 
...
LegislativeBuilding.property('openingHours', {
  "name" : "openingHours", 
