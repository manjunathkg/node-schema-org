...
var ImageObject = resource.define('ImageObject'); 

ImageObject.schema.description = "An image file."; 
ImageObject.persist('fs'); 


ImageObject.property('additionalType', {
  "name" : "additionalType", 
...
ImageObject.property('description', {
  "name" : "description", 
...
ImageObject.property('accountablePerson', {
...
ImageObject.property('aggregateRating', {
...
ImageObject.property('alternativeHeadline', {
...
ImageObject.property('associatedMedia', {
...
ImageObject.property('contentLocation', {
...
ImageObject.property('contentRating', {
  "name" : "contentRating", 
...
ImageObject.property('contributor', {
  "name" : "contributor", 
...
ImageObject.property('copyrightHolder', {
...
ImageObject.property('copyrightYear', {
  "name" : "copyrightYear", 
...
ImageObject.property('dateCreated', {
  "name" : "dateCreated", 
...
ImageObject.property('dateModified', {
  "name" : "dateModified", 
...
ImageObject.property('datePublished', {
  "name" : "datePublished", 
...
ImageObject.property('discussionUrl', {
  "name" : "discussionUrl", 
...
ImageObject.property('educationalAlignment', {
...
ImageObject.property('educationalUse', {
  "name" : "educationalUse", 
...
ImageObject.property('encodings', {
  "name" : "encodings", 
...
ImageObject.property('inLanguage', {
  "name" : "inLanguage", 
...
ImageObject.property('interactionCount', {
...
ImageObject.property('interactivityType', {
...
ImageObject.property('isBasedOnUrl', {
  "name" : "isBasedOnUrl", 
...
ImageObject.property('isFamilyFriendly', {
...
ImageObject.property('learningResourceType', {
...
ImageObject.property('publisher', {
  "name" : "publisher", 
...
ImageObject.property('publishingPrinciples', {
...
ImageObject.property('sourceOrganization', {
...
ImageObject.property('thumbnailUrl', {
  "name" : "thumbnailUrl", 
...
ImageObject.property('timeRequired', {
  "name" : "timeRequired", 
...
ImageObject.property('typicalAgeRange', {
...
ImageObject.property('associatedArticle', {
...
ImageObject.property('contentSize', {
  "name" : "contentSize", 
...
ImageObject.property('contentUrl', {
  "name" : "contentUrl", 
...
ImageObject.property('encodesCreativeWork', {
...
ImageObject.property('encodingFormat', {
  "name" : "encodingFormat", 
...
ImageObject.property('playerType', {
  "name" : "playerType", 
...
ImageObject.property('regionsAllowed', {
  "name" : "regionsAllowed", 
...
ImageObject.property('requiresSubscription', {
...
ImageObject.property('uploadDate', {
  "name" : "uploadDate", 
