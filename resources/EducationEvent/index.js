...
var EducationEvent = resource.define('EducationEvent'); 

EducationEvent.schema.description = "Event type: Education event."; 
EducationEvent.persist('fs'); 


EducationEvent.property('additionalType', {
  "name" : "additionalType", 
...
EducationEvent.property('description', {
  "name" : "description", 
...
EducationEvent.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
EducationEvent.property('attendee', {
  "name" : "attendee", 
...
EducationEvent.property('attendees', {
  "name" : "attendees", 
...
EducationEvent.property('duration', {
  "name" : "duration", 
...
EducationEvent.property('endDate', {
  "name" : "endDate", 
...
EducationEvent.property('location', {
  "name" : "location", 
...
EducationEvent.property('offers', {
  "name" : "offers", 
  "displayName" : "Offers", 
...
EducationEvent.property('performer', {
  "name" : "performer", 
...
EducationEvent.property('performers', {
  "name" : "performers", 
...
EducationEvent.property('startDate', {
  "name" : "startDate", 
...
EducationEvent.property('subEvent', {
  "name" : "subEvent", 
...
EducationEvent.property('subEvents', {
  "name" : "subEvents", 
...
EducationEvent.property('superEvent', {
  "name" : "superEvent", 
