...
var InviteAction = resource.define('InviteAction'); 

InviteAction.schema.description = "The act of asking someone to attend an event. Reciprocal of RsvpAction."; 
InviteAction.persist('fs'); 


InviteAction.property('additionalType', {
  "name" : "additionalType", 
...
InviteAction.property('description', {
  "name" : "description", 
...
InviteAction.property('instrument', {
  "name" : "instrument", 
...
InviteAction.property('location', {
  "name" : "location", 
...
InviteAction.property('participant', {
  "name" : "participant", 
...
InviteAction.property('startTime', {
  "name" : "startTime", 
...
InviteAction.property('language', {
  "name" : "language", 
...
InviteAction.property('recipient', {
  "name" : "recipient", 
