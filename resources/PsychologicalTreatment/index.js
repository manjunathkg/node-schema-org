...
var PsychologicalTreatment = resource.define('PsychologicalTreatment'); 

PsychologicalTreatment.schema.description = "A process of care relying upon counseling, dialogue, communication, verbalization aimed at improving a mental health condition."; 
PsychologicalTreatment.persist('fs'); 


PsychologicalTreatment.property('additionalType', {
  "name" : "additionalType", 
...
PsychologicalTreatment.property('description', {
  "name" : "description", 
...
PsychologicalTreatment.property('image', {
  "name" : "image", 
  "displayName" : "Image", 
...
PsychologicalTreatment.property('name', {
  "name" : "name", 
  "displayName" : "Name", 
...
PsychologicalTreatment.property('sameAs', {
  "name" : "sameAs", 
  "displayName" : "Same as", 
...
PsychologicalTreatment.property('url', {
  "name" : "url", 
  "displayName" : "Url", 
...
PsychologicalTreatment.property('alternateName', {
  "name" : "alternateName", 
...
PsychologicalTreatment.property('code', {
  "name" : "code", 
  "displayName" : "Code", 
...
PsychologicalTreatment.property('guideline', {
  "name" : "guideline", 
...
PsychologicalTreatment.property('medicineSystem', {
  "name" : "medicineSystem", 
...
PsychologicalTreatment.property('recognizingAuthority', {
...
PsychologicalTreatment.property('relevantSpecialty', {
...
PsychologicalTreatment.property('study', {
  "name" : "study", 
  "displayName" : "Study", 
...
PsychologicalTreatment.property('adverseOutcome', {
  "name" : "adverseOutcome", 
...
PsychologicalTreatment.property('contraindication', {
...
PsychologicalTreatment.property('duplicateTherapy', {
...
PsychologicalTreatment.property('indication', {
  "name" : "indication", 
...
PsychologicalTreatment.property('seriousAdverseOutcome', {
