...
var Optician = resource.define('Optician'); 

Optician.schema.description = "An optician&#x27;s store."; 
Optician.persist('fs'); 


Optician.property('additionalType', {
  "name" : "additionalType", 
...
Optician.property('aggregateRating', {
...
Optician.property('globalLocationNumber', {
...
Optician.property('interactionCount', {
...
Optician.property('openingHoursSpecification', {
...
Optician.property('contactPoint', {
  "name" : "contactPoint", 
...
Optician.property('contactPoints', {
  "name" : "contactPoints", 
...
Optician.property('foundingDate', {
  "name" : "foundingDate", 
...
Optician.property('currenciesAccepted', {
...
Optician.property('openingHours', {
  "name" : "openingHours", 
...
Optician.property('paymentAccepted', {
