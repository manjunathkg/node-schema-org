...
var FireStation = resource.define('FireStation'); 

FireStation.schema.description = "A fire station. With firemen."; 
FireStation.persist('fs'); 


FireStation.property('additionalType', {
  "name" : "additionalType", 
...
FireStation.property('description', {
  "name" : "description", 
...
FireStation.property('aggregateRating', {
...
FireStation.property('containedIn', {
  "name" : "containedIn", 
...
FireStation.property('faxNumber', {
  "name" : "faxNumber", 
...
FireStation.property('globalLocationNumber', {
...
FireStation.property('interactionCount', {
...
FireStation.property('openingHoursSpecification', {
...
FireStation.property('telephone', {
  "name" : "telephone", 
...
FireStation.property('contactPoint', {
  "name" : "contactPoint", 
...
FireStation.property('contactPoints', {
  "name" : "contactPoints", 
...
FireStation.property('employees', {
  "name" : "employees", 
...
FireStation.property('foundingDate', {
  "name" : "foundingDate", 
...
FireStation.property('legalName', {
  "name" : "legalName", 
...
FireStation.property('makesOffer', {
  "name" : "makesOffer", 
...
FireStation.property('currenciesAccepted', {
...
FireStation.property('openingHours', {
  "name" : "openingHours", 
...
FireStation.property('paymentAccepted', {
...
FireStation.property('priceRange', {
  "name" : "priceRange", 
