...
var SportsTeam = resource.define('SportsTeam'); 

SportsTeam.schema.description = "Organization: Sports team."; 
SportsTeam.persist('fs'); 


SportsTeam.property('additionalType', {
  "name" : "additionalType", 
...
SportsTeam.property('description', {
  "name" : "description", 
...
SportsTeam.property('aggregateRating', {
...
SportsTeam.property('contactPoint', {
  "name" : "contactPoint", 
...
SportsTeam.property('contactPoints', {
  "name" : "contactPoints", 
...
SportsTeam.property('foundingDate', {
  "name" : "foundingDate", 
...
SportsTeam.property('globalLocationNumber', {
...
SportsTeam.property('interactionCount', {
...
SportsTeam.property('makesOffer', {
  "name" : "makesOffer", 
