...
var UserTweets = resource.define('UserTweets'); 

UserTweets.schema.description = "User interaction: Tweets."; 
UserTweets.persist('fs'); 


UserTweets.property('additionalType', {
  "name" : "additionalType", 
...
UserTweets.property('description', {
  "name" : "description", 
...
UserTweets.property('performers', {
  "name" : "performers", 
...
UserTweets.property('superEvent', {
  "name" : "superEvent", 
