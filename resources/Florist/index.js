...
var Florist = resource.define('Florist'); 

Florist.schema.description = "A florist."; 
Florist.persist('fs'); 


Florist.property('additionalType', {
  "name" : "additionalType", 
...
Florist.property('aggregateRating', {
...
Florist.property('globalLocationNumber', {
...
Florist.property('interactionCount', {
...
Florist.property('openingHoursSpecification', {
...
Florist.property('contactPoints', {
  "name" : "contactPoints", 
...
Florist.property('currenciesAccepted', {
...
Florist.property('paymentAccepted', {
