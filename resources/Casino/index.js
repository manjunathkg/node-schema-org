...
var Casino = resource.define('Casino'); 

Casino.schema.description = "A casino."; 
Casino.persist('fs'); 


Casino.property('additionalType', {
  "name" : "additionalType", 
...
Casino.property('aggregateRating', {
...
Casino.property('globalLocationNumber', {
...
Casino.property('interactionCount', {
...
Casino.property('openingHoursSpecification', {
...
Casino.property('currenciesAccepted', {
...
Casino.property('paymentAccepted', {
