...
var PostOffice = resource.define('PostOffice'); 

PostOffice.schema.description = "A post office."; 
PostOffice.persist('fs'); 


PostOffice.property('additionalType', {
  "name" : "additionalType", 
...
PostOffice.property('description', {
  "name" : "description", 
...
PostOffice.property('aggregateRating', {
...
PostOffice.property('containedIn', {
  "name" : "containedIn", 
...
PostOffice.property('globalLocationNumber', {
...
PostOffice.property('interactionCount', {
...
PostOffice.property('openingHoursSpecification', {
...
PostOffice.property('contactPoint', {
  "name" : "contactPoint", 
...
PostOffice.property('contactPoints', {
  "name" : "contactPoints", 
...
PostOffice.property('foundingDate', {
  "name" : "foundingDate", 
...
PostOffice.property('makesOffer', {
  "name" : "makesOffer", 
...
PostOffice.property('currenciesAccepted', {
...
PostOffice.property('openingHours', {
  "name" : "openingHours", 
...
PostOffice.property('paymentAccepted', {
...
PostOffice.property('priceRange', {
  "name" : "priceRange", 
